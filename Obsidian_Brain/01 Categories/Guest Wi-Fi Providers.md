---
type: category
name: "Guest Wi-Fi Providers"
slug: "guest-wi-fi-providers"
---

# 📂 Category: Guest Wi-Fi Providers

> G2 Software Category: Guest Wi-Fi Providers within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Guest Wi-Fi Providers") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Guest Wi-Fi Providers") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Guest Wi-Fi Providers")
SORT osi_score DESC
```