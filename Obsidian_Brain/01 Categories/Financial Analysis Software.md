...
> G2 Software Category: Financial Analysis Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Financial Analysis Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Financial Analysis Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Financial Analysis Software")
SORT osi_score DESC
```