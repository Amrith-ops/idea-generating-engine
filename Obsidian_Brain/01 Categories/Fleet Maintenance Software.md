...
> G2 Software Category: Fleet Maintenance Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Fleet Maintenance Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Fleet Maintenance Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Fleet Maintenance Software")
SORT osi_score DESC
```