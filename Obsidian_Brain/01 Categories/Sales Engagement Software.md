...
> G2 Software Category: Sales Engagement Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Sales Engagement Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Sales Engagement Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Sales Engagement Software")
SORT osi_score DESC
```