---
type: category
name: "Drug Testing Software"
slug: "drug-testing"
---

# 📂 Category: Drug Testing Software

> G2 Software Category: Drug Testing Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Drug Testing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Drug Testing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Drug Testing Software")
SORT osi_score DESC
```