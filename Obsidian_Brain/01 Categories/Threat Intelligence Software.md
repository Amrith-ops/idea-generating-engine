---
type: category
name: "Threat Intelligence Software"
slug: "threat-intelligence"
---

# 📂 Category: Threat Intelligence Software

> G2 Software Category: Threat Intelligence Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Threat Intelligence Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Threat Intelligence Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Threat Intelligence Software")
SORT osi_score DESC
```