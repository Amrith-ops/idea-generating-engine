---
type: category
name: "Parks and Recreation Software"
slug: "parks-and-recreation"
---

# 📂 Category: Parks and Recreation Software

> G2 Software Category: Parks and Recreation Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Parks and Recreation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Parks and Recreation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Parks and Recreation Software")
SORT osi_score DESC
```