...
slug: "audience-response"
---

# 📂 Category: Audience Response Software

> G2 Software Category: Audience Response Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Audience Response Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Audience Response Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Audience Response Software")
SORT osi_score DESC
```