...
> G2 Software Category: Financial Data APIs within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Financial Data APIs") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Financial Data APIs") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Financial Data APIs")
SORT osi_score DESC
```