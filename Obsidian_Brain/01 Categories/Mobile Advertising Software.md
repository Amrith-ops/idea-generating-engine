---
type: category
name: "Mobile Advertising Software"
slug: "mobile-advertising"
---

# 📂 Category: Mobile Advertising Software

> G2 Software Category: Mobile Advertising Software within Digital Advertising Tech.
...
FROM "02 Products"
WHERE contains(category, "Mobile Advertising Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Mobile Advertising Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Mobile Advertising Software")
SORT osi_score DESC
```