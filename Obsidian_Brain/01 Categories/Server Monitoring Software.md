...
# 📂 Category: Server Monitoring Software

> G2 Software Category: Server Monitoring Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Server Monitoring Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Server Monitoring Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Server Monitoring Software")
SORT osi_score DESC
```