...
# 📂 Category: Contract Analytics Software

> G2 Software Category: Contract Analytics Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Contract Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Contract Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Contract Analytics Software")
SORT osi_score DESC
```