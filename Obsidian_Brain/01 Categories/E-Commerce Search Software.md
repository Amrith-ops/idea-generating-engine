---
type: category
name: "E-Commerce Search Software"
slug: "e-commerce-search"
---

# 📂 Category: E-Commerce Search Software

> G2 Software Category: E-Commerce Search Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "E-Commerce Search Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "E-Commerce Search Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "E-Commerce Search Software")
SORT osi_score DESC
```