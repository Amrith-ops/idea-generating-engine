---
type: category
name: "Microlearning Platforms"
slug: "microlearning-platforms"
---

# 📂 Category: Microlearning Platforms

> G2 Software Category: Microlearning Platforms within HR.
...
FROM "02 Products"
WHERE contains(category, "Microlearning Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Microlearning Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Microlearning Platforms")
SORT osi_score DESC
```