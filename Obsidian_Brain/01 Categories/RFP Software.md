...
# 📂 Category: RFP Software

> G2 Software Category: RFP Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "RFP Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "RFP Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "RFP Software")
SORT osi_score DESC
```