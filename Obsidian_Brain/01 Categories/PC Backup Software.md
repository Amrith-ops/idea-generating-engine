---
type: category
name: "PC Backup Software"
slug: "pc-backup"
---

# 📂 Category: PC Backup Software

> G2 Software Category: PC Backup Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "PC Backup Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "PC Backup Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "PC Backup Software")
SORT osi_score DESC
```