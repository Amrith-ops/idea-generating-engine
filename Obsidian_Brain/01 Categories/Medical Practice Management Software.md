---
type: category
name: "Medical Practice Management Software"
slug: "medical-practice-management"
---

# 📂 Category: Medical Practice Management Software

> G2 Software Category: Medical Practice Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Medical Practice Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Medical Practice Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Medical Practice Management Software")
SORT osi_score DESC
```