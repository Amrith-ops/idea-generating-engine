---
type: category
name: "Financial Close Software"
slug: "financial-close"
---

# 📂 Category: Financial Close Software

> G2 Software Category: Financial Close Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Financial Close Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Financial Close Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Financial Close Software")
SORT osi_score DESC
```