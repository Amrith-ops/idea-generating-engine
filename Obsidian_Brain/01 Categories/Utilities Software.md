...
> G2 Software Category: Utilities Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Utilities Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Utilities Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Utilities Software")
SORT osi_score DESC
```