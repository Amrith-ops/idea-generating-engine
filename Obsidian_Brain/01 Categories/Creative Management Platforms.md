---
type: category
name: "Creative Management Platforms"
slug: "creative-management-platforms"
---

# 📂 Category: Creative Management Platforms

> G2 Software Category: Creative Management Platforms within Digital Advertising Tech.
...
FROM "02 Products"
WHERE contains(category, "Creative Management Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Creative Management Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Creative Management Platforms")
SORT osi_score DESC
```