...
> G2 Software Category: Email Tracking Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Email Tracking Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Email Tracking Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Email Tracking Software")
SORT osi_score DESC
```