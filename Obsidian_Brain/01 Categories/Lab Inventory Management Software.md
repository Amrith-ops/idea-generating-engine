---
type: category
name: "Lab Inventory Management Software"
slug: "lab-inventory-management"
---

# 📂 Category: Lab Inventory Management Software

> G2 Software Category: Lab Inventory Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Lab Inventory Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Lab Inventory Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Lab Inventory Management Software")
SORT osi_score DESC
```