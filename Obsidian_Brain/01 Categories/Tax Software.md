...
> G2 Software Category: Tax Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Tax Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Tax Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Tax Software")
SORT osi_score DESC
```