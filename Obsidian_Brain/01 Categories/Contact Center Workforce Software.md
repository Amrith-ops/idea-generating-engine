---
type: category
name: "Contact Center Workforce Software"
slug: "contact-center-workforce"
---

# 📂 Category: Contact Center Workforce Software

> G2 Software Category: Contact Center Workforce Software within Customer Service.
...
FROM "02 Products"
WHERE contains(category, "Contact Center Workforce Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Contact Center Workforce Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Contact Center Workforce Software")
SORT osi_score DESC
```