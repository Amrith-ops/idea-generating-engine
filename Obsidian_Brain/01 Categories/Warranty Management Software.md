...
# 📂 Category: Warranty Management Software

> G2 Software Category: Warranty Management Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Warranty Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Warranty Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Warranty Management Software")
SORT osi_score DESC
```