---
type: category
name: "Cannabis Industry Software"
slug: "cannabis-industry"
---

# 📂 Category: Cannabis Industry Software

> G2 Software Category: Cannabis Industry Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Cannabis Industry Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cannabis Industry Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cannabis Industry Software")
SORT osi_score DESC
```