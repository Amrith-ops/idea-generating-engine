---
type: category
name: "Other Finance Software"
slug: "other-finance"
---

# 📂 Category: Other Finance Software

> G2 Software Category: Other Finance Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Finance Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Finance Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Finance Software")
SORT osi_score DESC
```