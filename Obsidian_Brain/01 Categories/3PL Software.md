...
# 📂 Category: 3PL Software

> G2 Software Category: 3PL Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "3PL Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "3PL Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "3PL Software")
SORT osi_score DESC
```