---
type: category
name: "Car Dealer Software"
slug: "car-dealer"
---

# 📂 Category: Car Dealer Software

> G2 Software Category: Car Dealer Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Car Dealer Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Car Dealer Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Car Dealer Software")
SORT osi_score DESC
```