...
> G2 Software Category: Pharmacy Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Pharmacy Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Pharmacy Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Pharmacy Software")
SORT osi_score DESC
```