---
type: category
name: "AI Interview Agent Software"
slug: "ai-interview-agent"
---

# 📂 Category: AI Interview Agent Software

> G2 Software Category: AI Interview Agent Software within HR.
...
FROM "02 Products"
WHERE contains(category, "AI Interview Agent Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI Interview Agent Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI Interview Agent Software")
SORT osi_score DESC
```