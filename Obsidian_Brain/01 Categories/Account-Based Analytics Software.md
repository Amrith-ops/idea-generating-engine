---
type: category
name: "Account-Based Analytics Software"
slug: "account-based-analytics"
---

# 📂 Category: Account-Based Analytics Software

> G2 Software Category: Account-Based Analytics Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Account-Based Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Account-Based Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Account-Based Analytics Software")
SORT osi_score DESC
```