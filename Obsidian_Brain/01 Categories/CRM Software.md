...
> Customer Relationship Management platforms for managing leads, deals, pipelines, and customer communication.
...
FROM "02 Products"
WHERE contains(category, "CRM Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "CRM Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "CRM Software")
SORT osi_score DESC
```