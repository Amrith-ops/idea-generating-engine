---
type: category
name: "Technical Skills Screening Software"
slug: "technical-skills-screening"
---

# 📂 Category: Technical Skills Screening Software

> G2 Software Category: Technical Skills Screening Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Technical Skills Screening Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Technical Skills Screening Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Technical Skills Screening Software")
SORT osi_score DESC
```