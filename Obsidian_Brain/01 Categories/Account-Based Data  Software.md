---
type: category
name: "Account-Based Data  Software"
slug: "account-based-data"
---

# 📂 Category: Account-Based Data  Software

> G2 Software Category: Account-Based Data  Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Account-Based Data  Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Account-Based Data  Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Account-Based Data  Software")
SORT osi_score DESC
```