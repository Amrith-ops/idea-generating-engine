---
type: category
name: "Conflict Check Software"
slug: "conflict-check"
---

# 📂 Category: Conflict Check Software

> G2 Software Category: Conflict Check Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Conflict Check Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Conflict Check Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Conflict Check Software")
SORT osi_score DESC
```