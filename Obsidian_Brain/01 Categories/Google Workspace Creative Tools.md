---
type: category
name: "Google Workspace Creative Tools"
slug: "google-workspace-creative-tools"
---

# 📂 Category: Google Workspace Creative Tools

> G2 Software Category: Google Workspace Creative Tools within Marketplace Apps.
...
FROM "02 Products"
WHERE contains(category, "Google Workspace Creative Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Google Workspace Creative Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Google Workspace Creative Tools")
SORT osi_score DESC
```