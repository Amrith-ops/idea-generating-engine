---
type: category
name: "Identity Verification Software"
slug: "identity-verification"
---

# 📂 Category: Identity Verification Software

> G2 Software Category: Identity Verification Software within Data Privacy.
...
FROM "02 Products"
WHERE contains(category, "Identity Verification Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Identity Verification Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Identity Verification Software")
SORT osi_score DESC
```