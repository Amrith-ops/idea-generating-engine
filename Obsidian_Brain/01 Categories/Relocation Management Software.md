---
type: category
name: "Relocation Management Software"
slug: "relocation-management"
---

# 📂 Category: Relocation Management Software

> G2 Software Category: Relocation Management Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Relocation Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Relocation Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Relocation Management Software")
SORT osi_score DESC
```