---
type: category
name: "Child Care Software"
slug: "child-care"
---

# 📂 Category: Child Care Software

> G2 Software Category: Child Care Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Child Care Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Child Care Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Child Care Software")
SORT osi_score DESC
```