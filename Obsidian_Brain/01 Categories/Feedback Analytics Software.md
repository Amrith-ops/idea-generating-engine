---
type: category
name: "Feedback Analytics Software"
slug: "feedback-analytics"
---

# 📂 Category: Feedback Analytics Software

> G2 Software Category: Feedback Analytics Software within Customer Service.
...
FROM "02 Products"
WHERE contains(category, "Feedback Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Feedback Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Feedback Analytics Software")
SORT osi_score DESC
```