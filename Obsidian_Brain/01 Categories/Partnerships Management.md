...
slug: "partnerships-management"
---

# 📂 Category: Partnerships Management

> G2 Software Category: Partnerships Management within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Partnerships Management") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Partnerships Management") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Partnerships Management")
SORT osi_score DESC
```