...
> G2 Software Category: Legal Practice Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Legal Practice Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Legal Practice Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Legal Practice Management Software")
SORT osi_score DESC
```