...
> G2 Software Category: Team Collaboration Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Team Collaboration Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Team Collaboration Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Team Collaboration Software")
SORT osi_score DESC
```