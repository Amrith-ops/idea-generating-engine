...
# 📂 Category: Visitor Management Software

> G2 Software Category: Visitor Management Software within Office Management Software.
...
FROM "02 Products"
WHERE contains(category, "Visitor Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Visitor Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Visitor Management Software")
SORT osi_score DESC
```