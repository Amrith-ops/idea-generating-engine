---
type: category
name: "Capital Project Management Software"
slug: "capital-project-management"
---

# 📂 Category: Capital Project Management Software

> G2 Software Category: Capital Project Management Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Capital Project Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Capital Project Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Capital Project Management Software")
SORT osi_score DESC
```