...
> G2 Software Category: Manufacturing within ERP.
...
FROM "02 Products"
WHERE contains(category, "Manufacturing") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Manufacturing") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Manufacturing")
SORT osi_score DESC
```