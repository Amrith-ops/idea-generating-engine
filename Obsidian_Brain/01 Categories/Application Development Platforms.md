---
type: category
name: "Application Development Platforms"
slug: "application-development-platforms"
---

# 📂 Category: Application Development Platforms

> G2 Software Category: Application Development Platforms within Development.
...
FROM "02 Products"
WHERE contains(category, "Application Development Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Application Development Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Application Development Platforms")
SORT osi_score DESC
```