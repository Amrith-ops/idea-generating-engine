---
type: category
name: "Online Proofing Software"
slug: "online-proofing"
---

# 📂 Category: Online Proofing Software

> G2 Software Category: Online Proofing Software within Content Management.
...
FROM "02 Products"
WHERE contains(category, "Online Proofing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Online Proofing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Online Proofing Software")
SORT osi_score DESC
```