...
# 📂 Category: Heatmap Tools

> G2 Software Category: Heatmap Tools within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Heatmap Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Heatmap Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Heatmap Tools")
SORT osi_score DESC
```