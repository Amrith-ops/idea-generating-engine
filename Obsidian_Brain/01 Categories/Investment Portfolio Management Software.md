---
type: category
name: "Investment Portfolio Management Software"
slug: "investment-portfolio-management"
---

# 📂 Category: Investment Portfolio Management Software

> G2 Software Category: Investment Portfolio Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Investment Portfolio Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Investment Portfolio Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Investment Portfolio Management Software")
SORT osi_score DESC
```