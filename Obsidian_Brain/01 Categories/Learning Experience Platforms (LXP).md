...
slug: "learning-experience-platforms-lxp"
---

# 📂 Category: Learning Experience Platforms (LXP)

> G2 Software Category: Learning Experience Platforms (LXP) within HR.
...
FROM "02 Products"
WHERE contains(category, "Learning Experience Platforms (LXP)") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Learning Experience Platforms (LXP)") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Learning Experience Platforms (LXP)")
SORT osi_score DESC
```