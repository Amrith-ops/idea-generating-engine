...
> G2 Software Category: Business Intelligence Software within Analytics Tools & Software.
...
FROM "02 Products"
WHERE contains(category, "Business Intelligence Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Business Intelligence Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Business Intelligence Software")
SORT osi_score DESC
```