---
type: category
name: "Procore App Marketplace Partners"
slug: "procore-app-marketplace-partners"
---

# 📂 Category: Procore App Marketplace Partners

> G2 Software Category: Procore App Marketplace Partners within Marketplace Apps.
...
FROM "02 Products"
WHERE contains(category, "Procore App Marketplace Partners") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Procore App Marketplace Partners") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Procore App Marketplace Partners")
SORT osi_score DESC
```