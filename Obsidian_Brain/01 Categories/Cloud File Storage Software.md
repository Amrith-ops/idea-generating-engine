---
type: category
name: "Cloud File Storage Software"
slug: "cloud-file-storage"
---

# 📂 Category: Cloud File Storage Software

> G2 Software Category: Cloud File Storage Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Cloud File Storage Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cloud File Storage Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cloud File Storage Software")
SORT osi_score DESC
```