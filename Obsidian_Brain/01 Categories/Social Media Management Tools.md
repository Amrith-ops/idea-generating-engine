...
> G2 Software Category: Social Media Management Tools within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Social Media Management Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Social Media Management Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Social Media Management Tools")
SORT osi_score DESC
```