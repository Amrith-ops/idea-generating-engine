---
type: category
name: "Retail IoT Software"
slug: "retail-iot"
---

# 📂 Category: Retail IoT Software

> G2 Software Category: Retail IoT Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Retail IoT Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Retail IoT Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Retail IoT Software")
SORT osi_score DESC
```