---
type: category
name: "Component Libraries Software"
slug: "component-libraries"
---

# 📂 Category: Component Libraries Software

> G2 Software Category: Component Libraries Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Component Libraries Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Component Libraries Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Component Libraries Software")
SORT osi_score DESC
```