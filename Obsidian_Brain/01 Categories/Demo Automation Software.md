---
type: category
name: "Demo Automation Software"
slug: "demo-automation"
---

# 📂 Category: Demo Automation Software

> G2 Software Category: Demo Automation Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Demo Automation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Demo Automation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Demo Automation Software")
SORT osi_score DESC
```