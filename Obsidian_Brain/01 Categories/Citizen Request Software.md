---
type: category
name: "Citizen Request Software"
slug: "citizen-request-software"
---

# 📂 Category: Citizen Request Software

> G2 Software Category: Citizen Request Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Citizen Request Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Citizen Request Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Citizen Request Software")
SORT osi_score DESC
```