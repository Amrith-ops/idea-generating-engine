---
type: category
name: "Other Development Software"
slug: "other-development"
---

# 📂 Category: Other Development Software

> G2 Software Category: Other Development Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Other Development Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Development Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Development Software")
SORT osi_score DESC
```