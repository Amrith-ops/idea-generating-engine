---
type: category
name: "Audience Intelligence Platforms"
slug: "audience-intelligence-platforms"
---

# 📂 Category: Audience Intelligence Platforms

> G2 Software Category: Audience Intelligence Platforms within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Audience Intelligence Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Audience Intelligence Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Audience Intelligence Platforms")
SORT osi_score DESC
```