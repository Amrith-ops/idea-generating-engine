---
type: category
name: "System Security Software"
slug: "system-security"
---

# 📂 Category: System Security Software

> G2 Software Category: System Security Software within Security.
...
FROM "02 Products"
WHERE contains(category, "System Security Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "System Security Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "System Security Software")
SORT osi_score DESC
```