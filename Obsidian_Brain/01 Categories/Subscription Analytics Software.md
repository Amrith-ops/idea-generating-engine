---
type: category
name: "Subscription Analytics Software"
slug: "subscription-analytics"
---

# 📂 Category: Subscription Analytics Software

> G2 Software Category: Subscription Analytics Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Subscription Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Subscription Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Subscription Analytics Software")
SORT osi_score DESC
```