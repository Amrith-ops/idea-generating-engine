...
# 📂 Category: Hotel Reservations Software

> G2 Software Category: Hotel Reservations Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Hotel Reservations Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Hotel Reservations Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Hotel Reservations Software")
SORT osi_score DESC
```