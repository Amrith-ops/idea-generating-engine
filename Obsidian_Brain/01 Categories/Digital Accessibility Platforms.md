---
type: category
name: "Digital Accessibility Platforms"
slug: "Digital-accessibility-platforms"
---

# 📂 Category: Digital Accessibility Platforms

> G2 Software Category: Digital Accessibility Platforms within Content Management.
...
FROM "02 Products"
WHERE contains(category, "Digital Accessibility Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Digital Accessibility Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Digital Accessibility Platforms")
SORT osi_score DESC
```