---
type: category
name: "Clinical Research Software"
slug: "clinical-research"
---

# 📂 Category: Clinical Research Software

> G2 Software Category: Clinical Research Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Clinical Research Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Clinical Research Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Clinical Research Software")
SORT osi_score DESC
```