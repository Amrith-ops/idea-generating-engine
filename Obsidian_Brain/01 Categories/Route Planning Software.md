...
> G2 Software Category: Route Planning Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Route Planning Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Route Planning Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Route Planning Software")
SORT osi_score DESC
```