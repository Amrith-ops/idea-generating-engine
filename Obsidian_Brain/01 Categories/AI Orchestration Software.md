---
type: category
name: "AI Orchestration Software"
slug: "ai-orchestration"
---

# 📂 Category: AI Orchestration Software

> G2 Software Category: AI Orchestration Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "AI Orchestration Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI Orchestration Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI Orchestration Software")
SORT osi_score DESC
```