...
> G2 Software Category: Energy Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Energy Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Energy Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Energy Management Software")
SORT osi_score DESC
```