---
type: category
name: "IT Risk Management Software"
slug: "it-risk-management"
---

# 📂 Category: IT Risk Management Software

> G2 Software Category: IT Risk Management Software within Security.
...
FROM "02 Products"
WHERE contains(category, "IT Risk Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "IT Risk Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "IT Risk Management Software")
SORT osi_score DESC
```