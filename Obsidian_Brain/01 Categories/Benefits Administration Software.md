---
type: category
name: "Benefits Administration Software"
slug: "benefits-administration"
---

# 📂 Category: Benefits Administration Software

> G2 Software Category: Benefits Administration Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Benefits Administration Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Benefits Administration Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Benefits Administration Software")
SORT osi_score DESC
```