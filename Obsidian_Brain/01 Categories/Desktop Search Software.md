---
type: category
name: "Desktop Search Software"
slug: "desktop-search"
---

# 📂 Category: Desktop Search Software

> G2 Software Category: Desktop Search Software within Content Management.
...
FROM "02 Products"
WHERE contains(category, "Desktop Search Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Desktop Search Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Desktop Search Software")
SORT osi_score DESC
```