...
slug: "ai-voice-dictation"
---

# 📂 Category: AI Voice Dictation

> G2 Software Category: AI Voice Dictation within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "AI Voice Dictation") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI Voice Dictation") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI Voice Dictation")
SORT osi_score DESC
```