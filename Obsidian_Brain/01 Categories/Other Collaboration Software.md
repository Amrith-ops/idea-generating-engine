---
type: category
name: "Other Collaboration Software"
slug: "other-collaboration"
---

# 📂 Category: Other Collaboration Software

> G2 Software Category: Other Collaboration Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Other Collaboration Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Collaboration Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Collaboration Software")
SORT osi_score DESC
```