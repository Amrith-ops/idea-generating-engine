---
type: category
name: "Other Cloud Integration Software"
slug: "other-cloud-integration"
---

# 📂 Category: Other Cloud Integration Software

> G2 Software Category: Other Cloud Integration Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Other Cloud Integration Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Cloud Integration Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Cloud Integration Software")
SORT osi_score DESC
```