---
type: category
name: "Social Discovery Software"
slug: "social-discovery"
---

# 📂 Category: Social Discovery Software

> G2 Software Category: Social Discovery Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Social Discovery Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Social Discovery Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Social Discovery Software")
SORT osi_score DESC
```