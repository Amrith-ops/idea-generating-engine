---
type: category
name: "AWS Marketplace Software"
slug: "aws-marketplace"
---

# 📂 Category: AWS Marketplace Software

> G2 Software Category: AWS Marketplace Software within Marketplace Apps.
...
FROM "02 Products"
WHERE contains(category, "AWS Marketplace Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AWS Marketplace Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AWS Marketplace Software")
SORT osi_score DESC
```