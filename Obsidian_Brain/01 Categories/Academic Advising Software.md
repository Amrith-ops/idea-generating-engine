---
type: category
name: "Academic Advising Software"
slug: "academic-advising"
---

# 📂 Category: Academic Advising Software

> G2 Software Category: Academic Advising Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Academic Advising Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Academic Advising Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Academic Advising Software")
SORT osi_score DESC
```