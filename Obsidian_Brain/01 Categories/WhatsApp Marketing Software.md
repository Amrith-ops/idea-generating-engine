...
> G2 Software Category: WhatsApp Marketing Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "WhatsApp Marketing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "WhatsApp Marketing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "WhatsApp Marketing Software")
SORT osi_score DESC
```