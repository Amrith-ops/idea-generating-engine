...
# 📂 Category: Supply Chain Visibility Software

> G2 Software Category: Supply Chain Visibility Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Supply Chain Visibility Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Supply Chain Visibility Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Supply Chain Visibility Software")
SORT osi_score DESC
```