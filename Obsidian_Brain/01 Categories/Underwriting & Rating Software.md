---
type: category
name: "Underwriting & Rating Software"
slug: "underwriting-rating"
---

# 📂 Category: Underwriting & Rating Software

> G2 Software Category: Underwriting & Rating Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Underwriting & Rating Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Underwriting & Rating Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Underwriting & Rating Software")
SORT osi_score DESC
```