---
type: category
name: "Application Shielding Software"
slug: "application-shielding"
---

# 📂 Category: Application Shielding Software

> G2 Software Category: Application Shielding Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Application Shielding Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Application Shielding Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Application Shielding Software")
SORT osi_score DESC
```