---
type: category
name: "Project Management Tools Software"
slug: "project-management-tools"
---

# 📂 Category: Project Management Tools Software

> G2 Software Category: Project Management Tools Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Project Management Tools Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Project Management Tools Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Project Management Tools Software")
SORT osi_score DESC
```