...
slug: "endpoint-protection-platforms"
---

# 📂 Category: Endpoint Protection Platforms

> G2 Software Category: Endpoint Protection Platforms within Security.
...
FROM "02 Products"
WHERE contains(category, "Endpoint Protection Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Endpoint Protection Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Endpoint Protection Platforms")
SORT osi_score DESC
```