...
> G2 Software Category: Content Marketing Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Content Marketing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Content Marketing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Content Marketing Software")
SORT osi_score DESC
```