---
type: category
name: "Media Monitoring Software"
slug: "media-monitoring"
---

# 📂 Category: Media Monitoring Software

> G2 Software Category: Media Monitoring Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Media Monitoring Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Media Monitoring Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Media Monitoring Software")
SORT osi_score DESC
```