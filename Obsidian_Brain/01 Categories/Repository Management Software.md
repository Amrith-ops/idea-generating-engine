---
type: category
name: "Repository Management Software"
slug: "repository-management"
---

# 📂 Category: Repository Management Software

> G2 Software Category: Repository Management Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Repository Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Repository Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Repository Management Software")
SORT osi_score DESC
```