---
type: category
name: "Customer Journey Mapping Tools"
slug: "customer-journey-mapping"
---

# 📂 Category: Customer Journey Mapping Tools

> G2 Software Category: Customer Journey Mapping Tools within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Customer Journey Mapping Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Customer Journey Mapping Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Customer Journey Mapping Tools")
SORT osi_score DESC
```