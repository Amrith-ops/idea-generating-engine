...
> G2 Software Category: Competitive Intelligence Tools within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Competitive Intelligence Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Competitive Intelligence Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Competitive Intelligence Tools")
SORT osi_score DESC
```