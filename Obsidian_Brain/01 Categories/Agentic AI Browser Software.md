---
type: category
name: "Agentic AI Browser Software"
slug: "agentic-ai-browser"
---

# 📂 Category: Agentic AI Browser Software

> G2 Software Category: Agentic AI Browser Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Agentic AI Browser Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Agentic AI Browser Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Agentic AI Browser Software")
SORT osi_score DESC
```