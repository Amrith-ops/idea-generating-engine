...
> G2 Software Category: Invoice Management Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Invoice Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Invoice Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Invoice Management Software")
SORT osi_score DESC
```