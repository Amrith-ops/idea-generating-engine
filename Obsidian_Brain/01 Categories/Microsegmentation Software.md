---
type: category
name: "Microsegmentation Software"
slug: "microsegmentation"
---

# 📂 Category: Microsegmentation Software

> G2 Software Category: Microsegmentation Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Microsegmentation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Microsegmentation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Microsegmentation Software")
SORT osi_score DESC
```