---
type: category
name: "Decision Management Software"
slug: "decision-management-platforms"
---

# 📂 Category: Decision Management Software

> G2 Software Category: Decision Management Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Decision Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Decision Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Decision Management Software")
SORT osi_score DESC
```