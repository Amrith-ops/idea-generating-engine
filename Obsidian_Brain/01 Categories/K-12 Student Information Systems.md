---
type: category
name: "K-12 Student Information Systems"
slug: "k-12-student-information-systems"
---

# 📂 Category: K-12 Student Information Systems

> G2 Software Category: K-12 Student Information Systems within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "K-12 Student Information Systems") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "K-12 Student Information Systems") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "K-12 Student Information Systems")
SORT osi_score DESC
```