...
> G2 Software Category: Payment Processing Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Payment Processing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Payment Processing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Payment Processing Software")
SORT osi_score DESC
```