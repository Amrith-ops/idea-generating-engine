---
type: category
name: "Taxi & Limousine Software"
slug: "taxi-limousine"
---

# 📂 Category: Taxi & Limousine Software

> G2 Software Category: Taxi & Limousine Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Taxi & Limousine Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Taxi & Limousine Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Taxi & Limousine Software")
SORT osi_score DESC
```