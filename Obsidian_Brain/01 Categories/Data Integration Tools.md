...
> G2 Software Category: Data Integration Tools within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Data Integration Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Integration Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Integration Tools")
SORT osi_score DESC
```