...
> G2 Software Category: EHR Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "EHR Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "EHR Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "EHR Software")
SORT osi_score DESC
```