...
> G2 Software Category: CMS Tools within Content Management.
...
FROM "02 Products"
WHERE contains(category, "CMS Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "CMS Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "CMS Tools")
SORT osi_score DESC
```