---
type: category
name: "Digital Customer Service Platforms"
slug: "digital-customer-service-platforms"
---

# 📂 Category: Digital Customer Service Platforms

> G2 Software Category: Digital Customer Service Platforms within Customer Service.
...
FROM "02 Products"
WHERE contains(category, "Digital Customer Service Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Digital Customer Service Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Digital Customer Service Platforms")
SORT osi_score DESC
```