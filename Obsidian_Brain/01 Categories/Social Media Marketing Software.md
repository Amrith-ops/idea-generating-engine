...
# 📂 Category: Social Media Marketing Software

> G2 Software Category: Social Media Marketing Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Social Media Marketing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Social Media Marketing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Social Media Marketing Software")
SORT osi_score DESC
```