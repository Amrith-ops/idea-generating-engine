---
type: category
name: "Chiropractic Software"
slug: "chiropractic"
---

# 📂 Category: Chiropractic Software

> G2 Software Category: Chiropractic Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Chiropractic Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Chiropractic Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Chiropractic Software")
SORT osi_score DESC
```