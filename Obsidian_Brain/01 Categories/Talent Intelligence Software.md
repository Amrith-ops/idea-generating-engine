---
type: category
name: "Talent Intelligence Software"
slug: "talent-intelligence"
---

# 📂 Category: Talent Intelligence Software

> G2 Software Category: Talent Intelligence Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Talent Intelligence Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Talent Intelligence Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Talent Intelligence Software")
SORT osi_score DESC
```