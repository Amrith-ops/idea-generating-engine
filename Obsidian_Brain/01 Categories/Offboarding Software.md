---
type: category
name: "Offboarding Software"
slug: "offboarding"
---

# 📂 Category: Offboarding Software

> G2 Software Category: Offboarding Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Offboarding Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Offboarding Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Offboarding Software")
SORT osi_score DESC
```