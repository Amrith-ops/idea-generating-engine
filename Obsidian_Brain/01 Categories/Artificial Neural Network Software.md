---
type: category
name: "Artificial Neural Network Software"
slug: "artificial-neural-network"
---

# 📂 Category: Artificial Neural Network Software

> G2 Software Category: Artificial Neural Network Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Artificial Neural Network Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Artificial Neural Network Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Artificial Neural Network Software")
SORT osi_score DESC
```