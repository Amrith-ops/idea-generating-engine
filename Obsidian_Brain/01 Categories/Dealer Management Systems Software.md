---
type: category
name: "Dealer Management Systems Software"
slug: "dealer-management-systems"
---

# 📂 Category: Dealer Management Systems Software

> G2 Software Category: Dealer Management Systems Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Dealer Management Systems Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Dealer Management Systems Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Dealer Management Systems Software")
SORT osi_score DESC
```