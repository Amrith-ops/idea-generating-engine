...
# 📂 Category: Remote Support Software

> G2 Software Category: Remote Support Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Remote Support Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Remote Support Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Remote Support Software")
SORT osi_score DESC
```