---
type: category
name: "Inbound Call Tracking Software"
slug: "inbound-call-tracking"
---

# 📂 Category: Inbound Call Tracking Software

> G2 Software Category: Inbound Call Tracking Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Inbound Call Tracking Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Inbound Call Tracking Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Inbound Call Tracking Software")
SORT osi_score DESC
```