---
type: category
name: "Note-Taking Software"
slug: "note-taking-software"
---

# 📂 Category: Note-Taking Software

> G2 Software Category: Note-Taking Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Note-Taking Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Note-Taking Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Note-Taking Software")
SORT osi_score DESC
```