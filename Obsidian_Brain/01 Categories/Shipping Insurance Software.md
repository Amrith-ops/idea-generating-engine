---
type: category
name: "Shipping Insurance Software"
slug: "shipping-insurance"
---

# 📂 Category: Shipping Insurance Software

> G2 Software Category: Shipping Insurance Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Shipping Insurance Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Shipping Insurance Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Shipping Insurance Software")
SORT osi_score DESC
```