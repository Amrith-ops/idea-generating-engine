---
type: category
name: "Other Fitness Software"
slug: "other-fitness"
---

# 📂 Category: Other Fitness Software

> G2 Software Category: Other Fitness Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Fitness Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Fitness Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Fitness Software")
SORT osi_score DESC
```