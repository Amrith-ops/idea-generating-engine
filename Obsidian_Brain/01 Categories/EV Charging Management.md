...
slug: "ev-charging-management"
---

# 📂 Category: EV Charging Management

> G2 Software Category: EV Charging Management within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "EV Charging Management") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "EV Charging Management") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "EV Charging Management")
SORT osi_score DESC
```