...
> G2 Software Category: Java Development Tools within Development.
...
FROM "02 Products"
WHERE contains(category, "Java Development Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Java Development Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Java Development Tools")
SORT osi_score DESC
```