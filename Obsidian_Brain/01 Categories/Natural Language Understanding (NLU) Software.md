---
type: category
name: "Natural Language Understanding (NLU) Software"
slug: "natural-language-understanding-nlu"
---

# 📂 Category: Natural Language Understanding (NLU) Software

> G2 Software Category: Natural Language Understanding (NLU) Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Natural Language Understanding (NLU) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Natural Language Understanding (NLU) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Natural Language Understanding (NLU) Software")
SORT osi_score DESC
```