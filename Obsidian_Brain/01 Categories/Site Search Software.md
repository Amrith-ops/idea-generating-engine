---
type: category
name: "Site Search Software"
slug: "site-search-software"
---

# 📂 Category: Site Search Software

> G2 Software Category: Site Search Software within Analytics Tools & Software.
...
FROM "02 Products"
WHERE contains(category, "Site Search Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Site Search Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Site Search Software")
SORT osi_score DESC
```