...
slug: "digital-experience-platforms-dxp"
---

# 📂 Category: Digital Experience Platforms (DXP)

> G2 Software Category: Digital Experience Platforms (DXP) within Content Management.
...
FROM "02 Products"
WHERE contains(category, "Digital Experience Platforms (DXP)") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Digital Experience Platforms (DXP)") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Digital Experience Platforms (DXP)")
SORT osi_score DESC
```