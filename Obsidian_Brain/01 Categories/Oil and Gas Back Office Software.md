---
type: category
name: "Oil and Gas Back Office Software"
slug: "oil-and-gas-back-office"
---

# 📂 Category: Oil and Gas Back Office Software

> G2 Software Category: Oil and Gas Back Office Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Oil and Gas Back Office Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Oil and Gas Back Office Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Oil and Gas Back Office Software")
SORT osi_score DESC
```