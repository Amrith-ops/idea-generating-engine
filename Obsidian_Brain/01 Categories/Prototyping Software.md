...
> G2 Software Category: Prototyping Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Prototyping Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Prototyping Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Prototyping Software")
SORT osi_score DESC
```