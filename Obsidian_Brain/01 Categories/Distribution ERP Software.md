---
type: category
name: "Distribution ERP Software"
slug: "distribution-erp"
---

# 📂 Category: Distribution ERP Software

> G2 Software Category: Distribution ERP Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Distribution ERP Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Distribution ERP Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Distribution ERP Software")
SORT osi_score DESC
```