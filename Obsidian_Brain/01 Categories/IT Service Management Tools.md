---
type: category
name: "IT Service Management Tools"
slug: "it-service-management-itsm-tools"
---

# 📂 Category: IT Service Management Tools

> G2 Software Category: IT Service Management Tools within IT Management.
...
FROM "02 Products"
WHERE contains(category, "IT Service Management Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "IT Service Management Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "IT Service Management Tools")
SORT osi_score DESC
```