...
> G2 Software Category: Real Estate Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Real Estate Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Real Estate Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Real Estate Software")
SORT osi_score DESC
```