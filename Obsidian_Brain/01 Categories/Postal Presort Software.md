---
type: category
name: "Postal Presort Software"
slug: "postal-presort"
---

# 📂 Category: Postal Presort Software

> G2 Software Category: Postal Presort Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Postal Presort Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Postal Presort Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Postal Presort Software")
SORT osi_score DESC
```