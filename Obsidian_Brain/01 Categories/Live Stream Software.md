---
type: category
name: "Live Stream Software"
slug: "live-stream-software"
---

# 📂 Category: Live Stream Software

> G2 Software Category: Live Stream Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Live Stream Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Live Stream Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Live Stream Software")
SORT osi_score DESC
```