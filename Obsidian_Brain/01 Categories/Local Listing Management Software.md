---
type: category
name: "Local Listing Management Software"
slug: "local-listing-management"
---

# 📂 Category: Local Listing Management Software

> G2 Software Category: Local Listing Management Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Local Listing Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Local Listing Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Local Listing Management Software")
SORT osi_score DESC
```