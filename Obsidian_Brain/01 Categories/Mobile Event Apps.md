---
type: category
name: "Mobile Event Apps"
slug: "mobile-event-apps"
---

# 📂 Category: Mobile Event Apps

> G2 Software Category: Mobile Event Apps within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Mobile Event Apps") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Mobile Event Apps") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Mobile Event Apps")
SORT osi_score DESC
```