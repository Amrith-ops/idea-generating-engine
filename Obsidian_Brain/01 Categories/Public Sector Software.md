---
type: category
name: "Public Sector Software"
slug: "public-sector"
---

# 📂 Category: Public Sector Software

> G2 Software Category: Public Sector Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Public Sector Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Public Sector Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Public Sector Software")
SORT osi_score DESC
```