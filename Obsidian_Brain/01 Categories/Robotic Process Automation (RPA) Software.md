---
type: category
name: "Robotic Process Automation (RPA) Software"
slug: "robotic-process-automation-rpa"
---

# 📂 Category: Robotic Process Automation (RPA) Software

> G2 Software Category: Robotic Process Automation (RPA) Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Robotic Process Automation (RPA) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Robotic Process Automation (RPA) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Robotic Process Automation (RPA) Software")
SORT osi_score DESC
```