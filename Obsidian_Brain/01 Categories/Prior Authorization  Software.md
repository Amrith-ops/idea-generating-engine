---
type: category
name: "Prior Authorization  Software"
slug: "prior-authorization"
---

# 📂 Category: Prior Authorization  Software

> G2 Software Category: Prior Authorization  Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Prior Authorization  Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Prior Authorization  Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Prior Authorization  Software")
SORT osi_score DESC
```