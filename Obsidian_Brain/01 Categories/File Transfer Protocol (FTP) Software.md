...
slug: "file-transfer-protocol-ftp"
---

# 📂 Category: File Transfer Protocol (FTP) Software

> G2 Software Category: File Transfer Protocol (FTP) Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "File Transfer Protocol (FTP) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "File Transfer Protocol (FTP) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "File Transfer Protocol (FTP) Software")
SORT osi_score DESC
```