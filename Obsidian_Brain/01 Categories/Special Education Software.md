---
type: category
name: "Special Education Software"
slug: "special-education"
---

# 📂 Category: Special Education Software

> G2 Software Category: Special Education Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Special Education Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Special Education Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Special Education Software")
SORT osi_score DESC
```