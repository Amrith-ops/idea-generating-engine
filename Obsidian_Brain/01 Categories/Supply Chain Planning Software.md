---
type: category
name: "Supply Chain Planning Software"
slug: "supply-chain-planning"
---

# 📂 Category: Supply Chain Planning Software

> G2 Software Category: Supply Chain Planning Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Supply Chain Planning Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Supply Chain Planning Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Supply Chain Planning Software")
SORT osi_score DESC
```