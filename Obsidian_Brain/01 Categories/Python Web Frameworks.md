...
> G2 Software Category: Python Web Frameworks within Development.
...
FROM "02 Products"
WHERE contains(category, "Python Web Frameworks") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Python Web Frameworks") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Python Web Frameworks")
SORT osi_score DESC
```