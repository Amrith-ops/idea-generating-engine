...
> G2 Software Category: OCR Software within Content Management.
...
FROM "02 Products"
WHERE contains(category, "OCR Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "OCR Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "OCR Software")
SORT osi_score DESC
```