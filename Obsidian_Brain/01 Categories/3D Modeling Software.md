...
> G2 Software Category: 3D Modeling Software within Design.
...
FROM "02 Products"
WHERE contains(category, "3D Modeling Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "3D Modeling Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "3D Modeling Software")
SORT osi_score DESC
```