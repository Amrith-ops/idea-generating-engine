---
type: category
name: "Other Laboratory Software"
slug: "other-laboratory"
---

# 📂 Category: Other Laboratory Software

> G2 Software Category: Other Laboratory Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Laboratory Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Laboratory Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Laboratory Software")
SORT osi_score DESC
```