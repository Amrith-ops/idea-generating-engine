---
type: category
name: "Email Encryption Software"
slug: "email-encryption"
---

# 📂 Category: Email Encryption Software

> G2 Software Category: Email Encryption Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Email Encryption Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Email Encryption Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Email Encryption Software")
SORT osi_score DESC
```