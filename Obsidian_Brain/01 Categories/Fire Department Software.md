---
type: category
name: "Fire Department Software"
slug: "fire-department"
---

# 📂 Category: Fire Department Software

> G2 Software Category: Fire Department Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Fire Department Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Fire Department Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Fire Department Software")
SORT osi_score DESC
```