---
type: category
name: "Public Relations (PR) Software"
slug: "public-relations-pr"
---

# 📂 Category: Public Relations (PR) Software

> G2 Software Category: Public Relations (PR) Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Public Relations (PR) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Public Relations (PR) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Public Relations (PR) Software")
SORT osi_score DESC
```