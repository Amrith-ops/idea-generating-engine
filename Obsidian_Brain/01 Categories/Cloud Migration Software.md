---
type: category
name: "Cloud Migration Software"
slug: "cloud-migration"
---

# 📂 Category: Cloud Migration Software

> G2 Software Category: Cloud Migration Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Cloud Migration Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cloud Migration Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cloud Migration Software")
SORT osi_score DESC
```