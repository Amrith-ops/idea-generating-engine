---
type: category
name: "Battery Storage Systems Providers"
slug: "battery-storage-systems"
---

# 📂 Category: Battery Storage Systems Providers

> G2 Software Category: Battery Storage Systems Providers within Greentech.
...
FROM "02 Products"
WHERE contains(category, "Battery Storage Systems Providers") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Battery Storage Systems Providers") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Battery Storage Systems Providers")
SORT osi_score DESC
```