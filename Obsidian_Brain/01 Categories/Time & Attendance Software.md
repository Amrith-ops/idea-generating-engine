...
# 📂 Category: Time & Attendance Software

> G2 Software Category: Time & Attendance Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Time & Attendance Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Time & Attendance Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Time & Attendance Software")
SORT osi_score DESC
```