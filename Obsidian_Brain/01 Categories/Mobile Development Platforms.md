---
type: category
name: "Mobile Development Platforms"
slug: "mobile-development-platforms"
---

# 📂 Category: Mobile Development Platforms

> G2 Software Category: Mobile Development Platforms within Development.
...
FROM "02 Products"
WHERE contains(category, "Mobile Development Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Mobile Development Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Mobile Development Platforms")
SORT osi_score DESC
```