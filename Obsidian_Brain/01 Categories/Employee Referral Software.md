...
# 📂 Category: Employee Referral Software

> G2 Software Category: Employee Referral Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Employee Referral Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Employee Referral Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Employee Referral Software")
SORT osi_score DESC
```