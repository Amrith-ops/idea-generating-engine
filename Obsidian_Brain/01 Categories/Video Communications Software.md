---
type: category
name: "Video Communications Software"
slug: "video-communications"
---

# 📂 Category: Video Communications Software

> G2 Software Category: Video Communications Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Video Communications Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Video Communications Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Video Communications Software")
SORT osi_score DESC
```