---
type: category
name: "Email Signature Software"
slug: "email-signature"
---

# 📂 Category: Email Signature Software

> G2 Software Category: Email Signature Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Email Signature Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Email Signature Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Email Signature Software")
SORT osi_score DESC
```