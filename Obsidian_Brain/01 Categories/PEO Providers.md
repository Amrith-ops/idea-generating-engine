...
# 📂 Category: PEO Providers

> G2 Software Category: PEO Providers within HR.
...
FROM "02 Products"
WHERE contains(category, "PEO Providers") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "PEO Providers") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "PEO Providers")
SORT osi_score DESC
```