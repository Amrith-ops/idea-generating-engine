...
# 📂 Category: Moving Company Software

> G2 Software Category: Moving Company Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Moving Company Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Moving Company Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Moving Company Software")
SORT osi_score DESC
```