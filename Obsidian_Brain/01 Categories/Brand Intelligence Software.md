---
type: category
name: "Brand Intelligence Software"
slug: "brand-intelligence"
---

# 📂 Category: Brand Intelligence Software

> G2 Software Category: Brand Intelligence Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Brand Intelligence Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Brand Intelligence Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Brand Intelligence Software")
SORT osi_score DESC
```