...
> G2 Software Category: Veterinary Practice Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Veterinary Practice Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Veterinary Practice Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Veterinary Practice Management Software")
SORT osi_score DESC
```