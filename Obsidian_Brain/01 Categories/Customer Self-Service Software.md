---
type: category
name: "Customer Self-Service Software"
slug: "customer-self-service"
---

# 📂 Category: Customer Self-Service Software

> G2 Software Category: Customer Self-Service Software within Customer Service.
...
FROM "02 Products"
WHERE contains(category, "Customer Self-Service Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Customer Self-Service Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Customer Self-Service Software")
SORT osi_score DESC
```