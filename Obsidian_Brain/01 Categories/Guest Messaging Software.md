...
# 📂 Category: Guest Messaging Software

> G2 Software Category: Guest Messaging Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Guest Messaging Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Guest Messaging Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Guest Messaging Software")
SORT osi_score DESC
```