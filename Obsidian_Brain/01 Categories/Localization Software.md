...
# 📂 Category: Localization Software

> G2 Software Category: Localization Software within Content Management.
...
FROM "02 Products"
WHERE contains(category, "Localization Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Localization Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Localization Software")
SORT osi_score DESC
```