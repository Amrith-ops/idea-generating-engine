---
type: category
name: "Exploration Software"
slug: "exploration"
---

# 📂 Category: Exploration Software

> G2 Software Category: Exploration Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Exploration Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Exploration Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Exploration Software")
SORT osi_score DESC
```