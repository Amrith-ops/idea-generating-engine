---
type: category
name: "Sales Coaching Software"
slug: "sales-coaching"
---

# 📂 Category: Sales Coaching Software

> G2 Software Category: Sales Coaching Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Sales Coaching Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Sales Coaching Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Sales Coaching Software")
SORT osi_score DESC
```