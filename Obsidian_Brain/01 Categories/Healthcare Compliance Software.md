...
# 📂 Category: Healthcare Compliance Software

> G2 Software Category: Healthcare Compliance Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Healthcare Compliance Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Healthcare Compliance Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Healthcare Compliance Software")
SORT osi_score DESC
```