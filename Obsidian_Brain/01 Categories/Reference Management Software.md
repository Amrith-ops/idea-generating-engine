...
> G2 Software Category: Reference Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Reference Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Reference Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Reference Management Software")
SORT osi_score DESC
```