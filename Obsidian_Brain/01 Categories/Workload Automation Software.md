---
type: category
name: "Workload Automation Software"
slug: "workload-automation"
---

# 📂 Category: Workload Automation Software

> G2 Software Category: Workload Automation Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Workload Automation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Workload Automation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Workload Automation Software")
SORT osi_score DESC
```