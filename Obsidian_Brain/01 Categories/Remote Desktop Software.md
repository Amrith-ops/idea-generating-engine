...
> G2 Software Category: Remote Desktop Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Remote Desktop Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Remote Desktop Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Remote Desktop Software")
SORT osi_score DESC
```