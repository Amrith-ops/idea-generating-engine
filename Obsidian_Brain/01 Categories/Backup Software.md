...
> G2 Software Category: Backup Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Backup Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Backup Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Backup Software")
SORT osi_score DESC
```