---
type: category
name: "Loan Servicing Software"
slug: "loan-servicing"
---

# 📂 Category: Loan Servicing Software

> G2 Software Category: Loan Servicing Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Loan Servicing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Loan Servicing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Loan Servicing Software")
SORT osi_score DESC
```