---
type: category
name: "Corporate Tax Software"
slug: "corporate-tax"
---

# 📂 Category: Corporate Tax Software

> G2 Software Category: Corporate Tax Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Corporate Tax Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Corporate Tax Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Corporate Tax Software")
SORT osi_score DESC
```