...
> G2 Software Category: Medical Imaging within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Medical Imaging") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Medical Imaging") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Medical Imaging")
SORT osi_score DESC
```