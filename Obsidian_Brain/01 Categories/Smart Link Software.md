---
type: category
name: "Smart Link Software"
slug: "smart-link"
---

# 📂 Category: Smart Link Software

> G2 Software Category: Smart Link Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Smart Link Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Smart Link Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Smart Link Software")
SORT osi_score DESC
```