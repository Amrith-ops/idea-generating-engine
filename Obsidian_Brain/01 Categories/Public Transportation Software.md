---
type: category
name: "Public Transportation Software"
slug: "public-transportation"
---

# 📂 Category: Public Transportation Software

> G2 Software Category: Public Transportation Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Public Transportation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Public Transportation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Public Transportation Software")
SORT osi_score DESC
```