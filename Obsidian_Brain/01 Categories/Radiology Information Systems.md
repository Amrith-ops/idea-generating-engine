...
# 📂 Category: Radiology Information Systems

> G2 Software Category: Radiology Information Systems within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Radiology Information Systems") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Radiology Information Systems") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Radiology Information Systems")
SORT osi_score DESC
```