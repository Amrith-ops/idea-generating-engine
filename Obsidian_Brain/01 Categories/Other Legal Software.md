---
type: category
name: "Other Legal Software"
slug: "other-legal"
---

# 📂 Category: Other Legal Software

> G2 Software Category: Other Legal Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Legal Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Legal Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Legal Software")
SORT osi_score DESC
```