...
# 📂 Category: Core HR Software

> G2 Software Category: Core HR Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Core HR Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Core HR Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Core HR Software")
SORT osi_score DESC
```