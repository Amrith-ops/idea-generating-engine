---
type: category
name: "Performing Arts Software"
slug: "performing-arts"
---

# 📂 Category: Performing Arts Software

> G2 Software Category: Performing Arts Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Performing Arts Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Performing Arts Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Performing Arts Software")
SORT osi_score DESC
```