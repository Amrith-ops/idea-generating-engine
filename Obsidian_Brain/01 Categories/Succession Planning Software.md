---
type: category
name: "Succession Planning Software"
slug: "succession-planning"
---

# 📂 Category: Succession Planning Software

> G2 Software Category: Succession Planning Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Succession Planning Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Succession Planning Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Succession Planning Software")
SORT osi_score DESC
```