...
> G2 Software Category: URL Shortener within Marketing.
...
FROM "02 Products"
WHERE contains(category, "URL Shortener") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "URL Shortener") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "URL Shortener")
SORT osi_score DESC
```