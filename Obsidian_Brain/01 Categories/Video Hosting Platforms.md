...
# 📂 Category: Video Hosting Platforms

> G2 Software Category: Video Hosting Platforms within Design.
...
FROM "02 Products"
WHERE contains(category, "Video Hosting Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Video Hosting Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Video Hosting Platforms")
SORT osi_score DESC
```