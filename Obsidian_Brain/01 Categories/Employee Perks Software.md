---
type: category
name: "Employee Perks Software"
slug: "employee-perks"
---

# 📂 Category: Employee Perks Software

> G2 Software Category: Employee Perks Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Employee Perks Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Employee Perks Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Employee Perks Software")
SORT osi_score DESC
```