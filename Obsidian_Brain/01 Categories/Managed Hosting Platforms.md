---
type: category
name: "Managed Hosting Platforms"
slug: "managed-hosting"
---

# 📂 Category: Managed Hosting Platforms

> G2 Software Category: Managed Hosting Platforms within Hosting.
...
FROM "02 Products"
WHERE contains(category, "Managed Hosting Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Managed Hosting Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Managed Hosting Platforms")
SORT osi_score DESC
```