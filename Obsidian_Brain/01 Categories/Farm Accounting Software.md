...
slug: "farm-accounting"
---

# 📂 Category: Farm Accounting Software

> G2 Software Category: Farm Accounting Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Farm Accounting Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Farm Accounting Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Farm Accounting Software")
SORT osi_score DESC
```