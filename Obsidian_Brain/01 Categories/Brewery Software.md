---
type: category
name: "Brewery Software"
slug: "brewery"
---

# 📂 Category: Brewery Software

> G2 Software Category: Brewery Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Brewery Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Brewery Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Brewery Software")
SORT osi_score DESC
```