...
> G2 Software Category: Video Conferencing Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Video Conferencing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Video Conferencing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Video Conferencing Software")
SORT osi_score DESC
```