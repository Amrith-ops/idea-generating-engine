...
> G2 Software Category: Field Sales Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Field Sales Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Field Sales Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Field Sales Software")
SORT osi_score DESC
```