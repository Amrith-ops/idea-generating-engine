...
# 📂 Category: Training eLearning Software

> G2 Software Category: Training eLearning Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Training eLearning Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Training eLearning Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Training eLearning Software")
SORT osi_score DESC
```