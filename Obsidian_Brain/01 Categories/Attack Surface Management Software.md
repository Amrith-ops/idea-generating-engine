...
# 📂 Category: Attack Surface Management Software

> G2 Software Category: Attack Surface Management Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Attack Surface Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Attack Surface Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Attack Surface Management Software")
SORT osi_score DESC
```