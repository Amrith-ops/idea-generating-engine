---
type: category
name: "Talent Marketplace Platforms"
slug: "talent-marketplace-platforms"
---

# 📂 Category: Talent Marketplace Platforms

> G2 Software Category: Talent Marketplace Platforms within HR.
...
FROM "02 Products"
WHERE contains(category, "Talent Marketplace Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Talent Marketplace Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Talent Marketplace Platforms")
SORT osi_score DESC
```