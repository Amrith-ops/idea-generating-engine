...
> G2 Software Category: E-Commerce Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "E-Commerce Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "E-Commerce Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "E-Commerce Software")
SORT osi_score DESC
```