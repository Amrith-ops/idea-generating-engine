---
type: category
name: "Data De-Identification Tools"
slug: "data-de-identification"
---

# 📂 Category: Data De-Identification Tools

> G2 Software Category: Data De-Identification Tools within Data Privacy.
...
FROM "02 Products"
WHERE contains(category, "Data De-Identification Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data De-Identification Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data De-Identification Tools")
SORT osi_score DESC
```