---
type: category
name: "WAN Optimization Software"
slug: "wan-optimization"
---

# 📂 Category: WAN Optimization Software

> G2 Software Category: WAN Optimization Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "WAN Optimization Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "WAN Optimization Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "WAN Optimization Software")
SORT osi_score DESC
```