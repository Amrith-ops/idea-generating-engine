---
type: category
name: "Other Real Estate Software"
slug: "other-real-estate"
---

# 📂 Category: Other Real Estate Software

> G2 Software Category: Other Real Estate Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Real Estate Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Real Estate Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Real Estate Software")
SORT osi_score DESC
```