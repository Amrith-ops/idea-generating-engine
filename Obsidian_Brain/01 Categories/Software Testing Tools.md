...
> G2 Software Category: Software Testing Tools within Development.
...
FROM "02 Products"
WHERE contains(category, "Software Testing Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Software Testing Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Software Testing Tools")
SORT osi_score DESC
```