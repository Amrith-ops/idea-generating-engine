---
type: category
name: "Photography Software"
slug: "photography"
---

# 📂 Category: Photography Software

> G2 Software Category: Photography Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Photography Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Photography Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Photography Software")
SORT osi_score DESC
```