---
type: category
name: "Other Automotive Software"
slug: "other-automotive"
---

# 📂 Category: Other Automotive Software

> G2 Software Category: Other Automotive Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Automotive Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Automotive Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Automotive Software")
SORT osi_score DESC
```