...
slug: "meeting-room-booking-systems"
---

# 📂 Category: Meeting Room Booking Systems

> G2 Software Category: Meeting Room Booking Systems within Office Management Software.
...
FROM "02 Products"
WHERE contains(category, "Meeting Room Booking Systems") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Meeting Room Booking Systems") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Meeting Room Booking Systems")
SORT osi_score DESC
```