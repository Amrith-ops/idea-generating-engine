---
type: category
name: "Exit Interview Management Software"
slug: "exit-interview-management"
---

# 📂 Category: Exit Interview Management Software

> G2 Software Category: Exit Interview Management Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Exit Interview Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Exit Interview Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Exit Interview Management Software")
SORT osi_score DESC
```