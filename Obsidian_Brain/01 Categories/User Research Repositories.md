---
type: category
name: "User Research Repositories"
slug: "user-research-repositories"
---

# 📂 Category: User Research Repositories

> G2 Software Category: User Research Repositories within Development.
...
FROM "02 Products"
WHERE contains(category, "User Research Repositories") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "User Research Repositories") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "User Research Repositories")
SORT osi_score DESC
```