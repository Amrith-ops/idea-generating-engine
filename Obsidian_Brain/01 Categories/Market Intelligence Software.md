---
type: category
name: "Market Intelligence Software"
slug: "market-intelligence"
---

# 📂 Category: Market Intelligence Software

> G2 Software Category: Market Intelligence Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Market Intelligence Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Market Intelligence Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Market Intelligence Software")
SORT osi_score DESC
```