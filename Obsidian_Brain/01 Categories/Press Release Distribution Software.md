---
type: category
name: "Press Release Distribution Software"
slug: "press-release-distribution"
---

# 📂 Category: Press Release Distribution Software

> G2 Software Category: Press Release Distribution Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Press Release Distribution Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Press Release Distribution Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Press Release Distribution Software")
SORT osi_score DESC
```