---
type: category
name: "Healthcare Risk Management Software"
slug: "healthcare-risk-management"
---

# 📂 Category: Healthcare Risk Management Software

> G2 Software Category: Healthcare Risk Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Healthcare Risk Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Healthcare Risk Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Healthcare Risk Management Software")
SORT osi_score DESC
```