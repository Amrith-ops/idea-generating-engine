...
> G2 Software Category: Virtual Tour Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Virtual Tour Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Virtual Tour Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Virtual Tour Software")
SORT osi_score DESC
```