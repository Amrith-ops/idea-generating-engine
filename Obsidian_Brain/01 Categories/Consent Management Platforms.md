...
> G2 Software Category: Consent Management Platforms within Data Privacy.
...
FROM "02 Products"
WHERE contains(category, "Consent Management Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Consent Management Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Consent Management Platforms")
SORT osi_score DESC
```