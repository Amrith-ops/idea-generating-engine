---
type: category
name: "Patient Intake Software"
slug: "patient-intake"
---

# 📂 Category: Patient Intake Software

> G2 Software Category: Patient Intake Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Patient Intake Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Patient Intake Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Patient Intake Software")
SORT osi_score DESC
```