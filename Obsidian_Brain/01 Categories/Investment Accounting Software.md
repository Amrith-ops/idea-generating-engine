---
type: category
name: "Investment Accounting Software"
slug: "investment-accounting"
---

# 📂 Category: Investment Accounting Software

> G2 Software Category: Investment Accounting Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Investment Accounting Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Investment Accounting Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Investment Accounting Software")
SORT osi_score DESC
```