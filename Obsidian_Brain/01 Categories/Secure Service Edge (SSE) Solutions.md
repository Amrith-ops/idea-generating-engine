---
type: category
name: "Secure Service Edge (SSE) Solutions"
slug: "secure-service-edge-sse-solutions"
---

# 📂 Category: Secure Service Edge (SSE) Solutions

> G2 Software Category: Secure Service Edge (SSE) Solutions within Security.
...
FROM "02 Products"
WHERE contains(category, "Secure Service Edge (SSE) Solutions") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Secure Service Edge (SSE) Solutions") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Secure Service Edge (SSE) Solutions")
SORT osi_score DESC
```