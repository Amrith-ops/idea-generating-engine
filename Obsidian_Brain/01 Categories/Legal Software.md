...
> G2 Software Category: Legal Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Legal Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Legal Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Legal Software")
SORT osi_score DESC
```