---
type: category
name: "Secure Enterprise Browser Software"
slug: "secure-enterprise-browser"
---

# 📂 Category: Secure Enterprise Browser Software

> G2 Software Category: Secure Enterprise Browser Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Secure Enterprise Browser Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Secure Enterprise Browser Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Secure Enterprise Browser Software")
SORT osi_score DESC
```