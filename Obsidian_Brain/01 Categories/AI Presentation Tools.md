...
> G2 Software Category: AI Presentation Tools within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "AI Presentation Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI Presentation Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI Presentation Tools")
SORT osi_score DESC
```