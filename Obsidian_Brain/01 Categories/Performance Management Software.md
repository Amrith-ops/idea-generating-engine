...
> G2 Software Category: Performance Management Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Performance Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Performance Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Performance Management Software")
SORT osi_score DESC
```