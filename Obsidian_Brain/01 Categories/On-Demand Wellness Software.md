---
type: category
name: "On-Demand Wellness Software"
slug: "on-demand-wellness"
---

# 📂 Category: On-Demand Wellness Software

> G2 Software Category: On-Demand Wellness Software within B2B Marketplaces.
...
FROM "02 Products"
WHERE contains(category, "On-Demand Wellness Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "On-Demand Wellness Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "On-Demand Wellness Software")
SORT osi_score DESC
```