...
> G2 Software Category: PCB Design Software within CAD & PLM.
...
FROM "02 Products"
WHERE contains(category, "PCB Design Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "PCB Design Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "PCB Design Software")
SORT osi_score DESC
```