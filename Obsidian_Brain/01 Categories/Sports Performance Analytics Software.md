---
type: category
name: "Sports Performance Analytics Software"
slug: "sports-performance-analytics"
---

# 📂 Category: Sports Performance Analytics Software

> G2 Software Category: Sports Performance Analytics Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Sports Performance Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Sports Performance Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Sports Performance Analytics Software")
SORT osi_score DESC
```