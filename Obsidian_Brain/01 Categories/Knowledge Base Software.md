...
> G2 Software Category: Knowledge Base Software within Content Management.
...
FROM "02 Products"
WHERE contains(category, "Knowledge Base Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Knowledge Base Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Knowledge Base Software")
SORT osi_score DESC
```