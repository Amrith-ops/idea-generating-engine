---
type: category
name: "Load Balancing Software"
slug: "load-balancing"
---

# 📂 Category: Load Balancing Software

> G2 Software Category: Load Balancing Software within Hosting.
...
FROM "02 Products"
WHERE contains(category, "Load Balancing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Load Balancing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Load Balancing Software")
SORT osi_score DESC
```