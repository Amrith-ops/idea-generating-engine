...
> G2 Software Category: Text-to-Music within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Text-to-Music") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Text-to-Music") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Text-to-Music")
SORT osi_score DESC
```