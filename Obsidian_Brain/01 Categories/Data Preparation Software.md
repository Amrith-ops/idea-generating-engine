---
type: category
name: "Data Preparation Software"
slug: "data-preparation"
---

# 📂 Category: Data Preparation Software

> G2 Software Category: Data Preparation Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Data Preparation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Preparation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Preparation Software")
SORT osi_score DESC
```