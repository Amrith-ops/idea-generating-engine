---
type: category
name: "Crypto Accounting Software"
slug: "crypto-accounting"
---

# 📂 Category: Crypto Accounting Software

> G2 Software Category: Crypto Accounting Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Crypto Accounting Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Crypto Accounting Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Crypto Accounting Software")
SORT osi_score DESC
```