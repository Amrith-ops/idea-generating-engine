---
type: category
name: "Online Proctoring Software"
slug: "online-proctoring"
---

# 📂 Category: Online Proctoring Software

> G2 Software Category: Online Proctoring Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Online Proctoring Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Online Proctoring Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Online Proctoring Software")
SORT osi_score DESC
```