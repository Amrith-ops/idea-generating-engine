---
type: category
name: "Video Effects Software"
slug: "video-effects"
---

# 📂 Category: Video Effects Software

> G2 Software Category: Video Effects Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Video Effects Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Video Effects Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Video Effects Software")
SORT osi_score DESC
```