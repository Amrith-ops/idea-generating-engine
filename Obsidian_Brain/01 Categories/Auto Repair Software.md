...
# 📂 Category: Auto Repair Software

> G2 Software Category: Auto Repair Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Auto Repair Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Auto Repair Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Auto Repair Software")
SORT osi_score DESC
```