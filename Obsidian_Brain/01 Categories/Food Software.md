...
# 📂 Category: Food Software

> G2 Software Category: Food Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Food Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Food Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Food Software")
SORT osi_score DESC
```