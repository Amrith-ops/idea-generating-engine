---
type: category
name: "Collaborative Whiteboard Software"
slug: "collaborative-whiteboard"
---

# 📂 Category: Collaborative Whiteboard Software

> G2 Software Category: Collaborative Whiteboard Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Collaborative Whiteboard Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Collaborative Whiteboard Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Collaborative Whiteboard Software")
SORT osi_score DESC
```