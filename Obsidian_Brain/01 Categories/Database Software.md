...
> G2 Software Category: Database Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Database Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Database Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Database Software")
SORT osi_score DESC
```