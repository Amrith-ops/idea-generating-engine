...
# 📂 Category: Security Compliance Software

> G2 Software Category: Security Compliance Software within Governance, Risk & Compliance.
...
FROM "02 Products"
WHERE contains(category, "Security Compliance Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Security Compliance Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Security Compliance Software")
SORT osi_score DESC
```