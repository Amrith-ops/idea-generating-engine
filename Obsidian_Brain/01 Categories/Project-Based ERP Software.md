---
type: category
name: "Project-Based ERP Software"
slug: "project-based-erp"
---

# 📂 Category: Project-Based ERP Software

> G2 Software Category: Project-Based ERP Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Project-Based ERP Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Project-Based ERP Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Project-Based ERP Software")
SORT osi_score DESC
```