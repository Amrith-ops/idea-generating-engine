---
type: category
name: "Audio Engine Software"
slug: "audio-engine"
---

# 📂 Category: Audio Engine Software

> G2 Software Category: Audio Engine Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Audio Engine Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Audio Engine Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Audio Engine Software")
SORT osi_score DESC
```