---
type: category
name: "Fleet Tracking Software"
slug: "fleet-tracking"
---

# 📂 Category: Fleet Tracking Software

> G2 Software Category: Fleet Tracking Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Fleet Tracking Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Fleet Tracking Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Fleet Tracking Software")
SORT osi_score DESC
```