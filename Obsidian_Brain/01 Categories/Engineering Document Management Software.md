---
type: category
name: "Engineering Document Management Software"
slug: "engineering-document-management"
---

# 📂 Category: Engineering Document Management Software

> G2 Software Category: Engineering Document Management Software within CAD & PLM.
...
FROM "02 Products"
WHERE contains(category, "Engineering Document Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Engineering Document Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Engineering Document Management Software")
SORT osi_score DESC
```