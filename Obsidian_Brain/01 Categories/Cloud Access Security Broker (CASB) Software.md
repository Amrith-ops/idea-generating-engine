---
type: category
name: "Cloud Access Security Broker (CASB) Software"
slug: "cloud-access-security-broker-casb"
---

# 📂 Category: Cloud Access Security Broker (CASB) Software

> G2 Software Category: Cloud Access Security Broker (CASB) Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Cloud Access Security Broker (CASB) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cloud Access Security Broker (CASB) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cloud Access Security Broker (CASB) Software")
SORT osi_score DESC
```