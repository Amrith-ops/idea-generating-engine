---
type: category
name: "Drug Discovery Software"
slug: "drug-discovery"
---

# 📂 Category: Drug Discovery Software

> G2 Software Category: Drug Discovery Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Drug Discovery Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Drug Discovery Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Drug Discovery Software")
SORT osi_score DESC
```