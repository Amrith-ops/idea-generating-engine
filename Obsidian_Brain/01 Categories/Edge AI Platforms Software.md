---
type: category
name: "Edge AI Platforms Software"
slug: "edge-ai-platforms"
---

# 📂 Category: Edge AI Platforms Software

> G2 Software Category: Edge AI Platforms Software within IoT Management.
...
FROM "02 Products"
WHERE contains(category, "Edge AI Platforms Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Edge AI Platforms Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Edge AI Platforms Software")
SORT osi_score DESC
```