---
type: category
name: "AI Sales Roleplay Tools"
slug: "ai-sales-roleplay-tools"
---

# 📂 Category: AI Sales Roleplay Tools

> G2 Software Category: AI Sales Roleplay Tools within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "AI Sales Roleplay Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI Sales Roleplay Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI Sales Roleplay Tools")
SORT osi_score DESC
```