---
type: category
name: "Player Support Platforms"
slug: "player-support-platforms"
---

# 📂 Category: Player Support Platforms

> G2 Software Category: Player Support Platforms within Development.
...
FROM "02 Products"
WHERE contains(category, "Player Support Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Player Support Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Player Support Platforms")
SORT osi_score DESC
```