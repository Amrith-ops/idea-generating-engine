---
type: category
name: "Museum Software"
slug: "museum"
---

# 📂 Category: Museum Software

> G2 Software Category: Museum Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Museum Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Museum Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Museum Software")
SORT osi_score DESC
```