...
# 📂 Category: Demand Generation Software

> G2 Software Category: Demand Generation Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Demand Generation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Demand Generation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Demand Generation Software")
SORT osi_score DESC
```