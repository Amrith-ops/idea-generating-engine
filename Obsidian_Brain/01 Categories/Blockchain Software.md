...
> G2 Software Category: Blockchain Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Blockchain Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Blockchain Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Blockchain Software")
SORT osi_score DESC
```