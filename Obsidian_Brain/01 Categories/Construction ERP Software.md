---
type: category
name: "Construction ERP Software"
slug: "construction-erp"
---

# 📂 Category: Construction ERP Software

> G2 Software Category: Construction ERP Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Construction ERP Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Construction ERP Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Construction ERP Software")
SORT osi_score DESC
```