---
type: category
name: "Education ERP Suites"
slug: "education-erp-suites"
---

# 📂 Category: Education ERP Suites

> G2 Software Category: Education ERP Suites within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Education ERP Suites") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Education ERP Suites") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Education ERP Suites")
SORT osi_score DESC
```