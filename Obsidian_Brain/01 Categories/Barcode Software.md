...
> G2 Software Category: Barcode Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Barcode Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Barcode Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Barcode Software")
SORT osi_score DESC
```