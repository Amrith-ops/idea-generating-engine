...
> G2 Software Category: Affiliate Marketing Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Affiliate Marketing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Affiliate Marketing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Affiliate Marketing Software")
SORT osi_score DESC
```