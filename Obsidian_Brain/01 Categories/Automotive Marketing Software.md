---
type: category
name: "Automotive Marketing Software"
slug: "automotive-marketing"
---

# 📂 Category: Automotive Marketing Software

> G2 Software Category: Automotive Marketing Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Automotive Marketing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Automotive Marketing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Automotive Marketing Software")
SORT osi_score DESC
```