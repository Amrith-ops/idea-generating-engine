---
type: category
name: "Chatbots Software"
slug: "chatbots"
---

# 📂 Category: Chatbots Software

> G2 Software Category: Chatbots Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Chatbots Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Chatbots Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Chatbots Software")
SORT osi_score DESC
```