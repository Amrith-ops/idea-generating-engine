---
type: category
name: "Through-Channel Marketing Software"
slug: "through-channel-marketing"
---

# 📂 Category: Through-Channel Marketing Software

> G2 Software Category: Through-Channel Marketing Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Through-Channel Marketing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Through-Channel Marketing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Through-Channel Marketing Software")
SORT osi_score DESC
```