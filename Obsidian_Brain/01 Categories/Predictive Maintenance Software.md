...
# 📂 Category: Predictive Maintenance Software

> G2 Software Category: Predictive Maintenance Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Predictive Maintenance Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Predictive Maintenance Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Predictive Maintenance Software")
SORT osi_score DESC
```