---
type: category
name: "Single Sign-On (SSO) Solutions"
slug: "single-sign-on-sso"
---

# 📂 Category: Single Sign-On (SSO) Solutions

> G2 Software Category: Single Sign-On (SSO) Solutions within Security.
...
FROM "02 Products"
WHERE contains(category, "Single Sign-On (SSO) Solutions") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Single Sign-On (SSO) Solutions") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Single Sign-On (SSO) Solutions")
SORT osi_score DESC
```