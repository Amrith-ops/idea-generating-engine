...
> G2 Software Category: RFID Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "RFID Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "RFID Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "RFID Software")
SORT osi_score DESC
```