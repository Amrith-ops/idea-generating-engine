---
type: category
name: "Email Client Software"
slug: "email-client"
---

# 📂 Category: Email Client Software

> G2 Software Category: Email Client Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Email Client Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Email Client Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Email Client Software")
SORT osi_score DESC
```