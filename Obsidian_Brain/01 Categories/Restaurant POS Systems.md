...
> G2 Software Category: Restaurant POS Systems within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Restaurant POS Systems") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Restaurant POS Systems") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Restaurant POS Systems")
SORT osi_score DESC
```