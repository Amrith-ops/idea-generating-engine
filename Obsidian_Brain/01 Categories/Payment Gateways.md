...
> G2 Software Category: Payment Gateways within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Payment Gateways") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Payment Gateways") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Payment Gateways")
SORT osi_score DESC
```