---
type: category
name: "Google Workspace Office Tools"
slug: "google-workspace-office-tools"
---

# 📂 Category: Google Workspace Office Tools

> G2 Software Category: Google Workspace Office Tools within Marketplace Apps.
...
FROM "02 Products"
WHERE contains(category, "Google Workspace Office Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Google Workspace Office Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Google Workspace Office Tools")
SORT osi_score DESC
```