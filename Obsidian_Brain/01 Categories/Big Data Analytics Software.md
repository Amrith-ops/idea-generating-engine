---
type: category
name: "Big Data Analytics Software"
slug: "big-data-analytics"
---

# 📂 Category: Big Data Analytics Software

> G2 Software Category: Big Data Analytics Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Big Data Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Big Data Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Big Data Analytics Software")
SORT osi_score DESC
```