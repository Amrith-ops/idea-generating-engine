...
> G2 Software Category: Browsers within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Browsers") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Browsers") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Browsers")
SORT osi_score DESC
```