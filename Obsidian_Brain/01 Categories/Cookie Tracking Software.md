---
type: category
name: "Cookie Tracking Software"
slug: "cookie-tracking"
---

# 📂 Category: Cookie Tracking Software

> G2 Software Category: Cookie Tracking Software within Data Privacy.
...
FROM "02 Products"
WHERE contains(category, "Cookie Tracking Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cookie Tracking Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cookie Tracking Software")
SORT osi_score DESC
```