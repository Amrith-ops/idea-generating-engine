...
# 📂 Category: Sales Acceleration Software

> G2 Software Category: Sales Acceleration Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Sales Acceleration Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Sales Acceleration Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Sales Acceleration Software")
SORT osi_score DESC
```