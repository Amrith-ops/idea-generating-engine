...
slug: "encryption-software"
---

# 📂 Category: Encryption Software

> G2 Software Category: Encryption Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Encryption Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Encryption Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Encryption Software")
SORT osi_score DESC
```