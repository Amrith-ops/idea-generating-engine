---
type: category
name: "Photogrammetry Software"
slug: "photogrammetry"
---

# 📂 Category: Photogrammetry Software

> G2 Software Category: Photogrammetry Software within CAD & PLM.
...
FROM "02 Products"
WHERE contains(category, "Photogrammetry Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Photogrammetry Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Photogrammetry Software")
SORT osi_score DESC
```