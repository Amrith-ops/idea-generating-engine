...
> G2 Software Category: Data Quality Tools within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Data Quality Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Quality Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Quality Tools")
SORT osi_score DESC
```