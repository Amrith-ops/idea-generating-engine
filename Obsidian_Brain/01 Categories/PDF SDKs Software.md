---
type: category
name: "PDF SDKs Software"
slug: "pdf-sdks"
---

# 📂 Category: PDF SDKs Software

> G2 Software Category: PDF SDKs Software within Development.
...
FROM "02 Products"
WHERE contains(category, "PDF SDKs Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "PDF SDKs Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "PDF SDKs Software")
SORT osi_score DESC
```