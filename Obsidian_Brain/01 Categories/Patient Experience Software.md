---
type: category
name: "Patient Experience Software"
slug: "patient-experience-88bbaea1-3b81-4636-8255-4b3ab72d3675"
---

# 📂 Category: Patient Experience Software

> G2 Software Category: Patient Experience Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Patient Experience Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Patient Experience Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Patient Experience Software")
SORT osi_score DESC
```