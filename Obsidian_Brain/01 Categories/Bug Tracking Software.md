...
> G2 Software Category: Bug Tracking Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Bug Tracking Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Bug Tracking Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Bug Tracking Software")
SORT osi_score DESC
```