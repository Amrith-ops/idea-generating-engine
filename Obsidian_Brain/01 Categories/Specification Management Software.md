---
type: category
name: "Specification Management Software"
slug: "specification-management"
---

# 📂 Category: Specification Management Software

> G2 Software Category: Specification Management Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Specification Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Specification Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Specification Management Software")
SORT osi_score DESC
```