---
type: category
name: "Project Cost Management Software"
slug: "project-cost-management"
---

# 📂 Category: Project Cost Management Software

> G2 Software Category: Project Cost Management Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Project Cost Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Project Cost Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Project Cost Management Software")
SORT osi_score DESC
```