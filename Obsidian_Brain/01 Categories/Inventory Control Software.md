...
> G2 Software Category: Inventory Control Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Inventory Control Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Inventory Control Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Inventory Control Software")
SORT osi_score DESC
```