...
# 📂 Category: Courier Software

> G2 Software Category: Courier Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Courier Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Courier Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Courier Software")
SORT osi_score DESC
```