---
type: category
name: "Physical Therapy Software"
slug: "physical-therapy"
---

# 📂 Category: Physical Therapy Software

> G2 Software Category: Physical Therapy Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Physical Therapy Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Physical Therapy Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Physical Therapy Software")
SORT osi_score DESC
```