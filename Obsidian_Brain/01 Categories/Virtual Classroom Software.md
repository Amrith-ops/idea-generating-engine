...
# 📂 Category: Virtual Classroom Software

> G2 Software Category: Virtual Classroom Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Virtual Classroom Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Virtual Classroom Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Virtual Classroom Software")
SORT osi_score DESC
```