---
type: category
name: "Real Estate Marketing Software"
slug: "real-estate-marketing"
---

# 📂 Category: Real Estate Marketing Software

> G2 Software Category: Real Estate Marketing Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Real Estate Marketing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Real Estate Marketing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Real Estate Marketing Software")
SORT osi_score DESC
```