---
type: category
name: "Legal Workflow Automation Software"
slug: "legal-workflow-automation"
---

# 📂 Category: Legal Workflow Automation Software

> G2 Software Category: Legal Workflow Automation Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Legal Workflow Automation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Legal Workflow Automation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Legal Workflow Automation Software")
SORT osi_score DESC
```