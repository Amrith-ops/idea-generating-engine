---
type: category
name: "Pharmacy Inventory Management Software"
slug: "pharmacy-inventory-management"
---

# 📂 Category: Pharmacy Inventory Management Software

> G2 Software Category: Pharmacy Inventory Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Pharmacy Inventory Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Pharmacy Inventory Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Pharmacy Inventory Management Software")
SORT osi_score DESC
```