---
type: category
name: "Other Hospitality Software"
slug: "other-hospitality"
---

# 📂 Category: Other Hospitality Software

> G2 Software Category: Other Hospitality Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Hospitality Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Hospitality Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Hospitality Software")
SORT osi_score DESC
```