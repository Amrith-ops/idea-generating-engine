...
slug: "virtual-desktop-infrastructure-vdi"
---

# 📂 Category: Virtual Desktop Infrastructure (VDI) Software

> G2 Software Category: Virtual Desktop Infrastructure (VDI) Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Virtual Desktop Infrastructure (VDI) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Virtual Desktop Infrastructure (VDI) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Virtual Desktop Infrastructure (VDI) Software")
SORT osi_score DESC
```