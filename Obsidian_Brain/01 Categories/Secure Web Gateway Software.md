---
type: category
name: "Secure Web Gateway Software"
slug: "secure-web-gateways"
---

# 📂 Category: Secure Web Gateway Software

> G2 Software Category: Secure Web Gateway Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Secure Web Gateway Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Secure Web Gateway Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Secure Web Gateway Software")
SORT osi_score DESC
```