...
# 📂 Category: IoT Security Solutions

> G2 Software Category: IoT Security Solutions within Security.
...
FROM "02 Products"
WHERE contains(category, "IoT Security Solutions") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "IoT Security Solutions") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "IoT Security Solutions")
SORT osi_score DESC
```