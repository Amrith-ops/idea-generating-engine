---
type: category
name: "Software Design Platforms"
slug: "software-design-platforms"
---

# 📂 Category: Software Design Platforms

> G2 Software Category: Software Design Platforms within Design.
...
FROM "02 Products"
WHERE contains(category, "Software Design Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Software Design Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Software Design Platforms")
SORT osi_score DESC
```