---
type: category
name: "Medication Dispensing Software"
slug: "medication-dispensing"
---

# 📂 Category: Medication Dispensing Software

> G2 Software Category: Medication Dispensing Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Medication Dispensing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Medication Dispensing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Medication Dispensing Software")
SORT osi_score DESC
```