...
# 📂 Category: Auto Dialer Software

> G2 Software Category: Auto Dialer Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Auto Dialer Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Auto Dialer Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Auto Dialer Software")
SORT osi_score DESC
```