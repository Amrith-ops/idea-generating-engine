---
type: category
name: "Food Traceability Software"
slug: "food-traceability"
---

# 📂 Category: Food Traceability Software

> G2 Software Category: Food Traceability Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Food Traceability Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Food Traceability Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Food Traceability Software")
SORT osi_score DESC
```