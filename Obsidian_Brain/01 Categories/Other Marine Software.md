---
type: category
name: "Other Marine Software"
slug: "other-marine"
---

# 📂 Category: Other Marine Software

> G2 Software Category: Other Marine Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Marine Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Marine Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Marine Software")
SORT osi_score DESC
```