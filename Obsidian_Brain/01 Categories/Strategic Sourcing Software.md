---
type: category
name: "Strategic Sourcing Software"
slug: "strategic-sourcing"
---

# 📂 Category: Strategic Sourcing Software

> G2 Software Category: Strategic Sourcing Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Strategic Sourcing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Strategic Sourcing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Strategic Sourcing Software")
SORT osi_score DESC
```