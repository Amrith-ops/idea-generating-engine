...
# 📂 Category: Loan Software

> G2 Software Category: Loan Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Loan Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Loan Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Loan Software")
SORT osi_score DESC
```