---
type: category
name: "Supplier Relationship Management (SRM) Software"
slug: "supplier-relationship-management-srm"
---

# 📂 Category: Supplier Relationship Management (SRM) Software

> G2 Software Category: Supplier Relationship Management (SRM) Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Supplier Relationship Management (SRM) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Supplier Relationship Management (SRM) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Supplier Relationship Management (SRM) Software")
SORT osi_score DESC
```