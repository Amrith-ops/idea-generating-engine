...
slug: "purchasing-software"
---

# 📂 Category: Purchasing Software

> G2 Software Category: Purchasing Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Purchasing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Purchasing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Purchasing Software")
SORT osi_score DESC
```