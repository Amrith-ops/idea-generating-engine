...
> G2 Software Category: Cryptocurrency Exchanges within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Cryptocurrency Exchanges") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cryptocurrency Exchanges") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cryptocurrency Exchanges")
SORT osi_score DESC
```