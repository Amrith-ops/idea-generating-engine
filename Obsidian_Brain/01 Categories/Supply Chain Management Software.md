...
> G2 Software Category: Supply Chain Management Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Supply Chain Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Supply Chain Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Supply Chain Management Software")
SORT osi_score DESC
```