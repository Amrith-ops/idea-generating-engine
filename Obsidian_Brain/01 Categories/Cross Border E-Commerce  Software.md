---
type: category
name: "Cross Border E-Commerce  Software"
slug: "cross-border-e-commerce"
---

# 📂 Category: Cross Border E-Commerce  Software

> G2 Software Category: Cross Border E-Commerce  Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Cross Border E-Commerce  Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cross Border E-Commerce  Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cross Border E-Commerce  Software")
SORT osi_score DESC
```