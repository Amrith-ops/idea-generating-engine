---
type: category
name: "Handwritten Notes Software"
slug: "handwritten-notes"
---

# 📂 Category: Handwritten Notes Software

> G2 Software Category: Handwritten Notes Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Handwritten Notes Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Handwritten Notes Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Handwritten Notes Software")
SORT osi_score DESC
```