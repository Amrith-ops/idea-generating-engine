---
type: category
name: "Digital Wayfinding Software"
slug: "digital-wayfinding"
---

# 📂 Category: Digital Wayfinding Software

> G2 Software Category: Digital Wayfinding Software within Office Management Software.
...
FROM "02 Products"
WHERE contains(category, "Digital Wayfinding Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Digital Wayfinding Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Digital Wayfinding Software")
SORT osi_score DESC
```