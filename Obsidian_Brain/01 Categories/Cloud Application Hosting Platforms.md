---
type: category
name: "Cloud Application Hosting Platforms"
slug: "cloud-application-hosting"
---

# 📂 Category: Cloud Application Hosting Platforms

> G2 Software Category: Cloud Application Hosting Platforms within Hosting.
...
FROM "02 Products"
WHERE contains(category, "Cloud Application Hosting Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cloud Application Hosting Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cloud Application Hosting Platforms")
SORT osi_score DESC
```