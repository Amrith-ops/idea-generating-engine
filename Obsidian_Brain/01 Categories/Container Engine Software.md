---
type: category
name: "Container Engine Software"
slug: "container-engine"
---

# 📂 Category: Container Engine Software

> G2 Software Category: Container Engine Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Container Engine Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Container Engine Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Container Engine Software")
SORT osi_score DESC
```