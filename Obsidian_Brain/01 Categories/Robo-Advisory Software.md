---
type: category
name: "Robo-Advisory Software"
slug: "robo-advisory"
---

# 📂 Category: Robo-Advisory Software

> G2 Software Category: Robo-Advisory Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Robo-Advisory Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Robo-Advisory Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Robo-Advisory Software")
SORT osi_score DESC
```