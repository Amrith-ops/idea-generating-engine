---
type: category
name: "Event Networking and Matchmaking"
slug: "event-networking-and-matchmaking"
---

# 📂 Category: Event Networking and Matchmaking

> G2 Software Category: Event Networking and Matchmaking within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Event Networking and Matchmaking") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Event Networking and Matchmaking") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Event Networking and Matchmaking")
SORT osi_score DESC
```