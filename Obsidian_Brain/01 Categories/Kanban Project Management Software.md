---
type: category
name: "Kanban Project Management Software"
slug: "kanban-project-management"
---

# 📂 Category: Kanban Project Management Software

> G2 Software Category: Kanban Project Management Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Kanban Project Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Kanban Project Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Kanban Project Management Software")
SORT osi_score DESC
```