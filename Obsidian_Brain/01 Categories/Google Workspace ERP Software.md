---
type: category
name: "Google Workspace ERP Software"
slug: "google-workspace-erp"
---

# 📂 Category: Google Workspace ERP Software

> G2 Software Category: Google Workspace ERP Software within Marketplace Apps.
...
FROM "02 Products"
WHERE contains(category, "Google Workspace ERP Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Google Workspace ERP Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Google Workspace ERP Software")
SORT osi_score DESC
```