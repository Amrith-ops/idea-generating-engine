---
type: category
name: "Document Creation Software"
slug: "document-creation"
---

# 📂 Category: Document Creation Software

> G2 Software Category: Document Creation Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Document Creation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Document Creation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Document Creation Software")
SORT osi_score DESC
```