---
type: category
name: "Healthcare Analytics Software"
slug: "healthcare-analytics"
---

# 📂 Category: Healthcare Analytics Software

> G2 Software Category: Healthcare Analytics Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Healthcare Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Healthcare Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Healthcare Analytics Software")
SORT osi_score DESC
```