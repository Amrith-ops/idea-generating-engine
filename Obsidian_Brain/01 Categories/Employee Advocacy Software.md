---
type: category
name: "Employee Advocacy Software"
slug: "employee-advocacy"
---

# 📂 Category: Employee Advocacy Software

> G2 Software Category: Employee Advocacy Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Employee Advocacy Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Employee Advocacy Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Employee Advocacy Software")
SORT osi_score DESC
```