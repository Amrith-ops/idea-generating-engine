---
type: category
name: "Location-Based Marketing Software"
slug: "location-based-marketing"
---

# 📂 Category: Location-Based Marketing Software

> G2 Software Category: Location-Based Marketing Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Location-Based Marketing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Location-Based Marketing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Location-Based Marketing Software")
SORT osi_score DESC
```