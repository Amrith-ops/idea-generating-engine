---
type: category
name: "Other Pharmacy Software"
slug: "other-pharmacy"
---

# 📂 Category: Other Pharmacy Software

> G2 Software Category: Other Pharmacy Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Pharmacy Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Pharmacy Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Pharmacy Software")
SORT osi_score DESC
```