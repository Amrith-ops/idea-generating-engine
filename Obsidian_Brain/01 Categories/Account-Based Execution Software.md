---
type: category
name: "Account-Based Execution Software"
slug: "account-based-execution"
---

# 📂 Category: Account-Based Execution Software

> G2 Software Category: Account-Based Execution Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Account-Based Execution Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Account-Based Execution Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Account-Based Execution Software")
SORT osi_score DESC
```