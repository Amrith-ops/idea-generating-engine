---
type: category
name: "Systems Engineering & MBSE Tools"
slug: "systems-engineering-and-mbse"
---

# 📂 Category: Systems Engineering & MBSE Tools

> G2 Software Category: Systems Engineering & MBSE Tools within CAD & PLM.
...
FROM "02 Products"
WHERE contains(category, "Systems Engineering & MBSE Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Systems Engineering & MBSE Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Systems Engineering & MBSE Tools")
SORT osi_score DESC
```