...
# 📂 Category: ALM Software

> G2 Software Category: ALM Software within Development.
...
FROM "02 Products"
WHERE contains(category, "ALM Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "ALM Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "ALM Software")
SORT osi_score DESC
```