---
type: category
name: "Insurance CRM Software"
slug: "insurance-crm"
---

# 📂 Category: Insurance CRM Software

> G2 Software Category: Insurance CRM Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Insurance CRM Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Insurance CRM Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Insurance CRM Software")
SORT osi_score DESC
```