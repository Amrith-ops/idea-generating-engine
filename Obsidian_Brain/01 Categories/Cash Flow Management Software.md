---
type: category
name: "Cash Flow Management Software"
slug: "cash-flow-management"
---

# 📂 Category: Cash Flow Management Software

> G2 Software Category: Cash Flow Management Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Cash Flow Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cash Flow Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cash Flow Management Software")
SORT osi_score DESC
```