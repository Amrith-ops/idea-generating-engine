...
> G2 Software Category: Help Desk Software within Customer Service.
...
FROM "02 Products"
WHERE contains(category, "Help Desk Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Help Desk Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Help Desk Software")
SORT osi_score DESC
```