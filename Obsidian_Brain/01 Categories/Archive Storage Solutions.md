---
type: category
name: "Archive Storage Solutions"
slug: "archive-storage-solutions"
---

# 📂 Category: Archive Storage Solutions

> G2 Software Category: Archive Storage Solutions within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Archive Storage Solutions") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Archive Storage Solutions") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Archive Storage Solutions")
SORT osi_score DESC
```