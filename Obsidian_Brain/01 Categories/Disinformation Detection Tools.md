---
type: category
name: "Disinformation Detection Tools"
slug: "disinformation-detection-tools"
---

# 📂 Category: Disinformation Detection Tools

> G2 Software Category: Disinformation Detection Tools within Security.
...
FROM "02 Products"
WHERE contains(category, "Disinformation Detection Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Disinformation Detection Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Disinformation Detection Tools")
SORT osi_score DESC
```