...
> G2 Software Category: Vector Graphics Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Vector Graphics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Vector Graphics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Vector Graphics Software")
SORT osi_score DESC
```