---
type: category
name: "Healthcare Supply Chain Software"
slug: "healthcare-supply-chain"
---

# 📂 Category: Healthcare Supply Chain Software

> G2 Software Category: Healthcare Supply Chain Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Healthcare Supply Chain Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Healthcare Supply Chain Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Healthcare Supply Chain Software")
SORT osi_score DESC
```