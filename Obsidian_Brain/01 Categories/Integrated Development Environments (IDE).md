...
slug: "integrated-development-environments-ide"
---

# 📂 Category: Integrated Development Environments (IDE)

> G2 Software Category: Integrated Development Environments (IDE) within Development.
...
FROM "02 Products"
WHERE contains(category, "Integrated Development Environments (IDE)") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Integrated Development Environments (IDE)") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Integrated Development Environments (IDE)")
SORT osi_score DESC
```