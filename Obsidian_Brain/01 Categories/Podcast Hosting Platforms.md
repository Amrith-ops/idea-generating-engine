---
type: category
name: "Podcast Hosting Platforms"
slug: "podcast-hosting"
---

# 📂 Category: Podcast Hosting Platforms

> G2 Software Category: Podcast Hosting Platforms within Design.
...
FROM "02 Products"
WHERE contains(category, "Podcast Hosting Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Podcast Hosting Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Podcast Hosting Platforms")
SORT osi_score DESC
```