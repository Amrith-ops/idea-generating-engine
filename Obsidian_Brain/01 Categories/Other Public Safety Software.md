---
type: category
name: "Other Public Safety Software"
slug: "other-public-safety"
---

# 📂 Category: Other Public Safety Software

> G2 Software Category: Other Public Safety Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Public Safety Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Public Safety Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Public Safety Software")
SORT osi_score DESC
```