---
type: category
name: "Book Marketing Tools"
slug: "book-marketing-tools"
---

# 📂 Category: Book Marketing Tools

> G2 Software Category: Book Marketing Tools within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Book Marketing Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Book Marketing Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Book Marketing Tools")
SORT osi_score DESC
```