---
type: category
name: "Donor Prospect Research Software"
slug: "donor-prospect-research"
---

# 📂 Category: Donor Prospect Research Software

> G2 Software Category: Donor Prospect Research Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Donor Prospect Research Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Donor Prospect Research Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Donor Prospect Research Software")
SORT osi_score DESC
```