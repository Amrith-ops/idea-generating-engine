---
type: category
name: "Mobile Attribution Platforms"
slug: "mobile-attribution"
---

# 📂 Category: Mobile Attribution Platforms

> G2 Software Category: Mobile Attribution Platforms within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Mobile Attribution Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Mobile Attribution Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Mobile Attribution Platforms")
SORT osi_score DESC
```