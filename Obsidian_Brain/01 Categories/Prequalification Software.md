---
type: category
name: "Prequalification Software"
slug: "prequalification"
---

# 📂 Category: Prequalification Software

> G2 Software Category: Prequalification Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Prequalification Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Prequalification Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Prequalification Software")
SORT osi_score DESC
```