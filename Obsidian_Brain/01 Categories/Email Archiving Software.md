---
type: category
name: "Email Archiving Software"
slug: "email-archiving"
---

# 📂 Category: Email Archiving Software

> G2 Software Category: Email Archiving Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Email Archiving Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Email Archiving Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Email Archiving Software")
SORT osi_score DESC
```