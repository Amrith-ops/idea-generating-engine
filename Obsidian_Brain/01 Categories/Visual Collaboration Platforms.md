---
type: category
name: "Visual Collaboration Platforms"
slug: "visual-collaboration-platforms"
---

# 📂 Category: Visual Collaboration Platforms

> G2 Software Category: Visual Collaboration Platforms within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Visual Collaboration Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Visual Collaboration Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Visual Collaboration Platforms")
SORT osi_score DESC
```