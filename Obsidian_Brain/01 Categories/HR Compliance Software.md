---
type: category
name: "HR Compliance Software"
slug: "hr-compliance"
---

# 📂 Category: HR Compliance Software

> G2 Software Category: HR Compliance Software within HR.
...
FROM "02 Products"
WHERE contains(category, "HR Compliance Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "HR Compliance Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "HR Compliance Software")
SORT osi_score DESC
```