---
type: category
name: "Social Customer Service Software"
slug: "social-customer-service"
---

# 📂 Category: Social Customer Service Software

> G2 Software Category: Social Customer Service Software within Customer Service.
...
FROM "02 Products"
WHERE contains(category, "Social Customer Service Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Social Customer Service Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Social Customer Service Software")
SORT osi_score DESC
```