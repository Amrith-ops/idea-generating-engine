---
type: category
name: "Procurement Orchestration Software"
slug: "procurement-orchestration"
---

# 📂 Category: Procurement Orchestration Software

> G2 Software Category: Procurement Orchestration Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Procurement Orchestration Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Procurement Orchestration Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Procurement Orchestration Software")
SORT osi_score DESC
```