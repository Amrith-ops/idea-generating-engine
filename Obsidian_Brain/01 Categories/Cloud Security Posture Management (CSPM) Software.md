---
type: category
name: "Cloud Security Posture Management (CSPM) Software"
slug: "cloud-security-posture-management-cspm"
---

# 📂 Category: Cloud Security Posture Management (CSPM) Software

> G2 Software Category: Cloud Security Posture Management (CSPM) Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Cloud Security Posture Management (CSPM) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cloud Security Posture Management (CSPM) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cloud Security Posture Management (CSPM) Software")
SORT osi_score DESC
```