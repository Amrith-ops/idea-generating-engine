...
> G2 Software Category: Data Management Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Data Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Management Software")
SORT osi_score DESC
```