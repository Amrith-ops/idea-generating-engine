---
type: category
name: "Data Exchange Platforms"
slug: "data-exchange-platforms"
---

# 📂 Category: Data Exchange Platforms

> G2 Software Category: Data Exchange Platforms within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Data Exchange Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Exchange Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Exchange Platforms")
SORT osi_score DESC
```