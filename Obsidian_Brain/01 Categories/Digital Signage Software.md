...
> G2 Software Category: Digital Signage Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Digital Signage Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Digital Signage Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Digital Signage Software")
SORT osi_score DESC
```