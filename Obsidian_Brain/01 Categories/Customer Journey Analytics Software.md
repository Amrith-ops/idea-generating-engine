---
type: category
name: "Customer Journey Analytics Software"
slug: "customer-journey-analytics"
---

# 📂 Category: Customer Journey Analytics Software

> G2 Software Category: Customer Journey Analytics Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Customer Journey Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Customer Journey Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Customer Journey Analytics Software")
SORT osi_score DESC
```