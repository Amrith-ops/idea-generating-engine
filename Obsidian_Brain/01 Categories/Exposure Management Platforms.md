---
type: category
name: "Exposure Management Platforms"
slug: "exposure-management-platforms"
---

# 📂 Category: Exposure Management Platforms

> G2 Software Category: Exposure Management Platforms within Security.
...
FROM "02 Products"
WHERE contains(category, "Exposure Management Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Exposure Management Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Exposure Management Platforms")
SORT osi_score DESC
```