---
type: category
name: "Virtual Fitting Software"
slug: "virtual-fitting"
---

# 📂 Category: Virtual Fitting Software

> G2 Software Category: Virtual Fitting Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Virtual Fitting Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Virtual Fitting Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Virtual Fitting Software")
SORT osi_score DESC
```