...
> G2 Software Category: DevOps Software within Development.
...
FROM "02 Products"
WHERE contains(category, "DevOps Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "DevOps Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "DevOps Software")
SORT osi_score DESC
```