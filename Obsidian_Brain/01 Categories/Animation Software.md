...
> G2 Software Category: Animation Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Animation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Animation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Animation Software")
SORT osi_score DESC
```