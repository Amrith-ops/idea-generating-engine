---
type: category
name: "Push-To-Talk (PTT) Software"
slug: "push-to-talk-ptt"
---

# 📂 Category: Push-To-Talk (PTT) Software

> G2 Software Category: Push-To-Talk (PTT) Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Push-To-Talk (PTT) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Push-To-Talk (PTT) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Push-To-Talk (PTT) Software")
SORT osi_score DESC
```