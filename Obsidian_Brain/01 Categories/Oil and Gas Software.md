---
type: category
name: "Oil and Gas Software"
slug: "oil-and-gas"
---

# 📂 Category: Oil and Gas Software

> G2 Software Category: Oil and Gas Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Oil and Gas Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Oil and Gas Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Oil and Gas Software")
SORT osi_score DESC
```