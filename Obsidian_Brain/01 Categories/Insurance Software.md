...
> G2 Software Category: Insurance Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Insurance Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Insurance Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Insurance Software")
SORT osi_score DESC
```