---
type: category
name: "Other IT Infrastructure Software"
slug: "other-it-infrastructure"
---

# 📂 Category: Other IT Infrastructure Software

> G2 Software Category: Other IT Infrastructure Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Other IT Infrastructure Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other IT Infrastructure Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other IT Infrastructure Software")
SORT osi_score DESC
```