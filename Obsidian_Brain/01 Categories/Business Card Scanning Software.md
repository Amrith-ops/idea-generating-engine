---
type: category
name: "Business Card Scanning Software"
slug: "business-card-scanning"
---

# 📂 Category: Business Card Scanning Software

> G2 Software Category: Business Card Scanning Software within Office Management Software.
...
FROM "02 Products"
WHERE contains(category, "Business Card Scanning Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Business Card Scanning Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Business Card Scanning Software")
SORT osi_score DESC
```