...
# 📂 Category: CMMS Software

> G2 Software Category: CMMS Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "CMMS Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "CMMS Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "CMMS Software")
SORT osi_score DESC
```