---
type: category
name: "ADP Marketplace Apps Software"
slug: "adp-marketplace-apps"
---

# 📂 Category: ADP Marketplace Apps Software

> G2 Software Category: ADP Marketplace Apps Software within Marketplace Apps.
...
FROM "02 Products"
WHERE contains(category, "ADP Marketplace Apps Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "ADP Marketplace Apps Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "ADP Marketplace Apps Software")
SORT osi_score DESC
```