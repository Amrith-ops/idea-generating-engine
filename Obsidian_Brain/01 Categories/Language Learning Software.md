...
> G2 Software Category: Language Learning Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Language Learning Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Language Learning Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Language Learning Software")
SORT osi_score DESC
```