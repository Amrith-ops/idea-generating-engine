...
slug: "user-generated-content-platforms"
---

# 📂 Category: User-Generated Content Platforms

> G2 Software Category: User-Generated Content Platforms within Content Management.
...
FROM "02 Products"
WHERE contains(category, "User-Generated Content Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "User-Generated Content Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "User-Generated Content Platforms")
SORT osi_score DESC
```