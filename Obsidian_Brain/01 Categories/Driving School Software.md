---
type: category
name: "Driving School Software"
slug: "driving-school"
---

# 📂 Category: Driving School Software

> G2 Software Category: Driving School Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Driving School Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Driving School Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Driving School Software")
SORT osi_score DESC
```