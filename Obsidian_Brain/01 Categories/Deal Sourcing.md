...
> G2 Software Category: Deal Sourcing within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Deal Sourcing") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Deal Sourcing") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Deal Sourcing")
SORT osi_score DESC
```