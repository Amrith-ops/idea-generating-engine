---
type: category
name: "3D Painting Software"
slug: "3d-painting"
---

# 📂 Category: 3D Painting Software

> G2 Software Category: 3D Painting Software within Design.
...
FROM "02 Products"
WHERE contains(category, "3D Painting Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "3D Painting Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "3D Painting Software")
SORT osi_score DESC
```