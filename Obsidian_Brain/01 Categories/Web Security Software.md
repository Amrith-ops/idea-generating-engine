---
type: category
name: "Web Security Software"
slug: "web-security"
---

# 📂 Category: Web Security Software

> G2 Software Category: Web Security Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Web Security Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Web Security Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Web Security Software")
SORT osi_score DESC
```