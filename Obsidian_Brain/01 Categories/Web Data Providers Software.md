---
type: category
name: "Web Data Providers Software"
slug: "web-data-providers"
---

# 📂 Category: Web Data Providers Software

> G2 Software Category: Web Data Providers Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Web Data Providers Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Web Data Providers Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Web Data Providers Software")
SORT osi_score DESC
```