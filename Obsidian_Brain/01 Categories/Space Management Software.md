---
type: category
name: "Space Management Software"
slug: "space-management"
---

# 📂 Category: Space Management Software

> G2 Software Category: Space Management Software within Office Management Software.
...
FROM "02 Products"
WHERE contains(category, "Space Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Space Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Space Management Software")
SORT osi_score DESC
```