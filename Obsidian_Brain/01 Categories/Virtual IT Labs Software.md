---
type: category
name: "Virtual IT Labs Software"
slug: "virtual-it-labs"
---

# 📂 Category: Virtual IT Labs Software

> G2 Software Category: Virtual IT Labs Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Virtual IT Labs Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Virtual IT Labs Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Virtual IT Labs Software")
SORT osi_score DESC
```