...
# 📂 Category: Budgeting and Forecasting Software

> G2 Software Category: Budgeting and Forecasting Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Budgeting and Forecasting Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Budgeting and Forecasting Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Budgeting and Forecasting Software")
SORT osi_score DESC
```