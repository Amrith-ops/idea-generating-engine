---
type: category
name: "Digital Analytics Software"
slug: "digital-analytics"
---

# 📂 Category: Digital Analytics Software

> G2 Software Category: Digital Analytics Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Digital Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Digital Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Digital Analytics Software")
SORT osi_score DESC
```