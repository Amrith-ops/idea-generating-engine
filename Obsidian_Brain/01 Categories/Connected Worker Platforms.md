---
type: category
name: "Connected Worker Platforms"
slug: "connected-worker-platform"
---

# 📂 Category: Connected Worker Platforms

> G2 Software Category: Connected Worker Platforms within ERP.
...
FROM "02 Products"
WHERE contains(category, "Connected Worker Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Connected Worker Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Connected Worker Platforms")
SORT osi_score DESC
```