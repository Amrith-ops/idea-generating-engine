---
type: category
name: "Landscape Design Software"
slug: "landscape-design"
---

# 📂 Category: Landscape Design Software

> G2 Software Category: Landscape Design Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Landscape Design Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Landscape Design Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Landscape Design Software")
SORT osi_score DESC
```