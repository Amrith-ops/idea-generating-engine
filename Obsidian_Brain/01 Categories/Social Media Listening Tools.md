---
type: category
name: "Social Media Listening Tools"
slug: "social-media-listening-tools"
---

# 📂 Category: Social Media Listening Tools

> G2 Software Category: Social Media Listening Tools within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Social Media Listening Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Social Media Listening Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Social Media Listening Tools")
SORT osi_score DESC
```