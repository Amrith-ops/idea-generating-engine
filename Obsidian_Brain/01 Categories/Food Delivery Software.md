...
> G2 Software Category: Food Delivery Software within B2B Marketplaces.
...
FROM "02 Products"
WHERE contains(category, "Food Delivery Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Food Delivery Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Food Delivery Software")
SORT osi_score DESC
```