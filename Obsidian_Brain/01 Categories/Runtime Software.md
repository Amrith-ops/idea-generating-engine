...
> G2 Software Category: Runtime Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Runtime Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Runtime Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Runtime Software")
SORT osi_score DESC
```