---
type: category
name: "Spreadsheets Software"
slug: "spreadsheets"
---

# 📂 Category: Spreadsheets Software

> G2 Software Category: Spreadsheets Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Spreadsheets Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Spreadsheets Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Spreadsheets Software")
SORT osi_score DESC
```