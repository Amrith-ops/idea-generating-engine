---
type: category
name: "Managed File Transfer (MFT) Software"
slug: "managed-file-transfer-mft"
---

# 📂 Category: Managed File Transfer (MFT) Software

> G2 Software Category: Managed File Transfer (MFT) Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Managed File Transfer (MFT) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Managed File Transfer (MFT) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Managed File Transfer (MFT) Software")
SORT osi_score DESC
```