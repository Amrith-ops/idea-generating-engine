...
> G2 Software Category: Employee Scheduling Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Employee Scheduling Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Employee Scheduling Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Employee Scheduling Software")
SORT osi_score DESC
```