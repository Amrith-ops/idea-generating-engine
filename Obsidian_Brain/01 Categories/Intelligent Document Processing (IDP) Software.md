---
type: category
name: "Intelligent Document Processing (IDP) Software"
slug: "intelligent-document-processing-idp"
---

# 📂 Category: Intelligent Document Processing (IDP) Software

> G2 Software Category: Intelligent Document Processing (IDP) Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Intelligent Document Processing (IDP) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Intelligent Document Processing (IDP) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Intelligent Document Processing (IDP) Software")
SORT osi_score DESC
```