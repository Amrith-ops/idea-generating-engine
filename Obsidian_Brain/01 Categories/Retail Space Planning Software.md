---
type: category
name: "Retail Space Planning Software"
slug: "retail-space-planning"
---

# 📂 Category: Retail Space Planning Software

> G2 Software Category: Retail Space Planning Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Retail Space Planning Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Retail Space Planning Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Retail Space Planning Software")
SORT osi_score DESC
```