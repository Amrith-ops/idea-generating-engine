---
type: category
name: "Student Health Records Software"
slug: "student-health-records"
---

# 📂 Category: Student Health Records Software

> G2 Software Category: Student Health Records Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Student Health Records Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Student Health Records Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Student Health Records Software")
SORT osi_score DESC
```