---
type: category
name: "Loan Pricing Software"
slug: "loan-pricing"
---

# 📂 Category: Loan Pricing Software

> G2 Software Category: Loan Pricing Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Loan Pricing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Loan Pricing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Loan Pricing Software")
SORT osi_score DESC
```