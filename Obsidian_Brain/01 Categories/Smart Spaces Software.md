---
type: category
name: "Smart Spaces Software"
slug: "smart-spaces"
---

# 📂 Category: Smart Spaces Software

> G2 Software Category: Smart Spaces Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Smart Spaces Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Smart Spaces Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Smart Spaces Software")
SORT osi_score DESC
```