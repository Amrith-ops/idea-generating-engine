...
> G2 Software Category: Restaurant Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Restaurant Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Restaurant Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Restaurant Software")
SORT osi_score DESC
```