---
type: category
name: "Other Child Care Software"
slug: "other-child-care"
---

# 📂 Category: Other Child Care Software

> G2 Software Category: Other Child Care Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Child Care Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Child Care Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Child Care Software")
SORT osi_score DESC
```