---
type: category
name: "Embedded Integration Platforms"
slug: "embedded-integration-platforms"
---

# 📂 Category: Embedded Integration Platforms

> G2 Software Category: Embedded Integration Platforms within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Embedded Integration Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Embedded Integration Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Embedded Integration Platforms")
SORT osi_score DESC
```