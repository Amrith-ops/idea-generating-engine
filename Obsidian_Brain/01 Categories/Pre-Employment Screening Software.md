---
type: category
name: "Pre-Employment Screening Software"
slug: "pre-employment-screening"
---

# 📂 Category: Pre-Employment Screening Software

> G2 Software Category: Pre-Employment Screening Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Pre-Employment Screening Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Pre-Employment Screening Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Pre-Employment Screening Software")
SORT osi_score DESC
```