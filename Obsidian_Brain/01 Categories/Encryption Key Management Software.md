---
type: category
name: "Encryption Key Management Software"
slug: "encryption-key-management"
---

# 📂 Category: Encryption Key Management Software

> G2 Software Category: Encryption Key Management Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Encryption Key Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Encryption Key Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Encryption Key Management Software")
SORT osi_score DESC
```