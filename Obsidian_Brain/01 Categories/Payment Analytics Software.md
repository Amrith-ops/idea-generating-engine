---
type: category
name: "Payment Analytics Software"
slug: "payment-analytics"
---

# 📂 Category: Payment Analytics Software

> G2 Software Category: Payment Analytics Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Payment Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Payment Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Payment Analytics Software")
SORT osi_score DESC
```