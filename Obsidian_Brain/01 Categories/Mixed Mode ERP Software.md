---
type: category
name: "Mixed Mode ERP Software"
slug: "mixed-mode-erp"
---

# 📂 Category: Mixed Mode ERP Software

> G2 Software Category: Mixed Mode ERP Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Mixed Mode ERP Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Mixed Mode ERP Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Mixed Mode ERP Software")
SORT osi_score DESC
```