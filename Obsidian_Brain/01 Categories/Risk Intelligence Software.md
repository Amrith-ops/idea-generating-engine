---
type: category
name: "Risk Intelligence Software"
slug: "risk-intelligence"
---

# 📂 Category: Risk Intelligence Software

> G2 Software Category: Risk Intelligence Software within Governance, Risk & Compliance.
...
FROM "02 Products"
WHERE contains(category, "Risk Intelligence Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Risk Intelligence Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Risk Intelligence Software")
SORT osi_score DESC
```