...
> G2 Software Category: Attribution Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Attribution Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Attribution Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Attribution Software")
SORT osi_score DESC
```