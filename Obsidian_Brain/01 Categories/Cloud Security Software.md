---
type: category
name: "Cloud Security Software"
slug: "cloud-security"
---

# 📂 Category: Cloud Security Software

> G2 Software Category: Cloud Security Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Cloud Security Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cloud Security Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cloud Security Software")
SORT osi_score DESC
```