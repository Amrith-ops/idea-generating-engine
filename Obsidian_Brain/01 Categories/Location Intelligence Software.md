---
type: category
name: "Location Intelligence Software"
slug: "location-intelligence"
---

# 📂 Category: Location Intelligence Software

> G2 Software Category: Location Intelligence Software within Analytics Tools & Software.
...
FROM "02 Products"
WHERE contains(category, "Location Intelligence Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Location Intelligence Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Location Intelligence Software")
SORT osi_score DESC
```