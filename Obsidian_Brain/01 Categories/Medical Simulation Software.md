---
type: category
name: "Medical Simulation Software"
slug: "medical-simulation"
---

# 📂 Category: Medical Simulation Software

> G2 Software Category: Medical Simulation Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Medical Simulation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Medical Simulation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Medical Simulation Software")
SORT osi_score DESC
```