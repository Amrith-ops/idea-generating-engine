...
> G2 Software Category: Photo Editing Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Photo Editing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Photo Editing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Photo Editing Software")
SORT osi_score DESC
```