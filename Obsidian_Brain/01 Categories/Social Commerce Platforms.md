...
slug: "social-commerce-platforms"
---

# 📂 Category: Social Commerce Platforms

> G2 Software Category: Social Commerce Platforms within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Social Commerce Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Social Commerce Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Social Commerce Platforms")
SORT osi_score DESC
```