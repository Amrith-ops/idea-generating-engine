---
type: category
name: "AI Marketing Agents Software"
slug: "ai-marketing-agents"
---

# 📂 Category: AI Marketing Agents Software

> G2 Software Category: AI Marketing Agents Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "AI Marketing Agents Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI Marketing Agents Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI Marketing Agents Software")
SORT osi_score DESC
```