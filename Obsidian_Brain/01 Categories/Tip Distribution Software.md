---
type: category
name: "Tip Distribution Software"
slug: "tip-distribution"
---

# 📂 Category: Tip Distribution Software

> G2 Software Category: Tip Distribution Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Tip Distribution Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Tip Distribution Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Tip Distribution Software")
SORT osi_score DESC
```