---
type: category
name: "Health Savings Account (HSA) Software"
slug: "health-savings-account-hsa"
---

# 📂 Category: Health Savings Account (HSA) Software

> G2 Software Category: Health Savings Account (HSA) Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Health Savings Account (HSA) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Health Savings Account (HSA) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Health Savings Account (HSA) Software")
SORT osi_score DESC
```