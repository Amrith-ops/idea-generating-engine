---
type: category
name: "Sales Performance Management Software"
slug: "sales-performance-management"
---

# 📂 Category: Sales Performance Management Software

> G2 Software Category: Sales Performance Management Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Sales Performance Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Sales Performance Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Sales Performance Management Software")
SORT osi_score DESC
```