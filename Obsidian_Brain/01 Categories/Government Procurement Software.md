---
type: category
name: "Government Procurement Software"
slug: "government-procurement"
---

# 📂 Category: Government Procurement Software

> G2 Software Category: Government Procurement Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Government Procurement Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Government Procurement Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Government Procurement Software")
SORT osi_score DESC
```