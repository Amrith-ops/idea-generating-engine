---
type: category
name: "Compensation Management Software"
slug: "compensation-management"
---

# 📂 Category: Compensation Management Software

> G2 Software Category: Compensation Management Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Compensation Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Compensation Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Compensation Management Software")
SORT osi_score DESC
```