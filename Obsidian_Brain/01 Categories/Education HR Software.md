---
type: category
name: "Education HR Software"
slug: "education-hr"
---

# 📂 Category: Education HR Software

> G2 Software Category: Education HR Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Education HR Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Education HR Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Education HR Software")
SORT osi_score DESC
```