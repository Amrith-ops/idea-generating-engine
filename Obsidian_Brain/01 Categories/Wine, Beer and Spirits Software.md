---
type: category
name: "Wine, Beer and Spirits Software"
slug: "wine-beer-and-spirits"
---

# 📂 Category: Wine, Beer and Spirits Software

> G2 Software Category: Wine, Beer and Spirits Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Wine, Beer and Spirits Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Wine, Beer and Spirits Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Wine, Beer and Spirits Software")
SORT osi_score DESC
```