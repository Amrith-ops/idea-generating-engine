...
> G2 Software Category: E-Commerce Platforms within Commerce.
...
FROM "02 Products"
WHERE contains(category, "E-Commerce Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "E-Commerce Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "E-Commerce Platforms")
SORT osi_score DESC
```