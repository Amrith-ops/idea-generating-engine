---
type: category
name: "Stock Media Software"
slug: "stock-media"
---

# 📂 Category: Stock Media Software

> G2 Software Category: Stock Media Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Stock Media Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Stock Media Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Stock Media Software")
SORT osi_score DESC
```