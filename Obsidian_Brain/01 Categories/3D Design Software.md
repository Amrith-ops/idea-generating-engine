...
> G2 Software Category: 3D Design Software within Design.
...
FROM "02 Products"
WHERE contains(category, "3D Design Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "3D Design Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "3D Design Software")
SORT osi_score DESC
```