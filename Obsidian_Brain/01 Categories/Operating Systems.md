...
> G2 Software Category: Operating Systems within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Operating Systems") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Operating Systems") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Operating Systems")
SORT osi_score DESC
```