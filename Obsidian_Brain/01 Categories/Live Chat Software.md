...
> G2 Software Category: Live Chat Software within Customer Service.
...
FROM "02 Products"
WHERE contains(category, "Live Chat Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Live Chat Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Live Chat Software")
SORT osi_score DESC
```