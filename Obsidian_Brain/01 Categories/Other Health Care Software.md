---
type: category
name: "Other Health Care Software"
slug: "other-health-care"
---

# 📂 Category: Other Health Care Software

> G2 Software Category: Other Health Care Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Health Care Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Health Care Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Health Care Software")
SORT osi_score DESC
```