---
type: category
name: "Hackathon Software"
slug: "hackathon-software"
---

# 📂 Category: Hackathon Software

> G2 Software Category: Hackathon Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Hackathon Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Hackathon Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Hackathon Software")
SORT osi_score DESC
```