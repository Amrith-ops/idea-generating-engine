---
type: category
name: "Online Form Builder Software"
slug: "online-form-builder"
---

# 📂 Category: Online Form Builder Software

> G2 Software Category: Online Form Builder Software within Content Management.
...
FROM "02 Products"
WHERE contains(category, "Online Form Builder Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Online Form Builder Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Online Form Builder Software")
SORT osi_score DESC
```