---
type: category
name: "Contractor of Record Software"
slug: "contractor-of-record"
---

# 📂 Category: Contractor of Record Software

> G2 Software Category: Contractor of Record Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Contractor of Record Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Contractor of Record Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Contractor of Record Software")
SORT osi_score DESC
```