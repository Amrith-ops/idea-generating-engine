---
type: category
name: "Meeting Management Software"
slug: "meeting-management"
---

# 📂 Category: Meeting Management Software

> G2 Software Category: Meeting Management Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Meeting Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Meeting Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Meeting Management Software")
SORT osi_score DESC
```