---
type: category
name: "Lease Administration Software"
slug: "lease-administration"
---

# 📂 Category: Lease Administration Software

> G2 Software Category: Lease Administration Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Lease Administration Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Lease Administration Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Lease Administration Software")
SORT osi_score DESC
```