---
type: category
name: "Email Anti-spam Software"
slug: "email-anti-spam"
---

# 📂 Category: Email Anti-spam Software

> G2 Software Category: Email Anti-spam Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Email Anti-spam Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Email Anti-spam Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Email Anti-spam Software")
SORT osi_score DESC
```