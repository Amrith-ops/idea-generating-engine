---
type: category
name: "Other Process Automation Software"
slug: "other-process-automation"
---

# 📂 Category: Other Process Automation Software

> G2 Software Category: Other Process Automation Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Other Process Automation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Process Automation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Process Automation Software")
SORT osi_score DESC
```