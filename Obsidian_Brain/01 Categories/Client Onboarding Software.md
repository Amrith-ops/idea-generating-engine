...
> G2 Software Category: Client Onboarding Software within Customer Service.
...
FROM "02 Products"
WHERE contains(category, "Client Onboarding Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Client Onboarding Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Client Onboarding Software")
SORT osi_score DESC
```