---
type: category
name: "Workplace Innovation Platforms"
slug: "workplace-innovation-platforms"
---

# 📂 Category: Workplace Innovation Platforms

> G2 Software Category: Workplace Innovation Platforms within Development.
...
FROM "02 Products"
WHERE contains(category, "Workplace Innovation Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Workplace Innovation Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Workplace Innovation Platforms")
SORT osi_score DESC
```