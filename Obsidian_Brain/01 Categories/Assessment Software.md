...
# 📂 Category: Assessment Software

> G2 Software Category: Assessment Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Assessment Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Assessment Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Assessment Software")
SORT osi_score DESC
```