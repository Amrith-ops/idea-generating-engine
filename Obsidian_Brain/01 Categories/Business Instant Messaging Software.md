---
type: category
name: "Business Instant Messaging Software"
slug: "business-instant-messaging"
---

# 📂 Category: Business Instant Messaging Software

> G2 Software Category: Business Instant Messaging Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Business Instant Messaging Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Business Instant Messaging Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Business Instant Messaging Software")
SORT osi_score DESC
```