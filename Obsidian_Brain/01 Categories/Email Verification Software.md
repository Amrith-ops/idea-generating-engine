---
type: category
name: "Email Verification Software"
slug: "email-verification"
---

# 📂 Category: Email Verification Software

> G2 Software Category: Email Verification Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Email Verification Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Email Verification Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Email Verification Software")
SORT osi_score DESC
```