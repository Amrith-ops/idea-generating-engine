---
type: category
name: "Winery Software"
slug: "winery"
---

# 📂 Category: Winery Software

> G2 Software Category: Winery Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Winery Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Winery Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Winery Software")
SORT osi_score DESC
```