---
type: category
name: "Employee Communications Software"
slug: "employee-communications"
---

# 📂 Category: Employee Communications Software

> G2 Software Category: Employee Communications Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Employee Communications Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Employee Communications Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Employee Communications Software")
SORT osi_score DESC
```