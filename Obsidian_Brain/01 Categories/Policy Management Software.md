...
# 📂 Category: Policy Management Software

> G2 Software Category: Policy Management Software within Governance, Risk & Compliance.
...
FROM "02 Products"
WHERE contains(category, "Policy Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Policy Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Policy Management Software")
SORT osi_score DESC
```