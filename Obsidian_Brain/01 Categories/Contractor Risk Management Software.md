---
type: category
name: "Contractor Risk Management Software"
slug: "contractor-risk-management"
---

# 📂 Category: Contractor Risk Management Software

> G2 Software Category: Contractor Risk Management Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Contractor Risk Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Contractor Risk Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Contractor Risk Management Software")
SORT osi_score DESC
```