---
type: category
name: "Tax Practice Management Software"
slug: "tax-practice-management"
---

# 📂 Category: Tax Practice Management Software

> G2 Software Category: Tax Practice Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Tax Practice Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Tax Practice Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Tax Practice Management Software")
SORT osi_score DESC
```