---
type: category
name: "Google Workspace for Sales Software"
slug: "google-workspace-for-sales"
---

# 📂 Category: Google Workspace for Sales Software

> G2 Software Category: Google Workspace for Sales Software within Marketplace Apps.
...
FROM "02 Products"
WHERE contains(category, "Google Workspace for Sales Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Google Workspace for Sales Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Google Workspace for Sales Software")
SORT osi_score DESC
```