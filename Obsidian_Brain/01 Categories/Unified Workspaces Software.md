---
type: category
name: "Unified Workspaces Software"
slug: "unified-workspaces"
---

# 📂 Category: Unified Workspaces Software

> G2 Software Category: Unified Workspaces Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Unified Workspaces Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Unified Workspaces Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Unified Workspaces Software")
SORT osi_score DESC
```