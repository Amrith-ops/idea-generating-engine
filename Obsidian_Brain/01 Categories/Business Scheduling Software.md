---
type: category
name: "Business Scheduling Software"
slug: "business-scheduling"
---

# 📂 Category: Business Scheduling Software

> G2 Software Category: Business Scheduling Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Business Scheduling Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Business Scheduling Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Business Scheduling Software")
SORT osi_score DESC
```