---
type: category
name: "Observability Pipeline Software"
slug: "observability-pipeline"
---

# 📂 Category: Observability Pipeline Software

> G2 Software Category: Observability Pipeline Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Observability Pipeline Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Observability Pipeline Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Observability Pipeline Software")
SORT osi_score DESC
```