...
> G2 Software Category: Payment Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Payment Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Payment Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Payment Software")
SORT osi_score DESC
```