---
type: category
name: "Job Description Management Software"
slug: "job-description-management"
---

# 📂 Category: Job Description Management Software

> G2 Software Category: Job Description Management Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Job Description Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Job Description Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Job Description Management Software")
SORT osi_score DESC
```