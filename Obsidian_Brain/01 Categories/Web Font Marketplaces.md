---
type: category
name: "Web Font Marketplaces"
slug: "web-font-marketplace"
---

# 📂 Category: Web Font Marketplaces

> G2 Software Category: Web Font Marketplaces within Design.
...
FROM "02 Products"
WHERE contains(category, "Web Font Marketplaces") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Web Font Marketplaces") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Web Font Marketplaces")
SORT osi_score DESC
```