...
> G2 Software Category: Last Mile Delivery Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Last Mile Delivery Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Last Mile Delivery Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Last Mile Delivery Software")
SORT osi_score DESC
```