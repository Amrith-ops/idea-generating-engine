---
type: category
name: "Contractor Management Software"
slug: "contractor-management"
---

# 📂 Category: Contractor Management Software

> G2 Software Category: Contractor Management Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Contractor Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Contractor Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Contractor Management Software")
SORT osi_score DESC
```