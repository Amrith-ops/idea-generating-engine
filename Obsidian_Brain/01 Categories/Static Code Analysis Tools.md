...
# 📂 Category: Static Code Analysis Tools

> G2 Software Category: Static Code Analysis Tools within Security.
...
FROM "02 Products"
WHERE contains(category, "Static Code Analysis Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Static Code Analysis Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Static Code Analysis Tools")
SORT osi_score DESC
```