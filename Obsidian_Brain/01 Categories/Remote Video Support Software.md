---
type: category
name: "Remote Video Support Software"
slug: "remote-video-support"
---

# 📂 Category: Remote Video Support Software

> G2 Software Category: Remote Video Support Software within Customer Service.
...
FROM "02 Products"
WHERE contains(category, "Remote Video Support Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Remote Video Support Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Remote Video Support Software")
SORT osi_score DESC
```