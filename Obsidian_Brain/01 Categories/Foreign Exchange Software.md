---
type: category
name: "Foreign Exchange Software"
slug: "foreign-exchange"
---

# 📂 Category: Foreign Exchange Software

> G2 Software Category: Foreign Exchange Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Foreign Exchange Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Foreign Exchange Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Foreign Exchange Software")
SORT osi_score DESC
```