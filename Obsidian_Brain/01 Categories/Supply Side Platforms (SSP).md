---
type: category
name: "Supply Side Platforms (SSP)"
slug: "supply-side-platform-ssp"
---

# 📂 Category: Supply Side Platforms (SSP)

> G2 Software Category: Supply Side Platforms (SSP) within Digital Advertising Tech.
...
FROM "02 Products"
WHERE contains(category, "Supply Side Platforms (SSP)") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Supply Side Platforms (SSP)") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Supply Side Platforms (SSP)")
SORT osi_score DESC
```