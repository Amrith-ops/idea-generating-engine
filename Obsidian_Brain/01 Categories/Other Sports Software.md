---
type: category
name: "Other Sports Software"
slug: "other-sports"
---

# 📂 Category: Other Sports Software

> G2 Software Category: Other Sports Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Sports Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Sports Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Sports Software")
SORT osi_score DESC
```