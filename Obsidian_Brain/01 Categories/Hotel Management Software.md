...
> G2 Software Category: Hotel Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Hotel Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Hotel Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Hotel Management Software")
SORT osi_score DESC
```