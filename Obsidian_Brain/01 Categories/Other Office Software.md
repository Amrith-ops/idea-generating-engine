---
type: category
name: "Other Office Software"
slug: "other-office"
---

# 📂 Category: Other Office Software

> G2 Software Category: Other Office Software within Office Management Software.
...
FROM "02 Products"
WHERE contains(category, "Other Office Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Office Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Office Software")
SORT osi_score DESC
```