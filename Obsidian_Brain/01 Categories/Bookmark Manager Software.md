---
type: category
name: "Bookmark Manager Software"
slug: "bookmark-manager"
---

# 📂 Category: Bookmark Manager Software

> G2 Software Category: Bookmark Manager Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Bookmark Manager Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Bookmark Manager Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Bookmark Manager Software")
SORT osi_score DESC
```