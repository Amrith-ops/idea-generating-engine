---
type: category
name: "Online Backup Software"
slug: "online-backup"
---

# 📂 Category: Online Backup Software

> G2 Software Category: Online Backup Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Online Backup Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Online Backup Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Online Backup Software")
SORT osi_score DESC
```