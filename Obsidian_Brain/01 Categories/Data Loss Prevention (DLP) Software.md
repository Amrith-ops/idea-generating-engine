...
# 📂 Category: Data Loss Prevention (DLP) Software

> G2 Software Category: Data Loss Prevention (DLP) Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Data Loss Prevention (DLP) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Loss Prevention (DLP) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Loss Prevention (DLP) Software")
SORT osi_score DESC
```