---
type: category
name: "Simulation & CAE Software"
slug: "simulation-cae"
---

# 📂 Category: Simulation & CAE Software

> G2 Software Category: Simulation & CAE Software within CAD & PLM.
...
FROM "02 Products"
WHERE contains(category, "Simulation & CAE Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Simulation & CAE Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Simulation & CAE Software")
SORT osi_score DESC
```