---
type: category
name: "Cross-border payments software"
slug: "cross-border-payments-software"
---

# 📂 Category: Cross-border payments software

> G2 Software Category: Cross-border payments software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Cross-border payments software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cross-border payments software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cross-border payments software")
SORT osi_score DESC
```