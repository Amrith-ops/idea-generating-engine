---
type: category
name: "Online Newsroom Software"
slug: "online-newsroom"
---

# 📂 Category: Online Newsroom Software

> G2 Software Category: Online Newsroom Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Online Newsroom Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Online Newsroom Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Online Newsroom Software")
SORT osi_score DESC
```