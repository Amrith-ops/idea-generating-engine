...
> G2 Software Category: Shipping Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Shipping Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Shipping Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Shipping Software")
SORT osi_score DESC
```