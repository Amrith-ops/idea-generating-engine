---
type: category
name: "Aviation MRO Software"
slug: "aviation-mro"
---

# 📂 Category: Aviation MRO Software

> G2 Software Category: Aviation MRO Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Aviation MRO Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Aviation MRO Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Aviation MRO Software")
SORT osi_score DESC
```