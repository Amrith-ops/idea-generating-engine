...
> G2 Software Category: AI Recruiting Software within HR.
...
FROM "02 Products"
WHERE contains(category, "AI Recruiting Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI Recruiting Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI Recruiting Software")
SORT osi_score DESC
```