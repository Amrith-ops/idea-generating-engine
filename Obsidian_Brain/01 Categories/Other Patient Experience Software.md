---
type: category
name: "Other Patient Experience Software"
slug: "other-patient-experience"
---

# 📂 Category: Other Patient Experience Software

> G2 Software Category: Other Patient Experience Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Patient Experience Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Patient Experience Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Patient Experience Software")
SORT osi_score DESC
```