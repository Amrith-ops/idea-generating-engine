---
type: category
name: "Shared Hosting Platforms"
slug: "shared-hosting"
---

# 📂 Category: Shared Hosting Platforms

> G2 Software Category: Shared Hosting Platforms within Hosting.
...
FROM "02 Products"
WHERE contains(category, "Shared Hosting Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Shared Hosting Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Shared Hosting Platforms")
SORT osi_score DESC
```