---
type: category
name: "Reference Check Software"
slug: "reference-check"
---

# 📂 Category: Reference Check Software

> G2 Software Category: Reference Check Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Reference Check Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Reference Check Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Reference Check Software")
SORT osi_score DESC
```