...
> G2 Software Category: Bot Platforms within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Bot Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Bot Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Bot Platforms")
SORT osi_score DESC
```