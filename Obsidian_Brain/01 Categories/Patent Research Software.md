---
type: category
name: "Patent Research Software"
slug: "patent-research"
---

# 📂 Category: Patent Research Software

> G2 Software Category: Patent Research Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Patent Research Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Patent Research Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Patent Research Software")
SORT osi_score DESC
```