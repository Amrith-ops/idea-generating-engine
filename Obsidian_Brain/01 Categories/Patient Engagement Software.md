---
type: category
name: "Patient Engagement Software"
slug: "patient-engagement"
---

# 📂 Category: Patient Engagement Software

> G2 Software Category: Patient Engagement Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Patient Engagement Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Patient Engagement Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Patient Engagement Software")
SORT osi_score DESC
```