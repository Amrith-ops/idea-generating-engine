...
> G2 Software Category: Asset Management  Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Asset Management  Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Asset Management  Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Asset Management  Software")
SORT osi_score DESC
```