...
> G2 Software Category: Clinical Decision Support within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Clinical Decision Support") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Clinical Decision Support") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Clinical Decision Support")
SORT osi_score DESC
```