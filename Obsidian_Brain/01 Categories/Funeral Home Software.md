---
type: category
name: "Funeral Home Software"
slug: "funeral-home"
---

# 📂 Category: Funeral Home Software

> G2 Software Category: Funeral Home Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Funeral Home Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Funeral Home Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Funeral Home Software")
SORT osi_score DESC
```