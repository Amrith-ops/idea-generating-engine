---
type: category
name: "Airline Reservations Software"
slug: "airline-reservations"
---

# 📂 Category: Airline Reservations Software

> G2 Software Category: Airline Reservations Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Airline Reservations Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Airline Reservations Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Airline Reservations Software")
SORT osi_score DESC
```