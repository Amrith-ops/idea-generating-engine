---
type: category
name: "Citizen Engagement Software"
slug: "citizen-engagement"
---

# 📂 Category: Citizen Engagement Software

> G2 Software Category: Citizen Engagement Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Citizen Engagement Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Citizen Engagement Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Citizen Engagement Software")
SORT osi_score DESC
```