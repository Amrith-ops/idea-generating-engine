---
type: category
name: "Strategic Planning and Execution Software"
slug: "strategic-planning-and-execution"
---

# 📂 Category: Strategic Planning and Execution Software

> G2 Software Category: Strategic Planning and Execution Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Strategic Planning and Execution Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Strategic Planning and Execution Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Strategic Planning and Execution Software")
SORT osi_score DESC
```