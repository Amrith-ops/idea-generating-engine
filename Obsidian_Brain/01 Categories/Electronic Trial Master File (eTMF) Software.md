---
type: category
name: "Electronic Trial Master File (eTMF) Software"
slug: "electronic-trial-master-file-etmf"
---

# 📂 Category: Electronic Trial Master File (eTMF) Software

> G2 Software Category: Electronic Trial Master File (eTMF) Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Electronic Trial Master File (eTMF) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Electronic Trial Master File (eTMF) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Electronic Trial Master File (eTMF) Software")
SORT osi_score DESC
```