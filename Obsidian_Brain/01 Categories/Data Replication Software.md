...
> G2 Software Category: Data Replication Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Data Replication Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Replication Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Replication Software")
SORT osi_score DESC
```