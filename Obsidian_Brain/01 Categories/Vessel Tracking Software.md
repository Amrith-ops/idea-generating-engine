---
type: category
name: "Vessel Tracking Software"
slug: "vessel-tracking"
---

# 📂 Category: Vessel Tracking Software

> G2 Software Category: Vessel Tracking Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Vessel Tracking Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Vessel Tracking Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Vessel Tracking Software")
SORT osi_score DESC
```