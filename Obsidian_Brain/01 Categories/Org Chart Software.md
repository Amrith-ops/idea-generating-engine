---
type: category
name: "Org Chart Software"
slug: "org-chart"
---

# 📂 Category: Org Chart Software

> G2 Software Category: Org Chart Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Org Chart Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Org Chart Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Org Chart Software")
SORT osi_score DESC
```