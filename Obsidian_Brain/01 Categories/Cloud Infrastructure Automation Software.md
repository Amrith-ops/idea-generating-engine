---
type: category
name: "Cloud Infrastructure Automation Software"
slug: "cloud-infrastructure-automation"
---

# 📂 Category: Cloud Infrastructure Automation Software

> G2 Software Category: Cloud Infrastructure Automation Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Cloud Infrastructure Automation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cloud Infrastructure Automation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cloud Infrastructure Automation Software")
SORT osi_score DESC
```