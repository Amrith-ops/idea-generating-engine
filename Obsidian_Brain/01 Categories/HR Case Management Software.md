---
type: category
name: "HR Case Management Software"
slug: "hr-case-management"
---

# 📂 Category: HR Case Management Software

> G2 Software Category: HR Case Management Software within HR.
...
FROM "02 Products"
WHERE contains(category, "HR Case Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "HR Case Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "HR Case Management Software")
SORT osi_score DESC
```