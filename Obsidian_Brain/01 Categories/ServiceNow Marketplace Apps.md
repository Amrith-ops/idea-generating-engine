---
type: category
name: "ServiceNow Marketplace Apps"
slug: "servicenow-store-apps"
---

# 📂 Category: ServiceNow Marketplace Apps

> G2 Software Category: ServiceNow Marketplace Apps within Marketplace Apps.
...
FROM "02 Products"
WHERE contains(category, "ServiceNow Marketplace Apps") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "ServiceNow Marketplace Apps") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "ServiceNow Marketplace Apps")
SORT osi_score DESC
```