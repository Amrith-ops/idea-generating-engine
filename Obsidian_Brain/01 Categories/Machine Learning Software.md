---
type: category
name: "Machine Learning Software"
slug: "machine-learning"
---

# 📂 Category: Machine Learning Software

> G2 Software Category: Machine Learning Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Machine Learning Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Machine Learning Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Machine Learning Software")
SORT osi_score DESC
```