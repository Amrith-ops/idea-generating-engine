---
type: category
name: "Education Finance Software"
slug: "education-finance-software"
---

# 📂 Category: Education Finance Software

> G2 Software Category: Education Finance Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Education Finance Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Education Finance Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Education Finance Software")
SORT osi_score DESC
```