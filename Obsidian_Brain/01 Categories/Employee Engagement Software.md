...
> G2 Software Category: Employee Engagement Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Employee Engagement Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Employee Engagement Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Employee Engagement Software")
SORT osi_score DESC
```