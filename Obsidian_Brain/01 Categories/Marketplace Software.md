...
> G2 Software Category: Marketplace Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Marketplace Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Marketplace Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Marketplace Software")
SORT osi_score DESC
```