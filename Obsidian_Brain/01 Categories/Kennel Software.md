---
type: category
name: "Kennel Software"
slug: "kennel"
---

# 📂 Category: Kennel Software

> G2 Software Category: Kennel Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Kennel Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Kennel Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Kennel Software")
SORT osi_score DESC
```