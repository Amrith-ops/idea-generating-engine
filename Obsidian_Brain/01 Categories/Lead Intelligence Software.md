---
type: category
name: "Lead Intelligence Software"
slug: "lead-intelligence"
---

# 📂 Category: Lead Intelligence Software

> G2 Software Category: Lead Intelligence Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Lead Intelligence Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Lead Intelligence Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Lead Intelligence Software")
SORT osi_score DESC
```