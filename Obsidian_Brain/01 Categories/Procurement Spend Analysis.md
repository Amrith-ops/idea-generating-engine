...
slug: "procurement-spend-analysis"
---

# 📂 Category: Procurement Spend Analysis

> G2 Software Category: Procurement Spend Analysis within ERP.
...
FROM "02 Products"
WHERE contains(category, "Procurement Spend Analysis") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Procurement Spend Analysis") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Procurement Spend Analysis")
SORT osi_score DESC
```