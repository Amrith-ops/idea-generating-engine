...
# 📂 Category: Dock Scheduling

> G2 Software Category: Dock Scheduling within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Dock Scheduling") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Dock Scheduling") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Dock Scheduling")
SORT osi_score DESC
```