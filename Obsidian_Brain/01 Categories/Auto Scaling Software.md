---
type: category
name: "Auto Scaling Software"
slug: "auto-scaling"
---

# 📂 Category: Auto Scaling Software

> G2 Software Category: Auto Scaling Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Auto Scaling Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Auto Scaling Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Auto Scaling Software")
SORT osi_score DESC
```