...
> G2 Software Category: Presentation Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Presentation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Presentation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Presentation Software")
SORT osi_score DESC
```