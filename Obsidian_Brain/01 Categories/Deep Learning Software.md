...
> G2 Software Category: Deep Learning Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Deep Learning Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Deep Learning Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Deep Learning Software")
SORT osi_score DESC
```