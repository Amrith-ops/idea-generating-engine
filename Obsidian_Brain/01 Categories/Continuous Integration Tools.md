...
> G2 Software Category: Continuous Integration Tools within Development.
...
FROM "02 Products"
WHERE contains(category, "Continuous Integration Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Continuous Integration Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Continuous Integration Tools")
SORT osi_score DESC
```