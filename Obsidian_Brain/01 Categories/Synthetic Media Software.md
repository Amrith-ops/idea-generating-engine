---
type: category
name: "Synthetic Media Software"
slug: "synthetic-media"
---

# 📂 Category: Synthetic Media Software

> G2 Software Category: Synthetic Media Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Synthetic Media Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Synthetic Media Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Synthetic Media Software")
SORT osi_score DESC
```