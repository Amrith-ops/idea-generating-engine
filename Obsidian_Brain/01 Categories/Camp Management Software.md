---
type: category
name: "Camp Management Software"
slug: "camp-management"
---

# 📂 Category: Camp Management Software

> G2 Software Category: Camp Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Camp Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Camp Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Camp Management Software")
SORT osi_score DESC
```