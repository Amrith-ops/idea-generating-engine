---
type: category
name: "Vacation Rental Software"
slug: "vacation-rental"
---

# 📂 Category: Vacation Rental Software

> G2 Software Category: Vacation Rental Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Vacation Rental Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Vacation Rental Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Vacation Rental Software")
SORT osi_score DESC
```