---
type: category
name: "Assisted Living Software"
slug: "assisted-living"
---

# 📂 Category: Assisted Living Software

> G2 Software Category: Assisted Living Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Assisted Living Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Assisted Living Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Assisted Living Software")
SORT osi_score DESC
```