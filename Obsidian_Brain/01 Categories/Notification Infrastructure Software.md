---
type: category
name: "Notification Infrastructure Software"
slug: "notification-infrastructure"
---

# 📂 Category: Notification Infrastructure Software

> G2 Software Category: Notification Infrastructure Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Notification Infrastructure Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Notification Infrastructure Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Notification Infrastructure Software")
SORT osi_score DESC
```