---
type: category
name: "Media Sales Software"
slug: "media-sales-software"
---

# 📂 Category: Media Sales Software

> G2 Software Category: Media Sales Software within Digital Advertising Tech.
...
FROM "02 Products"
WHERE contains(category, "Media Sales Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Media Sales Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Media Sales Software")
SORT osi_score DESC
```