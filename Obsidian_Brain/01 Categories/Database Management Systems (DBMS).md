...
slug: "database-management-systems-dbms"
---

# 📂 Category: Database Management Systems (DBMS)

> G2 Software Category: Database Management Systems (DBMS) within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Database Management Systems (DBMS)") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Database Management Systems (DBMS)") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Database Management Systems (DBMS)")
SORT osi_score DESC
```