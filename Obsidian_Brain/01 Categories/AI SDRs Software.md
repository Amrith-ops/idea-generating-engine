---
type: category
name: "AI SDRs Software"
slug: "ai-sdrs"
---

# 📂 Category: AI SDRs Software

> G2 Software Category: AI SDRs Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "AI SDRs Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI SDRs Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI SDRs Software")
SORT osi_score DESC
```