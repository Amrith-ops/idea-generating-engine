---
type: category
name: "Enterprise Feedback Management Software"
slug: "enterprise-feedback-management"
---

# 📂 Category: Enterprise Feedback Management Software

> G2 Software Category: Enterprise Feedback Management Software within Customer Service.
...
FROM "02 Products"
WHERE contains(category, "Enterprise Feedback Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Enterprise Feedback Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Enterprise Feedback Management Software")
SORT osi_score DESC
```