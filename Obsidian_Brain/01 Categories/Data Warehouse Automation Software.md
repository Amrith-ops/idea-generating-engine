---
type: category
name: "Data Warehouse Automation Software"
slug: "data-warehouse-automation"
---

# 📂 Category: Data Warehouse Automation Software

> G2 Software Category: Data Warehouse Automation Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Data Warehouse Automation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Warehouse Automation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Warehouse Automation Software")
SORT osi_score DESC
```