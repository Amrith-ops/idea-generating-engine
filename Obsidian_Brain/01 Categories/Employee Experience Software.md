---
type: category
name: "Employee Experience Software"
slug: "employee-experience"
---

# 📂 Category: Employee Experience Software

> G2 Software Category: Employee Experience Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Employee Experience Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Employee Experience Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Employee Experience Software")
SORT osi_score DESC
```