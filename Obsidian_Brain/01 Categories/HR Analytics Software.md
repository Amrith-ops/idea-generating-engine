...
# 📂 Category: HR Analytics Software

> G2 Software Category: HR Analytics Software within HR.
...
FROM "02 Products"
WHERE contains(category, "HR Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "HR Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "HR Analytics Software")
SORT osi_score DESC
```