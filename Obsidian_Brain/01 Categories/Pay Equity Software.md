---
type: category
name: "Pay Equity Software"
slug: "pay-equity"
---

# 📂 Category: Pay Equity Software

> G2 Software Category: Pay Equity Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Pay Equity Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Pay Equity Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Pay Equity Software")
SORT osi_score DESC
```