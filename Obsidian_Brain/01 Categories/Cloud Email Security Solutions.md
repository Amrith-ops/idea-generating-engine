---
type: category
name: "Cloud Email Security Solutions"
slug: "cloud-email-security"
---

# 📂 Category: Cloud Email Security Solutions

> G2 Software Category: Cloud Email Security Solutions within Security.
...
FROM "02 Products"
WHERE contains(category, "Cloud Email Security Solutions") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cloud Email Security Solutions") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cloud Email Security Solutions")
SORT osi_score DESC
```