---
type: category
name: "Nonprofit Software"
slug: "nonprofit"
---

# 📂 Category: Nonprofit Software

> G2 Software Category: Nonprofit Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Nonprofit Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Nonprofit Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Nonprofit Software")
SORT osi_score DESC
```