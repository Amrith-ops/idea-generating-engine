---
type: category
name: "Transportation Software"
slug: "transportation"
---

# 📂 Category: Transportation Software

> G2 Software Category: Transportation Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Transportation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Transportation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Transportation Software")
SORT osi_score DESC
```