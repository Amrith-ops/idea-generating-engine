---
type: category
name: "Ergonomics Software"
slug: "ergonomics"
---

# 📂 Category: Ergonomics Software

> G2 Software Category: Ergonomics Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Ergonomics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Ergonomics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Ergonomics Software")
SORT osi_score DESC
```