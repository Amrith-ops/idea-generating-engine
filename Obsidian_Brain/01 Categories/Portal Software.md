...
> G2 Software Category: Portal Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Portal Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Portal Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Portal Software")
SORT osi_score DESC
```