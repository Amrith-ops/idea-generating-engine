...
> G2 Software Category: OTT Platforms within Design.
...
FROM "02 Products"
WHERE contains(category, "OTT Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "OTT Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "OTT Platforms")
SORT osi_score DESC
```