...
> G2 Software Category: Session Replay Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Session Replay Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Session Replay Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Session Replay Software")
SORT osi_score DESC
```