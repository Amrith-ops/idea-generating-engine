...
# 📂 Category: Text to Speech Software

> G2 Software Category: Text to Speech Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Text to Speech Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Text to Speech Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Text to Speech Software")
SORT osi_score DESC
```