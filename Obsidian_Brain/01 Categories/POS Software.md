...
> G2 Software Category: POS Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "POS Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "POS Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "POS Software")
SORT osi_score DESC
```