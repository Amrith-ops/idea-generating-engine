---
type: category
name: "Personal Training Software"
slug: "personal-training"
---

# 📂 Category: Personal Training Software

> G2 Software Category: Personal Training Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Personal Training Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Personal Training Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Personal Training Software")
SORT osi_score DESC
```