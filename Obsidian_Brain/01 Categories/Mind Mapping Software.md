...
slug: "mind-mapping-software"
---

# 📂 Category: Mind Mapping Software

> G2 Software Category: Mind Mapping Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Mind Mapping Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Mind Mapping Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Mind Mapping Software")
SORT osi_score DESC
```