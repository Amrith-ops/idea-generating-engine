---
type: category
name: "Consumer Goods Software"
slug: "consumer-goods-software"
---

# 📂 Category: Consumer Goods Software

> G2 Software Category: Consumer Goods Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Consumer Goods Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Consumer Goods Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Consumer Goods Software")
SORT osi_score DESC
```