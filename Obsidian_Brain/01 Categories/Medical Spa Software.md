---
type: category
name: "Medical Spa Software"
slug: "medical-spa"
---

# 📂 Category: Medical Spa Software

> G2 Software Category: Medical Spa Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Medical Spa Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Medical Spa Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Medical Spa Software")
SORT osi_score DESC
```