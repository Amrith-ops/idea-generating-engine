---
type: category
name: "Smart Cities Software"
slug: "smart-cities"
---

# 📂 Category: Smart Cities Software

> G2 Software Category: Smart Cities Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Smart Cities Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Smart Cities Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Smart Cities Software")
SORT osi_score DESC
```