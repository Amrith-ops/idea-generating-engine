---
type: category
name: "Strategic Portfolio Management Software"
slug: "strategic-portfolio-management"
---

# 📂 Category: Strategic Portfolio Management Software

> G2 Software Category: Strategic Portfolio Management Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Strategic Portfolio Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Strategic Portfolio Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Strategic Portfolio Management Software")
SORT osi_score DESC
```