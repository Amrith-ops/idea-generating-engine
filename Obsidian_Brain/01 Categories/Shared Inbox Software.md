---
type: category
name: "Shared Inbox Software"
slug: "shared-inbox"
---

# 📂 Category: Shared Inbox Software

> G2 Software Category: Shared Inbox Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Shared Inbox Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Shared Inbox Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Shared Inbox Software")
SORT osi_score DESC
```