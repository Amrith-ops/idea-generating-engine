...
> G2 Software Category: Webinar Platforms within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Webinar Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Webinar Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Webinar Platforms")
SORT osi_score DESC
```