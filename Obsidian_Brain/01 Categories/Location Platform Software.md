---
type: category
name: "Location Platform Software"
slug: "location-platform"
---

# 📂 Category: Location Platform Software

> G2 Software Category: Location Platform Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Location Platform Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Location Platform Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Location Platform Software")
SORT osi_score DESC
```