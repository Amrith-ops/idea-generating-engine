...
> G2 Software Category: Data Security Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Data Security Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Security Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Security Software")
SORT osi_score DESC
```