---
type: category
name: "Online Course Providers"
slug: "online-course-providers"
---

# 📂 Category: Online Course Providers

> G2 Software Category: Online Course Providers within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Online Course Providers") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Online Course Providers") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Online Course Providers")
SORT osi_score DESC
```