---
type: category
name: "Lead Retrieval Software"
slug: "lead-retrieval"
---

# 📂 Category: Lead Retrieval Software

> G2 Software Category: Lead Retrieval Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Lead Retrieval Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Lead Retrieval Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Lead Retrieval Software")
SORT osi_score DESC
```