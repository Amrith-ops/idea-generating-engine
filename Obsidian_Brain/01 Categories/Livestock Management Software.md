...
# 📂 Category: Livestock Management Software

> G2 Software Category: Livestock Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Livestock Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Livestock Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Livestock Management Software")
SORT osi_score DESC
```