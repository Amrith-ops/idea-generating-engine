---
type: category
name: "Data Clean Room Software"
slug: "data-clean-room"
---

# 📂 Category: Data Clean Room Software

> G2 Software Category: Data Clean Room Software within Data Privacy.
...
FROM "02 Products"
WHERE contains(category, "Data Clean Room Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Clean Room Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Clean Room Software")
SORT osi_score DESC
```