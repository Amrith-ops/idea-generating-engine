---
type: category
name: "AI SDK Software"
slug: "ai-sdk"
---

# 📂 Category: AI SDK Software

> G2 Software Category: AI SDK Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "AI SDK Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI SDK Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI SDK Software")
SORT osi_score DESC
```