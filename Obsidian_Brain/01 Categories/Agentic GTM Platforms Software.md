---
type: category
name: "Agentic GTM Platforms Software"
slug: "agentic-gtm-platforms"
---

# 📂 Category: Agentic GTM Platforms Software

> G2 Software Category: Agentic GTM Platforms Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Agentic GTM Platforms Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Agentic GTM Platforms Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Agentic GTM Platforms Software")
SORT osi_score DESC
```