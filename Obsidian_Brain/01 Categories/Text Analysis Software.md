---
type: category
name: "Text Analysis Software"
slug: "text-analysis"
---

# 📂 Category: Text Analysis Software

> G2 Software Category: Text Analysis Software within Analytics Tools & Software.
...
FROM "02 Products"
WHERE contains(category, "Text Analysis Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Text Analysis Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Text Analysis Software")
SORT osi_score DESC
```