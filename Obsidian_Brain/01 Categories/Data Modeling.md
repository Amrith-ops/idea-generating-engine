...
> G2 Software Category: Data Modeling within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Data Modeling") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Modeling") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Modeling")
SORT osi_score DESC
```