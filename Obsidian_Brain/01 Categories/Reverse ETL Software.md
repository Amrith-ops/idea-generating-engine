---
type: category
name: "Reverse ETL Software"
slug: "reverse-etl"
---

# 📂 Category: Reverse ETL Software

> G2 Software Category: Reverse ETL Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Reverse ETL Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Reverse ETL Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Reverse ETL Software")
SORT osi_score DESC
```