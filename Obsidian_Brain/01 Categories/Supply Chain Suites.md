---
type: category
name: "Supply Chain Suites"
slug: "supply-chain-suites"
---

# 📂 Category: Supply Chain Suites

> G2 Software Category: Supply Chain Suites within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Supply Chain Suites") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Supply Chain Suites") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Supply Chain Suites")
SORT osi_score DESC
```