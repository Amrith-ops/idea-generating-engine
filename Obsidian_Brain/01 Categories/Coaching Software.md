...
# 📂 Category: Coaching Software

> G2 Software Category: Coaching Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Coaching Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Coaching Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Coaching Software")
SORT osi_score DESC
```