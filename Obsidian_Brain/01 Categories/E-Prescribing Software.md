...
# 📂 Category: E-Prescribing Software

> G2 Software Category: E-Prescribing Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "E-Prescribing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "E-Prescribing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "E-Prescribing Software")
SORT osi_score DESC
```