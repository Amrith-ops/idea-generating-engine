...
type: category
name: "FP&A Software"
slug: "fp-a-financial-planning-analysis"
---

# 📂 Category: FP&A Software

> G2 Software Category: FP&A Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "FP&A Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "FP&A Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "FP&A Software")
SORT osi_score DESC
```