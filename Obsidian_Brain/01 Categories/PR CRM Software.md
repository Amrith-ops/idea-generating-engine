---
type: category
name: "PR CRM Software"
slug: "pr-crm"
---

# 📂 Category: PR CRM Software

> G2 Software Category: PR CRM Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "PR CRM Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "PR CRM Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "PR CRM Software")
SORT osi_score DESC
```