---
type: category
name: "Discrete ERP Software"
slug: "discrete-erp"
---

# 📂 Category: Discrete ERP Software

> G2 Software Category: Discrete ERP Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Discrete ERP Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Discrete ERP Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Discrete ERP Software")
SORT osi_score DESC
```