...
# 📂 Category: Freight Management Software

> G2 Software Category: Freight Management Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Freight Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Freight Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Freight Management Software")
SORT osi_score DESC
```