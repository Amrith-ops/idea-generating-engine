---
type: category
name: "Social Media Suites"
slug: "social-media-suites"
---

# 📂 Category: Social Media Suites

> G2 Software Category: Social Media Suites within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Social Media Suites") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Social Media Suites") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Social Media Suites")
SORT osi_score DESC
```