...
> G2 Software Category: Inventory Management Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Inventory Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Inventory Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Inventory Management Software")
SORT osi_score DESC
```