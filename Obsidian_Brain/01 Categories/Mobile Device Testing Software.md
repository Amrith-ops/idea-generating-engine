---
type: category
name: "Mobile Device Testing Software"
slug: "mobile-device-testing"
---

# 📂 Category: Mobile Device Testing Software

> G2 Software Category: Mobile Device Testing Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Mobile Device Testing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Mobile Device Testing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Mobile Device Testing Software")
SORT osi_score DESC
```