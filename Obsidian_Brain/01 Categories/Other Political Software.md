---
type: category
name: "Other Political Software"
slug: "other-political"
---

# 📂 Category: Other Political Software

> G2 Software Category: Other Political Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Political Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Political Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Political Software")
SORT osi_score DESC
```