---
type: category
name: "Career Management Software"
slug: "career-management"
---

# 📂 Category: Career Management Software

> G2 Software Category: Career Management Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Career Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Career Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Career Management Software")
SORT osi_score DESC
```