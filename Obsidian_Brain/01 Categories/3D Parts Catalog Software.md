---
type: category
name: "3D Parts Catalog Software"
slug: "3d-parts-catalog"
---

# 📂 Category: 3D Parts Catalog Software

> G2 Software Category: 3D Parts Catalog Software within CAD & PLM.
...
FROM "02 Products"
WHERE contains(category, "3D Parts Catalog Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "3D Parts Catalog Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "3D Parts Catalog Software")
SORT osi_score DESC
```