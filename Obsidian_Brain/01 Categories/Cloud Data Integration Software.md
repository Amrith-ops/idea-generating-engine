---
type: category
name: "Cloud Data Integration Software"
slug: "cloud-data-integration"
---

# 📂 Category: Cloud Data Integration Software

> G2 Software Category: Cloud Data Integration Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Cloud Data Integration Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cloud Data Integration Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cloud Data Integration Software")
SORT osi_score DESC
```