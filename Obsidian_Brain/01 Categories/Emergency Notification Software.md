---
type: category
name: "Emergency Notification Software"
slug: "emergency-notification"
---

# 📂 Category: Emergency Notification Software

> G2 Software Category: Emergency Notification Software within Office Management Software.
...
FROM "02 Products"
WHERE contains(category, "Emergency Notification Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Emergency Notification Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Emergency Notification Software")
SORT osi_score DESC
```