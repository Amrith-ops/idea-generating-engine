---
type: category
name: "Protective Intelligence Platforms"
slug: "protective-intelligence-platforms"
---

# 📂 Category: Protective Intelligence Platforms

> G2 Software Category: Protective Intelligence Platforms within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Protective Intelligence Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Protective Intelligence Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Protective Intelligence Platforms")
SORT osi_score DESC
```