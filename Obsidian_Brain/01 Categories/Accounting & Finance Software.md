...
> G2 Software Category: Accounting & Finance Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Accounting & Finance Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Accounting & Finance Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Accounting & Finance Software")
SORT osi_score DESC
```