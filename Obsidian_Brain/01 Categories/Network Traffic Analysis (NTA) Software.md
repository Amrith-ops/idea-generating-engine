---
type: category
name: "Network Traffic Analysis (NTA) Software"
slug: "network-traffic-analysis-nta"
---

# 📂 Category: Network Traffic Analysis (NTA) Software

> G2 Software Category: Network Traffic Analysis (NTA) Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Network Traffic Analysis (NTA) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Network Traffic Analysis (NTA) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Network Traffic Analysis (NTA) Software")
SORT osi_score DESC
```