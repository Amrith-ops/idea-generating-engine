...
> G2 Software Category: Email Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Email Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Email Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Email Software")
SORT osi_score DESC
```