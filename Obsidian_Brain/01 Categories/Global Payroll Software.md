---
type: category
name: "Global Payroll Software"
slug: "global-payroll"
---

# 📂 Category: Global Payroll Software

> G2 Software Category: Global Payroll Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Global Payroll Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Global Payroll Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Global Payroll Software")
SORT osi_score DESC
```