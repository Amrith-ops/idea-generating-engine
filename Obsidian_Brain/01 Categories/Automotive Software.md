...
> G2 Software Category: Automotive Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Automotive Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Automotive Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Automotive Software")
SORT osi_score DESC
```