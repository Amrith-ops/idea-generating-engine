...
# 📂 Category: Treasury Management Systems

> G2 Software Category: Treasury Management Systems within ERP.
...
FROM "02 Products"
WHERE contains(category, "Treasury Management Systems") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Treasury Management Systems") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Treasury Management Systems")
SORT osi_score DESC
```