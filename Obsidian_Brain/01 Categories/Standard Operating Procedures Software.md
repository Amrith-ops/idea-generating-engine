---
type: category
name: "Standard Operating Procedures Software"
slug: "standard-operating-procedures"
---

# 📂 Category: Standard Operating Procedures Software

> G2 Software Category: Standard Operating Procedures Software within Content Management.
...
FROM "02 Products"
WHERE contains(category, "Standard Operating Procedures Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Standard Operating Procedures Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Standard Operating Procedures Software")
SORT osi_score DESC
```