...
> G2 Software Category: Construction Project Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Construction Project Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Construction Project Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Construction Project Management Software")
SORT osi_score DESC
```