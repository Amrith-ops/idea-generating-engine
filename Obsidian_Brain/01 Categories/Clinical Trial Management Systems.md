---
type: category
name: "Clinical Trial Management Systems"
slug: "clinical-trial-management-systems"
---

# 📂 Category: Clinical Trial Management Systems

> G2 Software Category: Clinical Trial Management Systems within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Clinical Trial Management Systems") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Clinical Trial Management Systems") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Clinical Trial Management Systems")
SORT osi_score DESC
```