---
type: category
name: "Event Registration and Ticketing Software"
slug: "event-registration-ticketing"
---

# 📂 Category: Event Registration and Ticketing Software

> G2 Software Category: Event Registration and Ticketing Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Event Registration and Ticketing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Event Registration and Ticketing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Event Registration and Ticketing Software")
SORT osi_score DESC
```