---
type: category
name: "OT Secure Remote Access Software"
slug: "ot-secure-remote-access"
---

# 📂 Category: OT Secure Remote Access Software

> G2 Software Category: OT Secure Remote Access Software within Security.
...
FROM "02 Products"
WHERE contains(category, "OT Secure Remote Access Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "OT Secure Remote Access Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "OT Secure Remote Access Software")
SORT osi_score DESC
```