---
type: category
name: "Academic Scheduling Software"
slug: "academic-scheduling"
---

# 📂 Category: Academic Scheduling Software

> G2 Software Category: Academic Scheduling Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Academic Scheduling Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Academic Scheduling Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Academic Scheduling Software")
SORT osi_score DESC
```