---
type: category
name: "Stock Footage Software"
slug: "stock-footage"
---

# 📂 Category: Stock Footage Software

> G2 Software Category: Stock Footage Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Stock Footage Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Stock Footage Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Stock Footage Software")
SORT osi_score DESC
```