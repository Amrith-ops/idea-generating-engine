...
# 📂 Category: SD-WAN Solutions

> G2 Software Category: SD-WAN Solutions within IT Management.
...
FROM "02 Products"
WHERE contains(category, "SD-WAN Solutions") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "SD-WAN Solutions") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "SD-WAN Solutions")
SORT osi_score DESC
```