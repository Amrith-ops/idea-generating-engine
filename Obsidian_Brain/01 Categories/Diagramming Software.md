...
> G2 Software Category: Diagramming Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Diagramming Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Diagramming Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Diagramming Software")
SORT osi_score DESC
```