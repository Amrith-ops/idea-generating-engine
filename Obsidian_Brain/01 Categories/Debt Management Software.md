---
type: category
name: "Debt Management Software"
slug: "debt-management"
---

# 📂 Category: Debt Management Software

> G2 Software Category: Debt Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Debt Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Debt Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Debt Management Software")
SORT osi_score DESC
```