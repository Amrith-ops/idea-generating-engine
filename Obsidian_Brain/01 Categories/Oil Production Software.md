---
type: category
name: "Oil Production Software"
slug: "oil-production"
---

# 📂 Category: Oil Production Software

> G2 Software Category: Oil Production Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Oil Production Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Oil Production Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Oil Production Software")
SORT osi_score DESC
```