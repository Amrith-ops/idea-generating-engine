---
type: category
name: "Corporate Volunteering Platforms"
slug: "corporate-volunteering-platform"
---

# 📂 Category: Corporate Volunteering Platforms

> G2 Software Category: Corporate Volunteering Platforms within HR.
...
FROM "02 Products"
WHERE contains(category, "Corporate Volunteering Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Corporate Volunteering Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Corporate Volunteering Platforms")
SORT osi_score DESC
```