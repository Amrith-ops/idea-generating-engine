---
type: category
name: "Product Data Management (PDM) Software"
slug: "product-data-management-pdm"
---

# 📂 Category: Product Data Management (PDM) Software

> G2 Software Category: Product Data Management (PDM) Software within CAD & PLM.
...
FROM "02 Products"
WHERE contains(category, "Product Data Management (PDM) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Product Data Management (PDM) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Product Data Management (PDM) Software")
SORT osi_score DESC
```