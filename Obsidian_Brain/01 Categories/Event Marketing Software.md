---
type: category
name: "Event Marketing Software"
slug: "event-marketing"
---

# 📂 Category: Event Marketing Software

> G2 Software Category: Event Marketing Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Event Marketing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Event Marketing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Event Marketing Software")
SORT osi_score DESC
```