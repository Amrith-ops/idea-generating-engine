---
type: category
name: "Log Monitoring Software"
slug: "log-monitoring"
---

# 📂 Category: Log Monitoring Software

> G2 Software Category: Log Monitoring Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Log Monitoring Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Log Monitoring Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Log Monitoring Software")
SORT osi_score DESC
```