---
type: category
name: "Construction Accounting Software"
slug: "construction-accounting-software"
---

# 📂 Category: Construction Accounting Software

> G2 Software Category: Construction Accounting Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Construction Accounting Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Construction Accounting Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Construction Accounting Software")
SORT osi_score DESC
```