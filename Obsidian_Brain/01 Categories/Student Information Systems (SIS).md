...
slug: "student-information-systems-sis"
---

# 📂 Category: Student Information Systems (SIS)

> G2 Software Category: Student Information Systems (SIS) within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Student Information Systems (SIS)") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Student Information Systems (SIS)") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Student Information Systems (SIS)")
SORT osi_score DESC
```