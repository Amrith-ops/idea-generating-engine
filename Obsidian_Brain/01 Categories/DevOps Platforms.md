...
slug: "devops-platforms"
---

# 📂 Category: DevOps Platforms

> G2 Software Category: DevOps Platforms within Development.
...
FROM "02 Products"
WHERE contains(category, "DevOps Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "DevOps Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "DevOps Platforms")
SORT osi_score DESC
```