---
type: category
name: "Talent Acquisition Suites Software"
slug: "talent-acquisition-suites"
---

# 📂 Category: Talent Acquisition Suites Software

> G2 Software Category: Talent Acquisition Suites Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Talent Acquisition Suites Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Talent Acquisition Suites Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Talent Acquisition Suites Software")
SORT osi_score DESC
```