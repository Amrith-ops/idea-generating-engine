---
type: category
name: "Search Monetization Platforms"
slug: "search-monetization"
---

# 📂 Category: Search Monetization Platforms

> G2 Software Category: Search Monetization Platforms within Digital Advertising Tech.
...
FROM "02 Products"
WHERE contains(category, "Search Monetization Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Search Monetization Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Search Monetization Platforms")
SORT osi_score DESC
```