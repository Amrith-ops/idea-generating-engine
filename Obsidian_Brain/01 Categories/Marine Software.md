---
type: category
name: "Marine Software"
slug: "marine"
---

# 📂 Category: Marine Software

> G2 Software Category: Marine Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Marine Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Marine Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Marine Software")
SORT osi_score DESC
```