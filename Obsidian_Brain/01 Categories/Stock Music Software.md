---
type: category
name: "Stock Music Software"
slug: "stock-music"
---

# 📂 Category: Stock Music Software

> G2 Software Category: Stock Music Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Stock Music Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Stock Music Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Stock Music Software")
SORT osi_score DESC
```