...
> G2 Software Category: Test Management Tools within Development.
...
FROM "02 Products"
WHERE contains(category, "Test Management Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Test Management Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Test Management Tools")
SORT osi_score DESC
```