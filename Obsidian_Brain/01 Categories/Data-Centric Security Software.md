---
type: category
name: "Data-Centric Security Software"
slug: "data-centric-security"
---

# 📂 Category: Data-Centric Security Software

> G2 Software Category: Data-Centric Security Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Data-Centric Security Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data-Centric Security Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data-Centric Security Software")
SORT osi_score DESC
```