---
type: category
name: "Digital Accessibility Tools"
slug: "digital-accessibility-tools"
---

# 📂 Category: Digital Accessibility Tools

> G2 Software Category: Digital Accessibility Tools within Content Management.
...
FROM "02 Products"
WHERE contains(category, "Digital Accessibility Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Digital Accessibility Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Digital Accessibility Tools")
SORT osi_score DESC
```