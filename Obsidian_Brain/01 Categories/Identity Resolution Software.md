---
type: category
name: "Identity Resolution Software"
slug: "identity-resolution"
---

# 📂 Category: Identity Resolution Software

> G2 Software Category: Identity Resolution Software within Digital Advertising Tech.
...
FROM "02 Products"
WHERE contains(category, "Identity Resolution Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Identity Resolution Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Identity Resolution Software")
SORT osi_score DESC
```