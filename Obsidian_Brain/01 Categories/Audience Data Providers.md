---
type: category
name: "Audience Data Providers"
slug: "audience-data-providers"
---

# 📂 Category: Audience Data Providers

> G2 Software Category: Audience Data Providers within Digital Advertising Tech.
...
FROM "02 Products"
WHERE contains(category, "Audience Data Providers") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Audience Data Providers") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Audience Data Providers")
SORT osi_score DESC
```