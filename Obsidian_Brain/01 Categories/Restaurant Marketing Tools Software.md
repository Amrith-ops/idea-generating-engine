---
type: category
name: "Restaurant Marketing Tools Software"
slug: "restaurant-marketing-tools"
---

# 📂 Category: Restaurant Marketing Tools Software

> G2 Software Category: Restaurant Marketing Tools Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Restaurant Marketing Tools Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Restaurant Marketing Tools Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Restaurant Marketing Tools Software")
SORT osi_score DESC
```