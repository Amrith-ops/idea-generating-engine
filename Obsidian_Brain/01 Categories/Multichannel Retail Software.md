---
type: category
name: "Multichannel Retail Software"
slug: "multichannel-retail"
---

# 📂 Category: Multichannel Retail Software

> G2 Software Category: Multichannel Retail Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Multichannel Retail Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Multichannel Retail Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Multichannel Retail Software")
SORT osi_score DESC
```