...
# 📂 Category: Audit Management Software

> G2 Software Category: Audit Management Software within Governance, Risk & Compliance.
...
FROM "02 Products"
WHERE contains(category, "Audit Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Audit Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Audit Management Software")
SORT osi_score DESC
```