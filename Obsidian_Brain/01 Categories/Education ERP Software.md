...
# 📂 Category: Education ERP Software

> G2 Software Category: Education ERP Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Education ERP Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Education ERP Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Education ERP Software")
SORT osi_score DESC
```