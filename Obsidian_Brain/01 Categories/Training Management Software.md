---
type: category
name: "Training Management Software"
slug: "training-management-systems"
---

# 📂 Category: Training Management Software

> G2 Software Category: Training Management Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Training Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Training Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Training Management Software")
SORT osi_score DESC
```