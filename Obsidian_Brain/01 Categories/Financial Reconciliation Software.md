---
type: category
name: "Financial Reconciliation Software"
slug: "financial-reconciliation"
---

# 📂 Category: Financial Reconciliation Software

> G2 Software Category: Financial Reconciliation Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Financial Reconciliation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Financial Reconciliation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Financial Reconciliation Software")
SORT osi_score DESC
```