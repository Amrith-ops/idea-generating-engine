---
type: category
name: "Video Advertising Software"
slug: "video-advertising"
---

# 📂 Category: Video Advertising Software

> G2 Software Category: Video Advertising Software within Digital Advertising Tech.
...
FROM "02 Products"
WHERE contains(category, "Video Advertising Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Video Advertising Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Video Advertising Software")
SORT osi_score DESC
```