---
type: category
name: "Version Control Hosting Software"
slug: "version-control-hosting"
---

# 📂 Category: Version Control Hosting Software

> G2 Software Category: Version Control Hosting Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Version Control Hosting Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Version Control Hosting Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Version Control Hosting Software")
SORT osi_score DESC
```