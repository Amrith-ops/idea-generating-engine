---
type: category
name: "Other Cannabis Software"
slug: "other-cannabis"
---

# 📂 Category: Other Cannabis Software

> G2 Software Category: Other Cannabis Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Cannabis Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Cannabis Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Cannabis Software")
SORT osi_score DESC
```