---
type: category
name: "Demand Planning Software"
slug: "demand-planning"
---

# 📂 Category: Demand Planning Software

> G2 Software Category: Demand Planning Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Demand Planning Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Demand Planning Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Demand Planning Software")
SORT osi_score DESC
```