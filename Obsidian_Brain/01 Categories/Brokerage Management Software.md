---
type: category
name: "Brokerage Management Software"
slug: "brokerage-management"
---

# 📂 Category: Brokerage Management Software

> G2 Software Category: Brokerage Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Brokerage Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Brokerage Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Brokerage Management Software")
SORT osi_score DESC
```