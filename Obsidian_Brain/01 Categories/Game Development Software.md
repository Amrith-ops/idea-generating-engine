...
> G2 Software Category: Game Development Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Game Development Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Game Development Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Game Development Software")
SORT osi_score DESC
```