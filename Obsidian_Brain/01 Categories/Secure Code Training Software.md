---
type: category
name: "Secure Code Training Software"
slug: "secure-code-training"
---

# 📂 Category: Secure Code Training Software

> G2 Software Category: Secure Code Training Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Secure Code Training Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Secure Code Training Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Secure Code Training Software")
SORT osi_score DESC
```