---
type: category
name: "Other Hosting Platforms"
slug: "other-hosting-platforms"
---

# 📂 Category: Other Hosting Platforms

> G2 Software Category: Other Hosting Platforms within Hosting.
...
FROM "02 Products"
WHERE contains(category, "Other Hosting Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Hosting Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Hosting Platforms")
SORT osi_score DESC
```