...
> G2 Software Category: ERP Systems within ERP.
...
FROM "02 Products"
WHERE contains(category, "ERP Systems") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "ERP Systems") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "ERP Systems")
SORT osi_score DESC
```