...
> G2 Software Category: Configuration Management Tools within Development.
...
FROM "02 Products"
WHERE contains(category, "Configuration Management Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Configuration Management Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Configuration Management Tools")
SORT osi_score DESC
```