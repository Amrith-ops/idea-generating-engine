---
type: category
name: "Stock Photos Websites"
slug: "stock-photos"
---

# 📂 Category: Stock Photos Websites

> G2 Software Category: Stock Photos Websites within Design.
...
FROM "02 Products"
WHERE contains(category, "Stock Photos Websites") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Stock Photos Websites") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Stock Photos Websites")
SORT osi_score DESC
```