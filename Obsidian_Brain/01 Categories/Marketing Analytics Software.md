...
> G2 Software Category: Marketing Analytics Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Marketing Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Marketing Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Marketing Analytics Software")
SORT osi_score DESC
```