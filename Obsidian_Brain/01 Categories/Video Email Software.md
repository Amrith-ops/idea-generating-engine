---
type: category
name: "Video Email Software"
slug: "video-email"
---

# 📂 Category: Video Email Software

> G2 Software Category: Video Email Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Video Email Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Video Email Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Video Email Software")
SORT osi_score DESC
```