---
type: category
name: "MCP Server Infrastructure Platforms Software"
slug: "mcp-server-infrastructure-platforms"
---

# 📂 Category: MCP Server Infrastructure Platforms Software

> G2 Software Category: MCP Server Infrastructure Platforms Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "MCP Server Infrastructure Platforms Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "MCP Server Infrastructure Platforms Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "MCP Server Infrastructure Platforms Software")
SORT osi_score DESC
```