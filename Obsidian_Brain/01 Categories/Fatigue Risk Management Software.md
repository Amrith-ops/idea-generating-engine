---
type: category
name: "Fatigue Risk Management Software"
slug: "fatigue-risk-management"
---

# 📂 Category: Fatigue Risk Management Software

> G2 Software Category: Fatigue Risk Management Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Fatigue Risk Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Fatigue Risk Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Fatigue Risk Management Software")
SORT osi_score DESC
```