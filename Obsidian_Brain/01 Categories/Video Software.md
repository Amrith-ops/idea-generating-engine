...
> G2 Software Category: Video Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Video Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Video Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Video Software")
SORT osi_score DESC
```