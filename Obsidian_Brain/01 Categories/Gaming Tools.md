...
> G2 Software Category: Gaming Tools within Development.
...
FROM "02 Products"
WHERE contains(category, "Gaming Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Gaming Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Gaming Tools")
SORT osi_score DESC
```