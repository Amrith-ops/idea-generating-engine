---
type: category
name: "Master Data Management (MDM) Tools"
slug: "master-data-management-mdm"
---

# 📂 Category: Master Data Management (MDM) Tools

> G2 Software Category: Master Data Management (MDM) Tools within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Master Data Management (MDM) Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Master Data Management (MDM) Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Master Data Management (MDM) Tools")
SORT osi_score DESC
```