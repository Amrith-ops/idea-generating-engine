...
> G2 Software Category: MLOps Platforms within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "MLOps Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "MLOps Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "MLOps Platforms")
SORT osi_score DESC
```