---
type: category
name: "Multi-Factor Authentication (MFA) Software"
slug: "multi-factor-authentication-mfa"
---

# 📂 Category: Multi-Factor Authentication (MFA) Software

> G2 Software Category: Multi-Factor Authentication (MFA) Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Multi-Factor Authentication (MFA) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Multi-Factor Authentication (MFA) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Multi-Factor Authentication (MFA) Software")
SORT osi_score DESC
```