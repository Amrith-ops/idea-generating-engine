...
> G2 Software Category: Study Tools within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Study Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Study Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Study Tools")
SORT osi_score DESC
```