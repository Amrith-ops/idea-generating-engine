---
type: category
name: "Airline Route Planning Software"
slug: "airline-route-planning"
---

# 📂 Category: Airline Route Planning Software

> G2 Software Category: Airline Route Planning Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Airline Route Planning Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Airline Route Planning Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Airline Route Planning Software")
SORT osi_score DESC
```