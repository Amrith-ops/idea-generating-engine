...
# 📂 Category: Email Deliverability Tools

> G2 Software Category: Email Deliverability Tools within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Email Deliverability Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Email Deliverability Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Email Deliverability Tools")
SORT osi_score DESC
```