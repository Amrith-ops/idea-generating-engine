...
> G2 Software Category: Auction Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Auction Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Auction Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Auction Software")
SORT osi_score DESC
```