---
type: category
name: "Enterprise App Store Software"
slug: "enterprise-app-store"
---

# 📂 Category: Enterprise App Store Software

> G2 Software Category: Enterprise App Store Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Enterprise App Store Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Enterprise App Store Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Enterprise App Store Software")
SORT osi_score DESC
```