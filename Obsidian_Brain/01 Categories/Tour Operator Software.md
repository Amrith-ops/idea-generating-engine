...
# 📂 Category: Tour Operator Software

> G2 Software Category: Tour Operator Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Tour Operator Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Tour Operator Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Tour Operator Software")
SORT osi_score DESC
```