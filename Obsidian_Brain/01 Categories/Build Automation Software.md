---
type: category
name: "Build Automation Software"
slug: "build-automation"
---

# 📂 Category: Build Automation Software

> G2 Software Category: Build Automation Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Build Automation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Build Automation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Build Automation Software")
SORT osi_score DESC
```