---
type: category
name: "Design Systems Software"
slug: "design-systems"
---

# 📂 Category: Design Systems Software

> G2 Software Category: Design Systems Software within Content Management.
...
FROM "02 Products"
WHERE contains(category, "Design Systems Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Design Systems Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Design Systems Software")
SORT osi_score DESC
```