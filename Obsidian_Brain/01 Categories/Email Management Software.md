...
# 📂 Category: Email Management Software

> G2 Software Category: Email Management Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Email Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Email Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Email Management Software")
SORT osi_score DESC
```