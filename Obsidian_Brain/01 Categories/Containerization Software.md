---
type: category
name: "Containerization Software"
slug: "containerization"
---

# 📂 Category: Containerization Software

> G2 Software Category: Containerization Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Containerization Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Containerization Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Containerization Software")
SORT osi_score DESC
```