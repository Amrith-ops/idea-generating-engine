...
# 📂 Category: Desk Booking Software

> G2 Software Category: Desk Booking Software within Office Management Software.
...
FROM "02 Products"
WHERE contains(category, "Desk Booking Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Desk Booking Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Desk Booking Software")
SORT osi_score DESC
```