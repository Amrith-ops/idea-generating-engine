...
slug: "recruitment-platforms"
---

# 📂 Category: Recruitment Platforms

> G2 Software Category: Recruitment Platforms within HR.
...
FROM "02 Products"
WHERE contains(category, "Recruitment Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Recruitment Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Recruitment Platforms")
SORT osi_score DESC
```