...
slug: "continuous-delivery-tools"
---

# 📂 Category: Continuous Delivery Tools

> G2 Software Category: Continuous Delivery Tools within Development.
...
FROM "02 Products"
WHERE contains(category, "Continuous Delivery Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Continuous Delivery Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Continuous Delivery Tools")
SORT osi_score DESC
```