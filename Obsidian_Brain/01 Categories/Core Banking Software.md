---
type: category
name: "Core Banking Software"
slug: "core-banking"
---

# 📂 Category: Core Banking Software

> G2 Software Category: Core Banking Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Core Banking Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Core Banking Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Core Banking Software")
SORT osi_score DESC
```