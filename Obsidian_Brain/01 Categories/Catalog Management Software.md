---
type: category
name: "Catalog Management Software"
slug: "catalog-management"
---

# 📂 Category: Catalog Management Software

> G2 Software Category: Catalog Management Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Catalog Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Catalog Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Catalog Management Software")
SORT osi_score DESC
```