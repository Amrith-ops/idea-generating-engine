---
type: category
name: "Legal Document Drafting Software"
slug: "legal-document-drafting"
---

# 📂 Category: Legal Document Drafting Software

> G2 Software Category: Legal Document Drafting Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Legal Document Drafting Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Legal Document Drafting Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Legal Document Drafting Software")
SORT osi_score DESC
```