...
# 📂 Category: Parking Management Software

> G2 Software Category: Parking Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Parking Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Parking Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Parking Management Software")
SORT osi_score DESC
```