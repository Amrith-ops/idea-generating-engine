---
type: category
name: "Global Employment Platforms (GEP)"
slug: "global-employment-platforms-gep"
---

# 📂 Category: Global Employment Platforms (GEP)

> G2 Software Category: Global Employment Platforms (GEP) within HR.
...
FROM "02 Products"
WHERE contains(category, "Global Employment Platforms (GEP)") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Global Employment Platforms (GEP)") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Global Employment Platforms (GEP)")
SORT osi_score DESC
```