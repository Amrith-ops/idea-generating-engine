...
> G2 Software Category: AI Voice Assistants within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "AI Voice Assistants") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI Voice Assistants") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI Voice Assistants")
SORT osi_score DESC
```