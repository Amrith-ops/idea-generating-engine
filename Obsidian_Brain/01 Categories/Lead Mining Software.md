---
type: category
name: "Lead Mining Software"
slug: "lead-mining"
---

# 📂 Category: Lead Mining Software

> G2 Software Category: Lead Mining Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Lead Mining Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Lead Mining Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Lead Mining Software")
SORT osi_score DESC
```