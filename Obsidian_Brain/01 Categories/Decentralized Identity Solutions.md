...
# 📂 Category: Decentralized Identity Solutions

> G2 Software Category: Decentralized Identity Solutions within Security.
...
FROM "02 Products"
WHERE contains(category, "Decentralized Identity Solutions") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Decentralized Identity Solutions") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Decentralized Identity Solutions")
SORT osi_score DESC
```