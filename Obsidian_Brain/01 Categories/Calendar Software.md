---
type: category
name: "Calendar Software"
slug: "calendar-software"
---

# 📂 Category: Calendar Software

> G2 Software Category: Calendar Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Calendar Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Calendar Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Calendar Software")
SORT osi_score DESC
```