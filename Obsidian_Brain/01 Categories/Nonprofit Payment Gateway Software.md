---
type: category
name: "Nonprofit Payment Gateway Software"
slug: "nonprofit-payment-gateway"
---

# 📂 Category: Nonprofit Payment Gateway Software

> G2 Software Category: Nonprofit Payment Gateway Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Nonprofit Payment Gateway Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Nonprofit Payment Gateway Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Nonprofit Payment Gateway Software")
SORT osi_score DESC
```