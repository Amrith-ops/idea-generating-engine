---
type: category
name: "Online Fax Software"
slug: "online-fax"
---

# 📂 Category: Online Fax Software

> G2 Software Category: Online Fax Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Online Fax Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Online Fax Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Online Fax Software")
SORT osi_score DESC
```