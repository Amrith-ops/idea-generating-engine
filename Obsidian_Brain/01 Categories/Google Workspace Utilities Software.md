---
type: category
name: "Google Workspace Utilities Software"
slug: "google-workspace-utilities"
---

# 📂 Category: Google Workspace Utilities Software

> G2 Software Category: Google Workspace Utilities Software within Marketplace Apps.
...
FROM "02 Products"
WHERE contains(category, "Google Workspace Utilities Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Google Workspace Utilities Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Google Workspace Utilities Software")
SORT osi_score DESC
```