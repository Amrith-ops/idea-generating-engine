---
type: category
name: "Account-Based Advertising Software"
slug: "account-based-advertising"
---

# 📂 Category: Account-Based Advertising Software

> G2 Software Category: Account-Based Advertising Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Account-Based Advertising Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Account-Based Advertising Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Account-Based Advertising Software")
SORT osi_score DESC
```