---
type: category
name: "Paid Search Intelligence Software"
slug: "paid-search-intelligence"
---

# 📂 Category: Paid Search Intelligence Software

> G2 Software Category: Paid Search Intelligence Software within Digital Advertising Tech.
...
FROM "02 Products"
WHERE contains(category, "Paid Search Intelligence Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Paid Search Intelligence Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Paid Search Intelligence Software")
SORT osi_score DESC
```