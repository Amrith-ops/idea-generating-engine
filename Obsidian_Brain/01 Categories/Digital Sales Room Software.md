---
type: category
name: "Digital Sales Room Software"
slug: "digital-sales-room"
---

# 📂 Category: Digital Sales Room Software

> G2 Software Category: Digital Sales Room Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Digital Sales Room Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Digital Sales Room Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Digital Sales Room Software")
SORT osi_score DESC
```