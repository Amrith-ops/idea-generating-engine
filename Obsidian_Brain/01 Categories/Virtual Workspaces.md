...
> G2 Software Category: Virtual Workspaces within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Virtual Workspaces") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Virtual Workspaces") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Virtual Workspaces")
SORT osi_score DESC
```