---
type: category
name: "AR Collaboration Tools"
slug: "ar-collaboration-tools"
---

# 📂 Category: AR Collaboration Tools

> G2 Software Category: AR Collaboration Tools within AR/VR.
...
FROM "02 Products"
WHERE contains(category, "AR Collaboration Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AR Collaboration Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AR Collaboration Tools")
SORT osi_score DESC
```