---
type: category
name: "Martial Arts Software"
slug: "martial-arts"
---

# 📂 Category: Martial Arts Software

> G2 Software Category: Martial Arts Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Martial Arts Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Martial Arts Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Martial Arts Software")
SORT osi_score DESC
```