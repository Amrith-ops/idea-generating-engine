---
type: category
name: "Population Health Management Software"
slug: "population-health-management"
---

# 📂 Category: Population Health Management Software

> G2 Software Category: Population Health Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Population Health Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Population Health Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Population Health Management Software")
SORT osi_score DESC
```