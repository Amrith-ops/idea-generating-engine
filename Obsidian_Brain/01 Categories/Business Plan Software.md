---
type: category
name: "Business Plan Software"
slug: "business-plan"
---

# 📂 Category: Business Plan Software

> G2 Software Category: Business Plan Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Business Plan Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Business Plan Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Business Plan Software")
SORT osi_score DESC
```