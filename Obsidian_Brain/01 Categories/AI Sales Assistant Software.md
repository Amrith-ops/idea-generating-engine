---
type: category
name: "AI Sales Assistant Software"
slug: "ai-sales-assistant"
---

# 📂 Category: AI Sales Assistant Software

> G2 Software Category: AI Sales Assistant Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "AI Sales Assistant Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI Sales Assistant Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI Sales Assistant Software")
SORT osi_score DESC
```