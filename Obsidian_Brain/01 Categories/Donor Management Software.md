---
type: category
name: "Donor Management Software"
slug: "donor-management"
---

# 📂 Category: Donor Management Software

> G2 Software Category: Donor Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Donor Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Donor Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Donor Management Software")
SORT osi_score DESC
```