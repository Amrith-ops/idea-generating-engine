---
type: category
name: "Media and Influencer Targeting Software"
slug: "media-and-influencer-targeting"
---

# 📂 Category: Media and Influencer Targeting Software

> G2 Software Category: Media and Influencer Targeting Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Media and Influencer Targeting Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Media and Influencer Targeting Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Media and Influencer Targeting Software")
SORT osi_score DESC
```