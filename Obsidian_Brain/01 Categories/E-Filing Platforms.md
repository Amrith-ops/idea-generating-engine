---
type: category
name: "E-Filing Platforms"
slug: "e-filing"
---

# 📂 Category: E-Filing Platforms

> G2 Software Category: E-Filing Platforms within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "E-Filing Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "E-Filing Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "E-Filing Platforms")
SORT osi_score DESC
```