---
type: category
name: "Game Engine Software"
slug: "game-engine"
---

# 📂 Category: Game Engine Software

> G2 Software Category: Game Engine Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Game Engine Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Game Engine Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Game Engine Software")
SORT osi_score DESC
```