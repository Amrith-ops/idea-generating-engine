---
type: category
name: "Editor Software"
slug: "editor"
---

# 📂 Category: Editor Software

> G2 Software Category: Editor Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Editor Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Editor Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Editor Software")
SORT osi_score DESC
```