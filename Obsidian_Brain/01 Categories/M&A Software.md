...
# 📂 Category: M&A Software

> G2 Software Category: M&A Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "M&A Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "M&A Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "M&A Software")
SORT osi_score DESC
```