...
# 📂 Category: Sales Gamification Software

> G2 Software Category: Sales Gamification Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Sales Gamification Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Sales Gamification Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Sales Gamification Software")
SORT osi_score DESC
```