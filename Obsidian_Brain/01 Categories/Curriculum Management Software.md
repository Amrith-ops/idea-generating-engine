---
type: category
name: "Curriculum Management Software"
slug: "curriculum-management"
---

# 📂 Category: Curriculum Management Software

> G2 Software Category: Curriculum Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Curriculum Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Curriculum Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Curriculum Management Software")
SORT osi_score DESC
```