---
type: category
name: "Office Suites Software"
slug: "office-suites"
---

# 📂 Category: Office Suites Software

> G2 Software Category: Office Suites Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Office Suites Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Office Suites Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Office Suites Software")
SORT osi_score DESC
```