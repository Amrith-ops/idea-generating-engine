---
type: category
name: "AI Chatbots Software"
slug: "ai-chatbots"
---

# 📂 Category: AI Chatbots Software

> G2 Software Category: AI Chatbots Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "AI Chatbots Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI Chatbots Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI Chatbots Software")
SORT osi_score DESC
```