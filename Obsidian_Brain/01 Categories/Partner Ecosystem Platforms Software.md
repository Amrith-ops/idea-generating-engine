---
type: category
name: "Partner Ecosystem Platforms Software"
slug: "partner-ecosystem-platforms"
---

# 📂 Category: Partner Ecosystem Platforms Software

> G2 Software Category: Partner Ecosystem Platforms Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Partner Ecosystem Platforms Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Partner Ecosystem Platforms Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Partner Ecosystem Platforms Software")
SORT osi_score DESC
```