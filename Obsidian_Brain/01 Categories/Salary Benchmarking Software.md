---
type: category
name: "Salary Benchmarking Software"
slug: "salary-benchmarking"
---

# 📂 Category: Salary Benchmarking Software

> G2 Software Category: Salary Benchmarking Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Salary Benchmarking Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Salary Benchmarking Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Salary Benchmarking Software")
SORT osi_score DESC
```