---
type: category
name: "Work Management Software"
slug: "work-management"
---

# 📂 Category: Work Management Software

> G2 Software Category: Work Management Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Work Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Work Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Work Management Software")
SORT osi_score DESC
```