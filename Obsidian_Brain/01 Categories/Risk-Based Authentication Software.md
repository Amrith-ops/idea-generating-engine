---
type: category
name: "Risk-Based Authentication Software"
slug: "risk-based-authentication-rba"
---

# 📂 Category: Risk-Based Authentication Software

> G2 Software Category: Risk-Based Authentication Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Risk-Based Authentication Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Risk-Based Authentication Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Risk-Based Authentication Software")
SORT osi_score DESC
```