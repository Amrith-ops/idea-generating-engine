...
# 📂 Category: Job Search Sites

> G2 Software Category: Job Search Sites within HR.
...
FROM "02 Products"
WHERE contains(category, "Job Search Sites") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Job Search Sites") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Job Search Sites")
SORT osi_score DESC
```