---
type: category
name: "Service Desk Software"
slug: "service-desk"
---

# 📂 Category: Service Desk Software

> G2 Software Category: Service Desk Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Service Desk Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Service Desk Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Service Desk Software")
SORT osi_score DESC
```