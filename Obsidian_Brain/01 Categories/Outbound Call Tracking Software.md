---
type: category
name: "Outbound Call Tracking Software"
slug: "outbound-call-tracking"
---

# 📂 Category: Outbound Call Tracking Software

> G2 Software Category: Outbound Call Tracking Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Outbound Call Tracking Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Outbound Call Tracking Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Outbound Call Tracking Software")
SORT osi_score DESC
```