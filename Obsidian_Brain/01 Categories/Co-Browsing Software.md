---
type: category
name: "Co-Browsing Software"
slug: "co-browsing"
---

# 📂 Category: Co-Browsing Software

> G2 Software Category: Co-Browsing Software within Customer Service.
...
FROM "02 Products"
WHERE contains(category, "Co-Browsing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Co-Browsing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Co-Browsing Software")
SORT osi_score DESC
```