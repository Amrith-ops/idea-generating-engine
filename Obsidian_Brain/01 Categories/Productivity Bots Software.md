---
type: category
name: "Productivity Bots Software"
slug: "productivity-bots"
---

# 📂 Category: Productivity Bots Software

> G2 Software Category: Productivity Bots Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Productivity Bots Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Productivity Bots Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Productivity Bots Software")
SORT osi_score DESC
```