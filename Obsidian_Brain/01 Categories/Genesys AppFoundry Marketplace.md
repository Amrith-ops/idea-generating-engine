---
type: category
name: "Genesys AppFoundry Marketplace"
slug: "genesys-appfoundry-marketplace"
---

# 📂 Category: Genesys AppFoundry Marketplace

> G2 Software Category: Genesys AppFoundry Marketplace within Marketplace Apps.
...
FROM "02 Products"
WHERE contains(category, "Genesys AppFoundry Marketplace") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Genesys AppFoundry Marketplace") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Genesys AppFoundry Marketplace")
SORT osi_score DESC
```