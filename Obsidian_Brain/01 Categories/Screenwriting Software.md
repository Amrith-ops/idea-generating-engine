...
# 📂 Category: Screenwriting Software

> G2 Software Category: Screenwriting Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Screenwriting Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Screenwriting Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Screenwriting Software")
SORT osi_score DESC
```