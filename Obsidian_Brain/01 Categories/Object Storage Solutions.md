---
type: category
name: "Object Storage Solutions"
slug: "object-storage-solutions"
---

# 📂 Category: Object Storage Solutions

> G2 Software Category: Object Storage Solutions within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Object Storage Solutions") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Object Storage Solutions") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Object Storage Solutions")
SORT osi_score DESC
```