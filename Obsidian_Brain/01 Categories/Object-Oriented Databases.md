...
slug: "object-oriented-databases"
---

# 📂 Category: Object-Oriented Databases

> G2 Software Category: Object-Oriented Databases within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Object-Oriented Databases") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Object-Oriented Databases") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Object-Oriented Databases")
SORT osi_score DESC
```