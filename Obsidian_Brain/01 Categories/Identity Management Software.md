---
type: category
name: "Identity Management Software"
slug: "identity-management"
---

# 📂 Category: Identity Management Software

> G2 Software Category: Identity Management Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Identity Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Identity Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Identity Management Software")
SORT osi_score DESC
```