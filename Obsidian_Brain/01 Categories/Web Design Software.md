...
> G2 Software Category: Web Design Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Web Design Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Web Design Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Web Design Software")
SORT osi_score DESC
```