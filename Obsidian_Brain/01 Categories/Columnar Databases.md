...
> G2 Software Category: Columnar Databases within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Columnar Databases") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Columnar Databases") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Columnar Databases")
SORT osi_score DESC
```