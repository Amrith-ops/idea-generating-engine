---
type: category
name: "Service Virtualization Software"
slug: "service-virtualization"
---

# 📂 Category: Service Virtualization Software

> G2 Software Category: Service Virtualization Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Service Virtualization Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Service Virtualization Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Service Virtualization Software")
SORT osi_score DESC
```