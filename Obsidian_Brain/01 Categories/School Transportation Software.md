---
type: category
name: "School Transportation Software"
slug: "school-transportation"
---

# 📂 Category: School Transportation Software

> G2 Software Category: School Transportation Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "School Transportation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "School Transportation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "School Transportation Software")
SORT osi_score DESC
```