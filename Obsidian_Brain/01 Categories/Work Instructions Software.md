---
type: category
name: "Work Instructions Software"
slug: "work-instructions"
---

# 📂 Category: Work Instructions Software

> G2 Software Category: Work Instructions Software within Content Management.
...
FROM "02 Products"
WHERE contains(category, "Work Instructions Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Work Instructions Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Work Instructions Software")
SORT osi_score DESC
```