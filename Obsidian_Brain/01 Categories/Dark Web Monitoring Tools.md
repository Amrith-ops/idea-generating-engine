...
# 📂 Category: Dark Web Monitoring Tools

> G2 Software Category: Dark Web Monitoring Tools within Security.
...
FROM "02 Products"
WHERE contains(category, "Dark Web Monitoring Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Dark Web Monitoring Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Dark Web Monitoring Tools")
SORT osi_score DESC
```