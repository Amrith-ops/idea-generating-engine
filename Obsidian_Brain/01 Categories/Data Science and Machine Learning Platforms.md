---
type: category
name: "Data Science and Machine Learning Platforms"
slug: "data-science-and-machine-learning-platforms"
---

# 📂 Category: Data Science and Machine Learning Platforms

> G2 Software Category: Data Science and Machine Learning Platforms within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Data Science and Machine Learning Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Science and Machine Learning Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Science and Machine Learning Platforms")
SORT osi_score DESC
```