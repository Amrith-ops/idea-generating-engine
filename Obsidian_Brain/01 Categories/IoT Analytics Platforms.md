---
type: category
name: "IoT Analytics Platforms"
slug: "iot-analytics-platforms"
---

# 📂 Category: IoT Analytics Platforms

> G2 Software Category: IoT Analytics Platforms within IoT Management.
...
FROM "02 Products"
WHERE contains(category, "IoT Analytics Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "IoT Analytics Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "IoT Analytics Platforms")
SORT osi_score DESC
```