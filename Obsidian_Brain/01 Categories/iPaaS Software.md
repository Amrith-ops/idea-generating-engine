...
# 📂 Category: iPaaS Software

> G2 Software Category: iPaaS Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "iPaaS Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "iPaaS Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "iPaaS Software")
SORT osi_score DESC
```