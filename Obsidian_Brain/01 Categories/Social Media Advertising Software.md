---
type: category
name: "Social Media Advertising Software"
slug: "social-media-advertising"
---

# 📂 Category: Social Media Advertising Software

> G2 Software Category: Social Media Advertising Software within Digital Advertising Tech.
...
FROM "02 Products"
WHERE contains(category, "Social Media Advertising Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Social Media Advertising Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Social Media Advertising Software")
SORT osi_score DESC
```