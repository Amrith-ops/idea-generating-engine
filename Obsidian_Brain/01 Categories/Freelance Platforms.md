...
> G2 Software Category: Freelance Platforms within HR.
...
FROM "02 Products"
WHERE contains(category, "Freelance Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Freelance Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Freelance Platforms")
SORT osi_score DESC
```