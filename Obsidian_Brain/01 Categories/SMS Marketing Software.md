---
type: category
name: "SMS Marketing Software"
slug: "sms-marketing"
---

# 📂 Category: SMS Marketing Software

> G2 Software Category: SMS Marketing Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "SMS Marketing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "SMS Marketing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "SMS Marketing Software")
SORT osi_score DESC
```