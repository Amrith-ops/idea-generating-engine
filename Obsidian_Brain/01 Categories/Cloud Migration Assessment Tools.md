---
type: category
name: "Cloud Migration Assessment Tools"
slug: "cloud-migration-assessment-tools"
---

# 📂 Category: Cloud Migration Assessment Tools

> G2 Software Category: Cloud Migration Assessment Tools within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Cloud Migration Assessment Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cloud Migration Assessment Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cloud Migration Assessment Tools")
SORT osi_score DESC
```