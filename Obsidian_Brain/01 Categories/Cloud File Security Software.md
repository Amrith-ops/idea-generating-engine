---
type: category
name: "Cloud File Security Software"
slug: "cloud-file-security"
---

# 📂 Category: Cloud File Security Software

> G2 Software Category: Cloud File Security Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Cloud File Security Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cloud File Security Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cloud File Security Software")
SORT osi_score DESC
```