...
slug: "sales-compensation"
---

# 📂 Category: Sales Compensation Software

> G2 Software Category: Sales Compensation Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Sales Compensation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Sales Compensation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Sales Compensation Software")
SORT osi_score DESC
```