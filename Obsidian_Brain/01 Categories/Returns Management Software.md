---
type: category
name: "Returns Management Software"
slug: "returns-management"
---

# 📂 Category: Returns Management Software

> G2 Software Category: Returns Management Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Returns Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Returns Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Returns Management Software")
SORT osi_score DESC
```