...
> G2 Software Category: Resource Management Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Resource Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Resource Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Resource Management Software")
SORT osi_score DESC
```