...
> G2 Software Category: Analytics Platforms within Analytics Tools & Software.
...
FROM "02 Products"
WHERE contains(category, "Analytics Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Analytics Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Analytics Platforms")
SORT osi_score DESC
```