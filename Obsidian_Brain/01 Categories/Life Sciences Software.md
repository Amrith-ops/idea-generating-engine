...
> G2 Software Category: Life Sciences Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Life Sciences Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Life Sciences Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Life Sciences Software")
SORT osi_score DESC
```