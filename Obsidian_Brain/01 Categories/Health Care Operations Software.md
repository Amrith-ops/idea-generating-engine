---
type: category
name: "Health Care Operations Software"
slug: "health-care-operations"
---

# 📂 Category: Health Care Operations Software

> G2 Software Category: Health Care Operations Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Health Care Operations Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Health Care Operations Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Health Care Operations Software")
SORT osi_score DESC
```