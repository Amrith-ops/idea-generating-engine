---
type: category
name: "I-9 Compliance Software"
slug: "i-9-compliance"
---

# 📂 Category: I-9 Compliance Software

> G2 Software Category: I-9 Compliance Software within HR.
...
FROM "02 Products"
WHERE contains(category, "I-9 Compliance Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "I-9 Compliance Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "I-9 Compliance Software")
SORT osi_score DESC
```