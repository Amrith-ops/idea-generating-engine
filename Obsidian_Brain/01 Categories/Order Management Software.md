...
# 📂 Category: Order Management Software

> G2 Software Category: Order Management Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Order Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Order Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Order Management Software")
SORT osi_score DESC
```