---
type: category
name: "Brokerage Trading Platforms"
slug: "brokerage-trading-platforms"
---

# 📂 Category: Brokerage Trading Platforms

> G2 Software Category: Brokerage Trading Platforms within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Brokerage Trading Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Brokerage Trading Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Brokerage Trading Platforms")
SORT osi_score DESC
```