...
> G2 Software Category: Pricing Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Pricing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Pricing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Pricing Software")
SORT osi_score DESC
```