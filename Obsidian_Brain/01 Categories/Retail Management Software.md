...
> G2 Software Category: Retail Management Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Retail Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Retail Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Retail Management Software")
SORT osi_score DESC
```