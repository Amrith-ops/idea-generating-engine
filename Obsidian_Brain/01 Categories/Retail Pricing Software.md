---
type: category
name: "Retail Pricing Software"
slug: "retail-pricing"
---

# 📂 Category: Retail Pricing Software

> G2 Software Category: Retail Pricing Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Retail Pricing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Retail Pricing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Retail Pricing Software")
SORT osi_score DESC
```