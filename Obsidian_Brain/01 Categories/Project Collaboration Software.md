---
type: category
name: "Project Collaboration Software"
slug: "project-collaboration"
---

# 📂 Category: Project Collaboration Software

> G2 Software Category: Project Collaboration Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Project Collaboration Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Project Collaboration Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Project Collaboration Software")
SORT osi_score DESC
```