...
# 📂 Category: A/B Testing Tools

> G2 Software Category: A/B Testing Tools within Marketing.
...
FROM "02 Products"
WHERE contains(category, "A/B Testing Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "A/B Testing Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "A/B Testing Tools")
SORT osi_score DESC
```