...
> G2 Software Category: Audio Editing Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Audio Editing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Audio Editing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Audio Editing Software")
SORT osi_score DESC
```