...
# 📂 Category: Container Orchestration Tools

> G2 Software Category: Container Orchestration Tools within Development.
...
FROM "02 Products"
WHERE contains(category, "Container Orchestration Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Container Orchestration Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Container Orchestration Tools")
SORT osi_score DESC
```