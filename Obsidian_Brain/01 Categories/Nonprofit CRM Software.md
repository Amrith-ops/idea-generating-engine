---
type: category
name: "Nonprofit CRM Software"
slug: "nonprofit-crm"
---

# 📂 Category: Nonprofit CRM Software

> G2 Software Category: Nonprofit CRM Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Nonprofit CRM Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Nonprofit CRM Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Nonprofit CRM Software")
SORT osi_score DESC
```