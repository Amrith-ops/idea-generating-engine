---
type: category
name: "Markup Software"
slug: "markup-software"
---

# 📂 Category: Markup Software

> G2 Software Category: Markup Software within Content Management.
...
FROM "02 Products"
WHERE contains(category, "Markup Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Markup Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Markup Software")
SORT osi_score DESC
```