---
type: category
name: "Other Finance & Admin. Software"
slug: "other-finance-admin"
---

# 📂 Category: Other Finance & Admin. Software

> G2 Software Category: Other Finance & Admin. Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Other Finance & Admin. Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Finance & Admin. Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Finance & Admin. Software")
SORT osi_score DESC
```