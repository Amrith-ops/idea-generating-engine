---
type: category
name: "Patient Case Management Software"
slug: "patient-case-management"
---

# 📂 Category: Patient Case Management Software

> G2 Software Category: Patient Case Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Patient Case Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Patient Case Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Patient Case Management Software")
SORT osi_score DESC
```