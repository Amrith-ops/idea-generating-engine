---
type: category
name: "Court Management Software"
slug: "court-management"
---

# 📂 Category: Court Management Software

> G2 Software Category: Court Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Court Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Court Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Court Management Software")
SORT osi_score DESC
```