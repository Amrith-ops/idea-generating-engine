...
# 📂 Category: Age Verification Software

> G2 Software Category: Age Verification Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Age Verification Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Age Verification Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Age Verification Software")
SORT osi_score DESC
```