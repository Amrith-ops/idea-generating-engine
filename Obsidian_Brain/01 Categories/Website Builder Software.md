...
> G2 Software Category: Website Builder Software within Content Management.
...
FROM "02 Products"
WHERE contains(category, "Website Builder Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Website Builder Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Website Builder Software")
SORT osi_score DESC
```