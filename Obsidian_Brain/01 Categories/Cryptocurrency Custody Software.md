---
type: category
name: "Cryptocurrency Custody Software"
slug: "cryptocurrency-custody"
---

# 📂 Category: Cryptocurrency Custody Software

> G2 Software Category: Cryptocurrency Custody Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Cryptocurrency Custody Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cryptocurrency Custody Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cryptocurrency Custody Software")
SORT osi_score DESC
```