---
type: category
name: "Accounts Payable Automation Software"
slug: "ap-automation"
---

# 📂 Category: Accounts Payable Automation Software

> G2 Software Category: Accounts Payable Automation Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Accounts Payable Automation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Accounts Payable Automation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Accounts Payable Automation Software")
SORT osi_score DESC
```