---
type: category
name: "QR Code Generator Software"
slug: "qr-code-generator"
---

# 📂 Category: QR Code Generator Software

> G2 Software Category: QR Code Generator Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "QR Code Generator Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "QR Code Generator Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "QR Code Generator Software")
SORT osi_score DESC
```