---
type: category
name: "BIM Objects Software"
slug: "bim-objects"
---

# 📂 Category: BIM Objects Software

> G2 Software Category: BIM Objects Software within CAD & PLM.
...
FROM "02 Products"
WHERE contains(category, "BIM Objects Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "BIM Objects Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "BIM Objects Software")
SORT osi_score DESC
```