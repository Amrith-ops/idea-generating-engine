---
type: category
name: "Other Design Software"
slug: "other-design"
---

# 📂 Category: Other Design Software

> G2 Software Category: Other Design Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Other Design Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Design Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Design Software")
SORT osi_score DESC
```