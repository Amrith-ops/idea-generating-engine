...
> G2 Software Category: CAD Viewers within CAD & PLM.
...
FROM "02 Products"
WHERE contains(category, "CAD Viewers") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "CAD Viewers") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "CAD Viewers")
SORT osi_score DESC
```