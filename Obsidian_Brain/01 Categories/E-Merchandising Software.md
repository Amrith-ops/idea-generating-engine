---
type: category
name: "E-Merchandising Software"
slug: "e-merchandising"
---

# 📂 Category: E-Merchandising Software

> G2 Software Category: E-Merchandising Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "E-Merchandising Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "E-Merchandising Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "E-Merchandising Software")
SORT osi_score DESC
```