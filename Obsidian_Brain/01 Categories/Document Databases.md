...
> G2 Software Category: Document Databases within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Document Databases") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Document Databases") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Document Databases")
SORT osi_score DESC
```