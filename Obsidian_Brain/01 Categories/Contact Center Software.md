...
> G2 Software Category: Contact Center Software within Customer Service.
...
FROM "02 Products"
WHERE contains(category, "Contact Center Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Contact Center Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Contact Center Software")
SORT osi_score DESC
```