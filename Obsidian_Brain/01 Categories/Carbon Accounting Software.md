...
> G2 Software Category: Carbon Accounting Software within Governance, Risk & Compliance.
...
FROM "02 Products"
WHERE contains(category, "Carbon Accounting Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Carbon Accounting Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Carbon Accounting Software")
SORT osi_score DESC
```