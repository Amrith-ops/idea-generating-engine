---
type: category
name: "Web Accessibility Software"
slug: "web-accessibility"
---

# 📂 Category: Web Accessibility Software

> G2 Software Category: Web Accessibility Software within Content Management.
...
FROM "02 Products"
WHERE contains(category, "Web Accessibility Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Web Accessibility Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Web Accessibility Software")
SORT osi_score DESC
```