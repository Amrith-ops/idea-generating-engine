---
type: category
name: "Consumer Insights Platforms"
slug: "consumer-insights-platforms"
---

# 📂 Category: Consumer Insights Platforms

> G2 Software Category: Consumer Insights Platforms within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Consumer Insights Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Consumer Insights Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Consumer Insights Platforms")
SORT osi_score DESC
```