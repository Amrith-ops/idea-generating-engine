...
# 📂 Category: Golf Software

> G2 Software Category: Golf Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Golf Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Golf Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Golf Software")
SORT osi_score DESC
```