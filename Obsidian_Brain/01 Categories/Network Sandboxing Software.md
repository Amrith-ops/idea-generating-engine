---
type: category
name: "Network Sandboxing Software"
slug: "network-sandboxing"
---

# 📂 Category: Network Sandboxing Software

> G2 Software Category: Network Sandboxing Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Network Sandboxing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Network Sandboxing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Network Sandboxing Software")
SORT osi_score DESC
```