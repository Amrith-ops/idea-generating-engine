...
# 📂 Category: Compensation Planning Software

> G2 Software Category: Compensation Planning Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Compensation Planning Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Compensation Planning Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Compensation Planning Software")
SORT osi_score DESC
```