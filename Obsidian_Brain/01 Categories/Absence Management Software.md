---
type: category
name: "Absence Management Software"
slug: "absence-management-software"
---

# 📂 Category: Absence Management Software

> G2 Software Category: Absence Management Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Absence Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Absence Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Absence Management Software")
SORT osi_score DESC
```