...
> G2 Software Category: ETL Tools within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "ETL Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "ETL Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "ETL Tools")
SORT osi_score DESC
```