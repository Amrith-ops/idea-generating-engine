---
type: category
name: "Reservation Software"
slug: "reservation"
---

# 📂 Category: Reservation Software

> G2 Software Category: Reservation Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Reservation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Reservation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Reservation Software")
SORT osi_score DESC
```