---
type: category
name: "Museum Management  Software"
slug: "museum-management"
---

# 📂 Category: Museum Management  Software

> G2 Software Category: Museum Management  Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Museum Management  Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Museum Management  Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Museum Management  Software")
SORT osi_score DESC
```