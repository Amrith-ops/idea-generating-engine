---
type: category
name: "Logistics Intelligence Software"
slug: "logistics-intelligence"
---

# 📂 Category: Logistics Intelligence Software

> G2 Software Category: Logistics Intelligence Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Logistics Intelligence Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Logistics Intelligence Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Logistics Intelligence Software")
SORT osi_score DESC
```