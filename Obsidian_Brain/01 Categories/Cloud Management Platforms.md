...
slug: "cloud-management-platforms"
---

# 📂 Category: Cloud Management Platforms

> G2 Software Category: Cloud Management Platforms within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Cloud Management Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cloud Management Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cloud Management Platforms")
SORT osi_score DESC
```