---
type: category
name: "Sales & Ops Planning Software"
slug: "sales-ops-planning"
---

# 📂 Category: Sales & Ops Planning Software

> G2 Software Category: Sales & Ops Planning Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Sales & Ops Planning Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Sales & Ops Planning Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Sales & Ops Planning Software")
SORT osi_score DESC
```