---
type: category
name: "Admission-Based Nonprofit Software"
slug: "admission-based-nonprofit"
---

# 📂 Category: Admission-Based Nonprofit Software

> G2 Software Category: Admission-Based Nonprofit Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Admission-Based Nonprofit Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Admission-Based Nonprofit Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Admission-Based Nonprofit Software")
SORT osi_score DESC
```