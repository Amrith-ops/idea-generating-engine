---
type: category
name: "Global Trade Management Software"
slug: "global-trade-management"
---

# 📂 Category: Global Trade Management Software

> G2 Software Category: Global Trade Management Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Global Trade Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Global Trade Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Global Trade Management Software")
SORT osi_score DESC
```