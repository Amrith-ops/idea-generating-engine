---
type: category
name: "Augmented Reality (AR) Development Software"
slug: "ar-development"
---

# 📂 Category: Augmented Reality (AR) Development Software

> G2 Software Category: Augmented Reality (AR) Development Software within AR/VR.
...
FROM "02 Products"
WHERE contains(category, "Augmented Reality (AR) Development Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Augmented Reality (AR) Development Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Augmented Reality (AR) Development Software")
SORT osi_score DESC
```