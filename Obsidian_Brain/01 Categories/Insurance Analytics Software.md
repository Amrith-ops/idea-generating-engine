---
type: category
name: "Insurance Analytics Software"
slug: "insurance-analytics"
---

# 📂 Category: Insurance Analytics Software

> G2 Software Category: Insurance Analytics Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Insurance Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Insurance Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Insurance Analytics Software")
SORT osi_score DESC
```