---
type: category
name: "Industrial AR Platforms"
slug: "industrial-ar-platforms"
---

# 📂 Category: Industrial AR Platforms

> G2 Software Category: Industrial AR Platforms within AR/VR.
...
FROM "02 Products"
WHERE contains(category, "Industrial AR Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Industrial AR Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Industrial AR Platforms")
SORT osi_score DESC
```