...
# 📂 Category: Dental Imaging Software

> G2 Software Category: Dental Imaging Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Dental Imaging Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Dental Imaging Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Dental Imaging Software")
SORT osi_score DESC
```