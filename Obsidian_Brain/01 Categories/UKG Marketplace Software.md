---
type: category
name: "UKG Marketplace Software"
slug: "ukg-marketplace"
---

# 📂 Category: UKG Marketplace Software

> G2 Software Category: UKG Marketplace Software within Marketplace Apps.
...
FROM "02 Products"
WHERE contains(category, "UKG Marketplace Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "UKG Marketplace Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "UKG Marketplace Software")
SORT osi_score DESC
```