---
type: category
name: "Job Shop Management Software"
slug: "job-shop-management"
---

# 📂 Category: Job Shop Management Software

> G2 Software Category: Job Shop Management Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Job Shop Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Job Shop Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Job Shop Management Software")
SORT osi_score DESC
```