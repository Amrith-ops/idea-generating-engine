---
type: category
name: "Audio Conferencing Software"
slug: "audio-conferencing"
---

# 📂 Category: Audio Conferencing Software

> G2 Software Category: Audio Conferencing Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Audio Conferencing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Audio Conferencing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Audio Conferencing Software")
SORT osi_score DESC
```