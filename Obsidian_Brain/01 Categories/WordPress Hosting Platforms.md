---
type: category
name: "WordPress Hosting Platforms"
slug: "wordpress-hosting"
---

# 📂 Category: WordPress Hosting Platforms

> G2 Software Category: WordPress Hosting Platforms within Hosting.
...
FROM "02 Products"
WHERE contains(category, "WordPress Hosting Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "WordPress Hosting Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "WordPress Hosting Platforms")
SORT osi_score DESC
```