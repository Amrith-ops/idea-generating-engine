---
type: category
name: "Physics Engine Software"
slug: "physics-engine"
---

# 📂 Category: Physics Engine Software

> G2 Software Category: Physics Engine Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Physics Engine Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Physics Engine Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Physics Engine Software")
SORT osi_score DESC
```