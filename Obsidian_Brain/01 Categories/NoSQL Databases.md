...
> G2 Software Category: NoSQL Databases within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "NoSQL Databases") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "NoSQL Databases") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "NoSQL Databases")
SORT osi_score DESC
```