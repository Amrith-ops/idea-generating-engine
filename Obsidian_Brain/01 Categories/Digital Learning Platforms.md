...
> G2 Software Category: Digital Learning Platforms within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Digital Learning Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Digital Learning Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Digital Learning Platforms")
SORT osi_score DESC
```