...
> G2 Software Category: Website Monitoring Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Website Monitoring Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Website Monitoring Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Website Monitoring Software")
SORT osi_score DESC
```