...
> G2 Software Category: Procurement Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Procurement Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Procurement Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Procurement Software")
SORT osi_score DESC
```