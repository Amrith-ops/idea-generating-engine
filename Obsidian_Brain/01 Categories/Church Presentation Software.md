---
type: category
name: "Church Presentation Software"
slug: "church-presentation"
---

# 📂 Category: Church Presentation Software

> G2 Software Category: Church Presentation Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Church Presentation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Church Presentation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Church Presentation Software")
SORT osi_score DESC
```