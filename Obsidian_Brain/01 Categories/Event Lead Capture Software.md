---
type: category
name: "Event Lead Capture Software"
slug: "event-lead-capture"
---

# 📂 Category: Event Lead Capture Software

> G2 Software Category: Event Lead Capture Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Event Lead Capture Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Event Lead Capture Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Event Lead Capture Software")
SORT osi_score DESC
```