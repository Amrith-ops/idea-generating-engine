...
slug: "autonomous-sourcing"
---

# 📂 Category: Autonomous Sourcing

> G2 Software Category: Autonomous Sourcing within ERP.
...
FROM "02 Products"
WHERE contains(category, "Autonomous Sourcing") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Autonomous Sourcing") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Autonomous Sourcing")
SORT osi_score DESC
```