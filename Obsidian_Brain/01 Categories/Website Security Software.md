...
> G2 Software Category: Website Security Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Website Security Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Website Security Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Website Security Software")
SORT osi_score DESC
```