...
> G2 Software Category: XML Databases within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "XML Databases") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "XML Databases") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "XML Databases")
SORT osi_score DESC
```