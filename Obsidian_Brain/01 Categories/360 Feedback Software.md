...
slug: "360-feedback-software"
---

# 📂 Category: 360 Feedback Software

> G2 Software Category: 360 Feedback Software within HR.
...
FROM "02 Products"
WHERE contains(category, "360 Feedback Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "360 Feedback Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "360 Feedback Software")
SORT osi_score DESC
```