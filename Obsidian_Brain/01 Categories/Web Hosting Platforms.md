...
> G2 Software Category: Web Hosting Platforms within Hosting.
...
FROM "02 Products"
WHERE contains(category, "Web Hosting Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Web Hosting Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Web Hosting Platforms")
SORT osi_score DESC
```