---
type: category
name: "Proxy Network Software"
slug: "proxy-networks"
---

# 📂 Category: Proxy Network Software

> G2 Software Category: Proxy Network Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Proxy Network Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Proxy Network Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Proxy Network Software")
SORT osi_score DESC
```