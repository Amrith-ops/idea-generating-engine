---
type: category
name: "Retail Analytics Software"
slug: "retail-analytics"
---

# 📂 Category: Retail Analytics Software

> G2 Software Category: Retail Analytics Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Retail Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Retail Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Retail Analytics Software")
SORT osi_score DESC
```