...
> G2 Software Category: Solar Design Software within CAD & PLM.
...
FROM "02 Products"
WHERE contains(category, "Solar Design Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Solar Design Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Solar Design Software")
SORT osi_score DESC
```