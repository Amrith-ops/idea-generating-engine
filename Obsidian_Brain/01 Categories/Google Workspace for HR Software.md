---
type: category
name: "Google Workspace for HR Software"
slug: "google-workspace-for-hr"
---

# 📂 Category: Google Workspace for HR Software

> G2 Software Category: Google Workspace for HR Software within Marketplace Apps.
...
FROM "02 Products"
WHERE contains(category, "Google Workspace for HR Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Google Workspace for HR Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Google Workspace for HR Software")
SORT osi_score DESC
```