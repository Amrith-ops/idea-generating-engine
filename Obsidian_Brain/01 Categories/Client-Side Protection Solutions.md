---
type: category
name: "Client-Side Protection Solutions"
slug: "client-side-protection"
---

# 📂 Category: Client-Side Protection Solutions

> G2 Software Category: Client-Side Protection Solutions within Security.
...
FROM "02 Products"
WHERE contains(category, "Client-Side Protection Solutions") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Client-Side Protection Solutions") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Client-Side Protection Solutions")
SORT osi_score DESC
```