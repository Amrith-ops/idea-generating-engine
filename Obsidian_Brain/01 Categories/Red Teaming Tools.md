---
type: category
name: "Red Teaming Tools"
slug: "red-teaming-tools"
---

# 📂 Category: Red Teaming Tools

> G2 Software Category: Red Teaming Tools within Security.
...
FROM "02 Products"
WHERE contains(category, "Red Teaming Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Red Teaming Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Red Teaming Tools")
SORT osi_score DESC
```