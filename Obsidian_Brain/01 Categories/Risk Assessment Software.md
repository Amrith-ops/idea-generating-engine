...
> G2 Software Category: Risk Assessment Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Risk Assessment Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Risk Assessment Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Risk Assessment Software")
SORT osi_score DESC
```