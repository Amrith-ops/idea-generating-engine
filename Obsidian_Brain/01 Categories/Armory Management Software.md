---
type: category
name: "Armory Management Software"
slug: "armory-management"
---

# 📂 Category: Armory Management Software

> G2 Software Category: Armory Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Armory Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Armory Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Armory Management Software")
SORT osi_score DESC
```