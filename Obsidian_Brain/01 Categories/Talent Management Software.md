...
# 📂 Category: Talent Management Software

> G2 Software Category: Talent Management Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Talent Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Talent Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Talent Management Software")
SORT osi_score DESC
```