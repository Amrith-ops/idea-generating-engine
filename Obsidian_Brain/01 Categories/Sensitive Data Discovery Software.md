---
type: category
name: "Sensitive Data Discovery Software"
slug: "sensitive-data-discovery"
---

# 📂 Category: Sensitive Data Discovery Software

> G2 Software Category: Sensitive Data Discovery Software within Data Privacy.
...
FROM "02 Products"
WHERE contains(category, "Sensitive Data Discovery Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Sensitive Data Discovery Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Sensitive Data Discovery Software")
SORT osi_score DESC
```