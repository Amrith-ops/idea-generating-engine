---
type: category
name: "Application Security Software"
slug: "application-security"
---

# 📂 Category: Application Security Software

> G2 Software Category: Application Security Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Application Security Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Application Security Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Application Security Software")
SORT osi_score DESC
```