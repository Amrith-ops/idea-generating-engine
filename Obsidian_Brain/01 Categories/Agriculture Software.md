...
> G2 Software Category: Agriculture Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Agriculture Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Agriculture Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Agriculture Software")
SORT osi_score DESC
```