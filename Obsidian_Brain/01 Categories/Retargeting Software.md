---
type: category
name: "Retargeting Software"
slug: "retargeting"
---

# 📂 Category: Retargeting Software

> G2 Software Category: Retargeting Software within Digital Advertising Tech.
...
FROM "02 Products"
WHERE contains(category, "Retargeting Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Retargeting Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Retargeting Software")
SORT osi_score DESC
```