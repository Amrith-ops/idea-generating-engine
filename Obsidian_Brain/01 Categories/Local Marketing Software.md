---
type: category
name: "Local Marketing Software"
slug: "local-marketing"
---

# 📂 Category: Local Marketing Software

> G2 Software Category: Local Marketing Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Local Marketing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Local Marketing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Local Marketing Software")
SORT osi_score DESC
```