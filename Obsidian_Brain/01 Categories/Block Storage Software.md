---
type: category
name: "Block Storage Software"
slug: "block-storage"
---

# 📂 Category: Block Storage Software

> G2 Software Category: Block Storage Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Block Storage Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Block Storage Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Block Storage Software")
SORT osi_score DESC
```