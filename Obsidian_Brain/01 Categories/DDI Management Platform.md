---
type: category
name: "DDI Management Platform"
slug: "ddi-management-platform"
---

# 📂 Category: DDI Management Platform

> G2 Software Category: DDI Management Platform within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "DDI Management Platform") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "DDI Management Platform") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "DDI Management Platform")
SORT osi_score DESC
```