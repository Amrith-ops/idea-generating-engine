...
# 📂 Category: Business VPN Software

> G2 Software Category: Business VPN Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Business VPN Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Business VPN Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Business VPN Software")
SORT osi_score DESC
```