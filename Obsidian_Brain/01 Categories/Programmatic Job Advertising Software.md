---
type: category
name: "Programmatic Job Advertising Software"
slug: "programmatic-job-advertising"
---

# 📂 Category: Programmatic Job Advertising Software

> G2 Software Category: Programmatic Job Advertising Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Programmatic Job Advertising Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Programmatic Job Advertising Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Programmatic Job Advertising Software")
SORT osi_score DESC
```