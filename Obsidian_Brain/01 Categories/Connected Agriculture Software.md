---
type: category
name: "Connected Agriculture Software"
slug: "connected-agriculture"
---

# 📂 Category: Connected Agriculture Software

> G2 Software Category: Connected Agriculture Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Connected Agriculture Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Connected Agriculture Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Connected Agriculture Software")
SORT osi_score DESC
```