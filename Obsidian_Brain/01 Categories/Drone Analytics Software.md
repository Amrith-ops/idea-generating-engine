---
type: category
name: "Drone Analytics Software"
slug: "drone-analytics"
---

# 📂 Category: Drone Analytics Software

> G2 Software Category: Drone Analytics Software within Analytics Tools & Software.
...
FROM "02 Products"
WHERE contains(category, "Drone Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Drone Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Drone Analytics Software")
SORT osi_score DESC
```