---
type: category
name: "Classroom Messaging Software"
slug: "classroom-messaging"
---

# 📂 Category: Classroom Messaging Software

> G2 Software Category: Classroom Messaging Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Classroom Messaging Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Classroom Messaging Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Classroom Messaging Software")
SORT osi_score DESC
```