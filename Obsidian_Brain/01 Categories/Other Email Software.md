---
type: category
name: "Other Email Software"
slug: "other-email"
---

# 📂 Category: Other Email Software

> G2 Software Category: Other Email Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Other Email Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Email Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Email Software")
SORT osi_score DESC
```