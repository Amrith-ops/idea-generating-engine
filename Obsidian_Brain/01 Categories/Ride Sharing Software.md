---
type: category
name: "Ride Sharing Software"
slug: "ride-sharing"
---

# 📂 Category: Ride Sharing Software

> G2 Software Category: Ride Sharing Software within B2B Marketplaces.
...
FROM "02 Products"
WHERE contains(category, "Ride Sharing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Ride Sharing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Ride Sharing Software")
SORT osi_score DESC
```