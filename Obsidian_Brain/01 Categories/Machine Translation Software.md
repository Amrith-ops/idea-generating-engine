...
> G2 Software Category: Machine Translation Software within Content Management.
...
FROM "02 Products"
WHERE contains(category, "Machine Translation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Machine Translation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Machine Translation Software")
SORT osi_score DESC
```