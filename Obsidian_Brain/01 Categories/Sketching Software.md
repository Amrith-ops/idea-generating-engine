---
type: category
name: "Sketching Software"
slug: "sketching"
---

# 📂 Category: Sketching Software

> G2 Software Category: Sketching Software within CAD & PLM.
...
FROM "02 Products"
WHERE contains(category, "Sketching Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Sketching Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Sketching Software")
SORT osi_score DESC
```