---
type: category
name: "Predictive Analytics Software"
slug: "predictive-analytics"
---

# 📂 Category: Predictive Analytics Software

> G2 Software Category: Predictive Analytics Software within Analytics Tools & Software.
...
FROM "02 Products"
WHERE contains(category, "Predictive Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Predictive Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Predictive Analytics Software")
SORT osi_score DESC
```