---
type: category
name: "Other Law Enforcement Software"
slug: "other-law-enforcement"
---

# 📂 Category: Other Law Enforcement Software

> G2 Software Category: Other Law Enforcement Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Law Enforcement Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Law Enforcement Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Law Enforcement Software")
SORT osi_score DESC
```