---
type: category
name: "Cross-Channel Advertising Software"
slug: "cross-channel-advertising"
---

# 📂 Category: Cross-Channel Advertising Software

> G2 Software Category: Cross-Channel Advertising Software within Digital Advertising Tech.
...
FROM "02 Products"
WHERE contains(category, "Cross-Channel Advertising Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cross-Channel Advertising Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cross-Channel Advertising Software")
SORT osi_score DESC
```