---
type: category
name: "Process ERP Software"
slug: "process-erp"
---

# 📂 Category: Process ERP Software

> G2 Software Category: Process ERP Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Process ERP Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Process ERP Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Process ERP Software")
SORT osi_score DESC
```