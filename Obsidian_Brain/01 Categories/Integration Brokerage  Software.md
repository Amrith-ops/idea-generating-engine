---
type: category
name: "Integration Brokerage  Software"
slug: "integration-brokerage"
---

# 📂 Category: Integration Brokerage  Software

> G2 Software Category: Integration Brokerage  Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Integration Brokerage  Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Integration Brokerage  Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Integration Brokerage  Software")
SORT osi_score DESC
```