---
type: category
name: "Sports Software"
slug: "sports"
---

# 📂 Category: Sports Software

> G2 Software Category: Sports Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Sports Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Sports Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Sports Software")
SORT osi_score DESC
```