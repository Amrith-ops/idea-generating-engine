...
# 📂 Category: Warehouse Automation Software

> G2 Software Category: Warehouse Automation Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Warehouse Automation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Warehouse Automation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Warehouse Automation Software")
SORT osi_score DESC
```