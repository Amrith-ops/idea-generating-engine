...
> G2 Software Category: IoT Platforms within IoT Management.
...
FROM "02 Products"
WHERE contains(category, "IoT Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "IoT Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "IoT Platforms")
SORT osi_score DESC
```