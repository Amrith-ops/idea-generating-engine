---
type: category
name: "Digital Forensics Software"
slug: "digital-forensics"
---

# 📂 Category: Digital Forensics Software

> G2 Software Category: Digital Forensics Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Digital Forensics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Digital Forensics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Digital Forensics Software")
SORT osi_score DESC
```