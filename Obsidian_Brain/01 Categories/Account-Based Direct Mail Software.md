---
type: category
name: "Account-Based Direct Mail Software"
slug: "account-based-direct-mail"
---

# 📂 Category: Account-Based Direct Mail Software

> G2 Software Category: Account-Based Direct Mail Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Account-Based Direct Mail Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Account-Based Direct Mail Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Account-Based Direct Mail Software")
SORT osi_score DESC
```