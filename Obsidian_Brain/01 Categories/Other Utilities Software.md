---
type: category
name: "Other Utilities Software"
slug: "other-utilities"
---

# 📂 Category: Other Utilities Software

> G2 Software Category: Other Utilities Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Utilities Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Utilities Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Utilities Software")
SORT osi_score DESC
```