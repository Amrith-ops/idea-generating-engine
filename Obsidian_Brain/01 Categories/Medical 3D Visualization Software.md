---
type: category
name: "Medical 3D Visualization Software"
slug: "medical-3d-visualization"
---

# 📂 Category: Medical 3D Visualization Software

> G2 Software Category: Medical 3D Visualization Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Medical 3D Visualization Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Medical 3D Visualization Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Medical 3D Visualization Software")
SORT osi_score DESC
```