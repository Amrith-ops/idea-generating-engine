---
type: category
name: "Email Backup Software"
slug: "email-backup"
---

# 📂 Category: Email Backup Software

> G2 Software Category: Email Backup Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Email Backup Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Email Backup Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Email Backup Software")
SORT osi_score DESC
```