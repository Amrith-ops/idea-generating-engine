...
slug: "low-code-development-platforms"
---

# 📂 Category: Low-Code Development Platforms

> G2 Software Category: Low-Code Development Platforms within Development.
...
FROM "02 Products"
WHERE contains(category, "Low-Code Development Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Low-Code Development Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Low-Code Development Platforms")
SORT osi_score DESC
```