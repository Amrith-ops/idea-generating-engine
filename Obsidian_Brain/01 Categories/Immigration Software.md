...
# 📂 Category: Immigration Software

> G2 Software Category: Immigration Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Immigration Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Immigration Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Immigration Software")
SORT osi_score DESC
```