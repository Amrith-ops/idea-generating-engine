...
slug: "pharmacy-management-systems"
---

# 📂 Category: Pharmacy Management Systems

> G2 Software Category: Pharmacy Management Systems within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Pharmacy Management Systems") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Pharmacy Management Systems") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Pharmacy Management Systems")
SORT osi_score DESC
```