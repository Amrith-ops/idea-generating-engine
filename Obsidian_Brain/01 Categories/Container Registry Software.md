---
type: category
name: "Container Registry Software"
slug: "container-registry"
---

# 📂 Category: Container Registry Software

> G2 Software Category: Container Registry Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Container Registry Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Container Registry Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Container Registry Software")
SORT osi_score DESC
```