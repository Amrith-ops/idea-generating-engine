---
type: category
name: "Physical Security Software"
slug: "physical-security"
---

# 📂 Category: Physical Security Software

> G2 Software Category: Physical Security Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Physical Security Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Physical Security Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Physical Security Software")
SORT osi_score DESC
```