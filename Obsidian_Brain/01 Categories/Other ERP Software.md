---
type: category
name: "Other ERP Software"
slug: "other-erp"
---

# 📂 Category: Other ERP Software

> G2 Software Category: Other ERP Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Other ERP Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other ERP Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other ERP Software")
SORT osi_score DESC
```