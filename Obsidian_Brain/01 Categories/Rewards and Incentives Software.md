---
type: category
name: "Rewards and Incentives Software"
slug: "rewards-and-incentives"
---

# 📂 Category: Rewards and Incentives Software

> G2 Software Category: Rewards and Incentives Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Rewards and Incentives Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Rewards and Incentives Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Rewards and Incentives Software")
SORT osi_score DESC
```