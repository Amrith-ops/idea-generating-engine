---
type: category
name: "Personalization Software"
slug: "personalization"
---

# 📂 Category: Personalization Software

> G2 Software Category: Personalization Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Personalization Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Personalization Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Personalization Software")
SORT osi_score DESC
```