...
slug: "blockchain-payments"
---

# 📂 Category: Blockchain Payment Systems

> G2 Software Category: Blockchain Payment Systems within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Blockchain Payment Systems") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Blockchain Payment Systems") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Blockchain Payment Systems")
SORT osi_score DESC
```