---
type: category
name: "Bundled Pay Management Software"
slug: "bundled-pay-management"
---

# 📂 Category: Bundled Pay Management Software

> G2 Software Category: Bundled Pay Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Bundled Pay Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Bundled Pay Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Bundled Pay Management Software")
SORT osi_score DESC
```