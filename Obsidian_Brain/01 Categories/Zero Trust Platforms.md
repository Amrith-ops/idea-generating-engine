---
type: category
name: "Zero Trust Platforms"
slug: "zero-trust-platforms"
---

# 📂 Category: Zero Trust Platforms

> G2 Software Category: Zero Trust Platforms within Zero Trust.
...
FROM "02 Products"
WHERE contains(category, "Zero Trust Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Zero Trust Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Zero Trust Platforms")
SORT osi_score DESC
```