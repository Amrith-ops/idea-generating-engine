---
type: category
name: "Direct Store Delivery Software"
slug: "direct-store-delivery"
---

# 📂 Category: Direct Store Delivery Software

> G2 Software Category: Direct Store Delivery Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Direct Store Delivery Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Direct Store Delivery Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Direct Store Delivery Software")
SORT osi_score DESC
```