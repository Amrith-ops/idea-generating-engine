---
type: category
name: "DataOps Platforms"
slug: "dataops-platforms"
---

# 📂 Category: DataOps Platforms

> G2 Software Category: DataOps Platforms within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "DataOps Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "DataOps Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "DataOps Platforms")
SORT osi_score DESC
```