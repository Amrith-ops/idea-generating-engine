...
# 📂 Category: Pet Grooming Software

> G2 Software Category: Pet Grooming Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Pet Grooming Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Pet Grooming Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Pet Grooming Software")
SORT osi_score DESC
```