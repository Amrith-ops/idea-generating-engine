...
> G2 Software Category: Digital Asset Management Software within Content Management.
...
FROM "02 Products"
WHERE contains(category, "Digital Asset Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Digital Asset Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Digital Asset Management Software")
SORT osi_score DESC
```