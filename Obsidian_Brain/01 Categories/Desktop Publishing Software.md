...
> G2 Software Category: Desktop Publishing Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Desktop Publishing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Desktop Publishing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Desktop Publishing Software")
SORT osi_score DESC
```