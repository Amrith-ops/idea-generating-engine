---
type: category
name: "Other Continuous Delivery Software"
slug: "other-continuous-delivery"
---

# 📂 Category: Other Continuous Delivery Software

> G2 Software Category: Other Continuous Delivery Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Other Continuous Delivery Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Continuous Delivery Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Continuous Delivery Software")
SORT osi_score DESC
```