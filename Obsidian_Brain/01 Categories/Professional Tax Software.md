---
type: category
name: "Professional Tax Software"
slug: "professional-tax"
---

# 📂 Category: Professional Tax Software

> G2 Software Category: Professional Tax Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Professional Tax Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Professional Tax Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Professional Tax Software")
SORT osi_score DESC
```