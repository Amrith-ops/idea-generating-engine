---
type: category
name: "Church Software"
slug: "church"
---

# 📂 Category: Church Software

> G2 Software Category: Church Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Church Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Church Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Church Software")
SORT osi_score DESC
```