---
type: category
name: "Google Workspace Administration Software"
slug: "google-workspace-administration"
---

# 📂 Category: Google Workspace Administration Software

> G2 Software Category: Google Workspace Administration Software within Marketplace Apps.
...
FROM "02 Products"
WHERE contains(category, "Google Workspace Administration Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Google Workspace Administration Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Google Workspace Administration Software")
SORT osi_score DESC
```