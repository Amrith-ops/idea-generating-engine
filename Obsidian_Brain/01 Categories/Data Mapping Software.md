---
type: category
name: "Data Mapping Software"
slug: "data-mapping"
---

# 📂 Category: Data Mapping Software

> G2 Software Category: Data Mapping Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Data Mapping Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Mapping Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Mapping Software")
SORT osi_score DESC
```