...
> G2 Software Category: Laboratory Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Laboratory Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Laboratory Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Laboratory Software")
SORT osi_score DESC
```