...
# 📂 Category: UAV Software

> G2 Software Category: UAV Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "UAV Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "UAV Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "UAV Software")
SORT osi_score DESC
```