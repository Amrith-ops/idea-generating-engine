...
# 📂 Category: DMARC Software

> G2 Software Category: DMARC Software within Security.
...
FROM "02 Products"
WHERE contains(category, "DMARC Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "DMARC Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "DMARC Software")
SORT osi_score DESC
```