---
type: category
name: "Email Security Software"
slug: "email-security"
---

# 📂 Category: Email Security Software

> G2 Software Category: Email Security Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Email Security Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Email Security Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Email Security Software")
SORT osi_score DESC
```