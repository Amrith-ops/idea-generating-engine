---
type: category
name: "Digital Business Card Software"
slug: "digital-business-card"
---

# 📂 Category: Digital Business Card Software

> G2 Software Category: Digital Business Card Software within Office Management Software.
...
FROM "02 Products"
WHERE contains(category, "Digital Business Card Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Digital Business Card Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Digital Business Card Software")
SORT osi_score DESC
```