---
type: category
name: "Talent Assessment Software"
slug: "talent-assessment-software"
---

# 📂 Category: Talent Assessment Software

> G2 Software Category: Talent Assessment Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Talent Assessment Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Talent Assessment Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Talent Assessment Software")
SORT osi_score DESC
```