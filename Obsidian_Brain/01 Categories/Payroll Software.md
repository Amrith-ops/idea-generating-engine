...
> G2 Software Category: Payroll Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Payroll Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Payroll Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Payroll Software")
SORT osi_score DESC
```