---
type: category
name: "Content Analytics Software"
slug: "content-analytics"
---

# 📂 Category: Content Analytics Software

> G2 Software Category: Content Analytics Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Content Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Content Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Content Analytics Software")
SORT osi_score DESC
```