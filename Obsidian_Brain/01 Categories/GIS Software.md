...
> G2 Software Category: GIS Software within CAD & PLM.
...
FROM "02 Products"
WHERE contains(category, "GIS Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "GIS Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "GIS Software")
SORT osi_score DESC
```