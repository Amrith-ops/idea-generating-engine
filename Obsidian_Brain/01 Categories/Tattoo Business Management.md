---
type: category
name: "Tattoo Business Management"
slug: "tattoo-business-management"
---

# 📂 Category: Tattoo Business Management

> G2 Software Category: Tattoo Business Management within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Tattoo Business Management") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Tattoo Business Management") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Tattoo Business Management")
SORT osi_score DESC
```