...
> G2 Software Category: Antivirus Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Antivirus Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Antivirus Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Antivirus Software")
SORT osi_score DESC
```