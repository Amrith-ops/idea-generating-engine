---
type: category
name: "Direct Mail Automation Software"
slug: "direct-mail-automation"
---

# 📂 Category: Direct Mail Automation Software

> G2 Software Category: Direct Mail Automation Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Direct Mail Automation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Direct Mail Automation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Direct Mail Automation Software")
SORT osi_score DESC
```