...
> G2 Software Category: Event Management Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Event Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Event Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Event Management Software")
SORT osi_score DESC
```