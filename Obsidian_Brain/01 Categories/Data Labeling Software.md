---
type: category
name: "Data Labeling Software"
slug: "data-labeling"
---

# 📂 Category: Data Labeling Software

> G2 Software Category: Data Labeling Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Data Labeling Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Labeling Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Labeling Software")
SORT osi_score DESC
```