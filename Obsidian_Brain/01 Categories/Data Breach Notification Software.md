---
type: category
name: "Data Breach Notification Software"
slug: "data-breach-notification"
---

# 📂 Category: Data Breach Notification Software

> G2 Software Category: Data Breach Notification Software within Data Privacy.
...
FROM "02 Products"
WHERE contains(category, "Data Breach Notification Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Breach Notification Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Breach Notification Software")
SORT osi_score DESC
```