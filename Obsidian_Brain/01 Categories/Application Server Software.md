...
> G2 Software Category: Application Server Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Application Server Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Application Server Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Application Server Software")
SORT osi_score DESC
```