...
> G2 Software Category: Mining Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Mining Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Mining Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Mining Software")
SORT osi_score DESC
```