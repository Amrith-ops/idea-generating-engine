---
type: category
name: "Insurance Compliance Software"
slug: "insurance-compliance"
---

# 📂 Category: Insurance Compliance Software

> G2 Software Category: Insurance Compliance Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Insurance Compliance Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Insurance Compliance Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Insurance Compliance Software")
SORT osi_score DESC
```