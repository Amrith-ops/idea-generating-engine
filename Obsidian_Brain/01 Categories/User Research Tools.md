...
> G2 Software Category: User Research Tools within Marketing.
...
FROM "02 Products"
WHERE contains(category, "User Research Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "User Research Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "User Research Tools")
SORT osi_score DESC
```