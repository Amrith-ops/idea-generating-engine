---
type: category
name: "Google Workspace Academic Software"
slug: "google-workspace-academic"
---

# 📂 Category: Google Workspace Academic Software

> G2 Software Category: Google Workspace Academic Software within Marketplace Apps.
...
FROM "02 Products"
WHERE contains(category, "Google Workspace Academic Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Google Workspace Academic Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Google Workspace Academic Software")
SORT osi_score DESC
```