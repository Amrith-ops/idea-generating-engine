---
type: category
name: "Internal Newsletter Software"
slug: "internal-newsletter-software"
---

# 📂 Category: Internal Newsletter Software

> G2 Software Category: Internal Newsletter Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Internal Newsletter Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Internal Newsletter Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Internal Newsletter Software")
SORT osi_score DESC
```