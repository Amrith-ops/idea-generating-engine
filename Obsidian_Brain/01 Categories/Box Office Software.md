...
# 📂 Category: Box Office Software

> G2 Software Category: Box Office Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Box Office Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Box Office Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Box Office Software")
SORT osi_score DESC
```