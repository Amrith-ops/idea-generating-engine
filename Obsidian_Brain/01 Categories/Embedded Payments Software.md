---
type: category
name: "Embedded Payments Software"
slug: "embedded-payments"
---

# 📂 Category: Embedded Payments Software

> G2 Software Category: Embedded Payments Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Embedded Payments Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Embedded Payments Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Embedded Payments Software")
SORT osi_score DESC
```