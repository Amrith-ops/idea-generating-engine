...
> G2 Software Category: Data Visualization Tools within Analytics Tools & Software.
...
FROM "02 Products"
WHERE contains(category, "Data Visualization Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Visualization Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Visualization Tools")
SORT osi_score DESC
```