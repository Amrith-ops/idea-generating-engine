...
> G2 Software Category: Graphic Design Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Graphic Design Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Graphic Design Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Graphic Design Software")
SORT osi_score DESC
```