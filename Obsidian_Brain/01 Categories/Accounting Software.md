...
> G2 Software Category: Accounting Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Accounting Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Accounting Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Accounting Software")
SORT osi_score DESC
```