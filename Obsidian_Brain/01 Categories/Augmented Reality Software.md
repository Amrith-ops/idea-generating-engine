---
type: category
name: "Augmented Reality Software"
slug: "augmented-reality"
---

# 📂 Category: Augmented Reality Software

> G2 Software Category: Augmented Reality Software within AR/VR.
...
FROM "02 Products"
WHERE contains(category, "Augmented Reality Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Augmented Reality Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Augmented Reality Software")
SORT osi_score DESC
```