---
type: category
name: "Other Sales Software"
slug: "other-sales"
---

# 📂 Category: Other Sales Software

> G2 Software Category: Other Sales Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Other Sales Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Sales Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Sales Software")
SORT osi_score DESC
```