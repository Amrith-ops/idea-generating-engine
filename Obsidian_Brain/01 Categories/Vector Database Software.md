---
type: category
name: "Vector Database Software"
slug: "vector-database"
---

# 📂 Category: Vector Database Software

> G2 Software Category: Vector Database Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Vector Database Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Vector Database Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Vector Database Software")
SORT osi_score DESC
```