---
type: category
name: "Cryptocurrency Software"
slug: "cryptocurrency"
---

# 📂 Category: Cryptocurrency Software

> G2 Software Category: Cryptocurrency Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Cryptocurrency Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cryptocurrency Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cryptocurrency Software")
SORT osi_score DESC
```