---
type: category
name: "Property Intelligence Software"
slug: "property-intelligence"
---

# 📂 Category: Property Intelligence Software

> G2 Software Category: Property Intelligence Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Property Intelligence Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Property Intelligence Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Property Intelligence Software")
SORT osi_score DESC
```