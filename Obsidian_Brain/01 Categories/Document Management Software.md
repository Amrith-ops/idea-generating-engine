...
> G2 Software Category: Document Management Software within Content Management.
...
FROM "02 Products"
WHERE contains(category, "Document Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Document Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Document Management Software")
SORT osi_score DESC
```