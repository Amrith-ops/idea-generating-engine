---
type: category
name: "Other Oil and Gas Software"
slug: "other-oil-and-gas"
---

# 📂 Category: Other Oil and Gas Software

> G2 Software Category: Other Oil and Gas Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Oil and Gas Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Oil and Gas Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Oil and Gas Software")
SORT osi_score DESC
```