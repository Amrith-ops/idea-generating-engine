...
# 📂 Category: Pest Control Software

> G2 Software Category: Pest Control Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Pest Control Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Pest Control Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Pest Control Software")
SORT osi_score DESC
```