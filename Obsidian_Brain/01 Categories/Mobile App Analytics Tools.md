...
# 📂 Category: Mobile App Analytics Tools

> G2 Software Category: Mobile App Analytics Tools within Development.
...
FROM "02 Products"
WHERE contains(category, "Mobile App Analytics Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Mobile App Analytics Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Mobile App Analytics Tools")
SORT osi_score DESC
```