---
type: category
name: "Political Software"
slug: "political"
---

# 📂 Category: Political Software

> G2 Software Category: Political Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Political Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Political Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Political Software")
SORT osi_score DESC
```