---
type: category
name: "Customer Advocacy Software"
slug: "customer-advocacy"
---

# 📂 Category: Customer Advocacy Software

> G2 Software Category: Customer Advocacy Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Customer Advocacy Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Customer Advocacy Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Customer Advocacy Software")
SORT osi_score DESC
```