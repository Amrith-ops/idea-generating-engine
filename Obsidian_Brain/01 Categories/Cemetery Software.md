...
# 📂 Category: Cemetery Software

> G2 Software Category: Cemetery Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Cemetery Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cemetery Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cemetery Software")
SORT osi_score DESC
```