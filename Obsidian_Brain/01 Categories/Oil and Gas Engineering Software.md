---
type: category
name: "Oil and Gas Engineering Software"
slug: "oil-and-gas-engineering"
---

# 📂 Category: Oil and Gas Engineering Software

> G2 Software Category: Oil and Gas Engineering Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Oil and Gas Engineering Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Oil and Gas Engineering Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Oil and Gas Engineering Software")
SORT osi_score DESC
```