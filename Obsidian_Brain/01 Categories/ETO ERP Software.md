---
type: category
name: "ETO ERP Software"
slug: "eto-erp"
---

# 📂 Category: ETO ERP Software

> G2 Software Category: ETO ERP Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "ETO ERP Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "ETO ERP Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "ETO ERP Software")
SORT osi_score DESC
```