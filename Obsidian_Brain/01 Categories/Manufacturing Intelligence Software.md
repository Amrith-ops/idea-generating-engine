---
type: category
name: "Manufacturing Intelligence Software"
slug: "manufacturing-intelligence"
---

# 📂 Category: Manufacturing Intelligence Software

> G2 Software Category: Manufacturing Intelligence Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Manufacturing Intelligence Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Manufacturing Intelligence Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Manufacturing Intelligence Software")
SORT osi_score DESC
```