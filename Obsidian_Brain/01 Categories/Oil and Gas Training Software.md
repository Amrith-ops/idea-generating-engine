---
type: category
name: "Oil and Gas Training Software"
slug: "oil-and-gas-training"
---

# 📂 Category: Oil and Gas Training Software

> G2 Software Category: Oil and Gas Training Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Oil and Gas Training Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Oil and Gas Training Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Oil and Gas Training Software")
SORT osi_score DESC
```