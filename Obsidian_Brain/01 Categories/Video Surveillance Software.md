---
type: category
name: "Video Surveillance Software"
slug: "video-surveillance"
---

# 📂 Category: Video Surveillance Software

> G2 Software Category: Video Surveillance Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Video Surveillance Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Video Surveillance Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Video Surveillance Software")
SORT osi_score DESC
```