...
> G2 Software Category: Data Warehouse Solutions within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Data Warehouse Solutions") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Warehouse Solutions") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Warehouse Solutions")
SORT osi_score DESC
```