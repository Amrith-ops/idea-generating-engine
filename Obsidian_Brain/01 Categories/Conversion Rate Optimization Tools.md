...
> G2 Software Category: Conversion Rate Optimization Tools within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Conversion Rate Optimization Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Conversion Rate Optimization Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Conversion Rate Optimization Tools")
SORT osi_score DESC
```