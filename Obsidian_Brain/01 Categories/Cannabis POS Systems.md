...
slug: "cannabis-pos-systems"
---

# 📂 Category: Cannabis POS Systems

> G2 Software Category: Cannabis POS Systems within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Cannabis POS Systems") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cannabis POS Systems") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cannabis POS Systems")
SORT osi_score DESC
```