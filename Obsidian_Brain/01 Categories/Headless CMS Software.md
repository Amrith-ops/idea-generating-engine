...
# 📂 Category: Headless CMS Software

> G2 Software Category: Headless CMS Software within Content Management.
...
FROM "02 Products"
WHERE contains(category, "Headless CMS Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Headless CMS Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Headless CMS Software")
SORT osi_score DESC
```