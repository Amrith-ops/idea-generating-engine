---
type: category
name: "Cloud GTM Platforms"
slug: "cloud-gtm-platforms"
---

# 📂 Category: Cloud GTM Platforms

> G2 Software Category: Cloud GTM Platforms within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Cloud GTM Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cloud GTM Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cloud GTM Platforms")
SORT osi_score DESC
```