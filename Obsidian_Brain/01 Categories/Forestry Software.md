---
type: category
name: "Forestry Software"
slug: "forestry"
---

# 📂 Category: Forestry Software

> G2 Software Category: Forestry Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Forestry Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Forestry Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Forestry Software")
SORT osi_score DESC
```