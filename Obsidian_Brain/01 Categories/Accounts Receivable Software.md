...
# 📂 Category: Accounts Receivable Software

> G2 Software Category: Accounts Receivable Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Accounts Receivable Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Accounts Receivable Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Accounts Receivable Software")
SORT osi_score DESC
```