---
type: category
name: "Observability Software"
slug: "observability-software"
---

# 📂 Category: Observability Software

> G2 Software Category: Observability Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Observability Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Observability Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Observability Software")
SORT osi_score DESC
```