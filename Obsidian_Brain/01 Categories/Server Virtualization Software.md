---
type: category
name: "Server Virtualization Software"
slug: "server-virtualization"
---

# 📂 Category: Server Virtualization Software

> G2 Software Category: Server Virtualization Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Server Virtualization Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Server Virtualization Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Server Virtualization Software")
SORT osi_score DESC
```