---
type: category
name: "Medical Quality Management Systems (QMS)"
slug: "medical-qms"
---

# 📂 Category: Medical Quality Management Systems (QMS)

> G2 Software Category: Medical Quality Management Systems (QMS) within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Medical Quality Management Systems (QMS)") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Medical Quality Management Systems (QMS)") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Medical Quality Management Systems (QMS)")
SORT osi_score DESC
```