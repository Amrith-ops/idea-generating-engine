---
type: category
name: "AI Agents for HR Software"
slug: "ai-agents-for-hr"
---

# 📂 Category: AI Agents for HR Software

> G2 Software Category: AI Agents for HR Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "AI Agents for HR Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI Agents for HR Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI Agents for HR Software")
SORT osi_score DESC
```