---
type: category
name: "Recruitment Marketing Platforms"
slug: "recruitment-marketing"
---

# 📂 Category: Recruitment Marketing Platforms

> G2 Software Category: Recruitment Marketing Platforms within HR.
...
FROM "02 Products"
WHERE contains(category, "Recruitment Marketing Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Recruitment Marketing Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Recruitment Marketing Platforms")
SORT osi_score DESC
```