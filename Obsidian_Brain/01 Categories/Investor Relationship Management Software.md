...
# 📂 Category: Investor Relationship Management Software

> G2 Software Category: Investor Relationship Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Investor Relationship Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Investor Relationship Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Investor Relationship Management Software")
SORT osi_score DESC
```