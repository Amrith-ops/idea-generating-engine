---
type: category
name: "On-Demand Catering Software"
slug: "on-demand-catering"
---

# 📂 Category: On-Demand Catering Software

> G2 Software Category: On-Demand Catering Software within B2B Marketplaces.
...
FROM "02 Products"
WHERE contains(category, "On-Demand Catering Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "On-Demand Catering Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "On-Demand Catering Software")
SORT osi_score DESC
```