...
# 📂 Category: Equipment Rental Software

> G2 Software Category: Equipment Rental Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Equipment Rental Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Equipment Rental Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Equipment Rental Software")
SORT osi_score DESC
```