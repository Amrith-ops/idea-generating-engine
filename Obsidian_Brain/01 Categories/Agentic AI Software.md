---
type: category
name: "Agentic AI Software"
slug: "agentic-ai"
---

# 📂 Category: Agentic AI Software

> G2 Software Category: Agentic AI Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Agentic AI Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Agentic AI Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Agentic AI Software")
SORT osi_score DESC
```