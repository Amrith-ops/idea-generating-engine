---
type: category
name: "Data Fabric Software"
slug: "data-fabric"
---

# 📂 Category: Data Fabric Software

> G2 Software Category: Data Fabric Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Data Fabric Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Fabric Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Fabric Software")
SORT osi_score DESC
```