---
type: category
name: "Disaster Recovery Software"
slug: "disaster-recovery"
---

# 📂 Category: Disaster Recovery Software

> G2 Software Category: Disaster Recovery Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Disaster Recovery Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Disaster Recovery Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Disaster Recovery Software")
SORT osi_score DESC
```