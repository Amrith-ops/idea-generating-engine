---
type: category
name: "Wide Column Database Software"
slug: "wide-column-database"
---

# 📂 Category: Wide Column Database Software

> G2 Software Category: Wide Column Database Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Wide Column Database Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Wide Column Database Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Wide Column Database Software")
SORT osi_score DESC
```