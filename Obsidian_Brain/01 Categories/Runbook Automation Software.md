---
type: category
name: "Runbook Automation Software"
slug: "runbook-automation"
---

# 📂 Category: Runbook Automation Software

> G2 Software Category: Runbook Automation Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Runbook Automation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Runbook Automation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Runbook Automation Software")
SORT osi_score DESC
```