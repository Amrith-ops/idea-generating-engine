...
# 📂 Category: Software Design Software

> G2 Software Category: Software Design Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Software Design Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Software Design Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Software Design Software")
SORT osi_score DESC
```