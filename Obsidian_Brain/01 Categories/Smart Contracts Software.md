---
type: category
name: "Smart Contracts Software"
slug: "smart-contracts"
---

# 📂 Category: Smart Contracts Software

> G2 Software Category: Smart Contracts Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Smart Contracts Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Smart Contracts Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Smart Contracts Software")
SORT osi_score DESC
```