---
type: category
name: "Home Furnishing Software"
slug: "home-furnishing"
---

# 📂 Category: Home Furnishing Software

> G2 Software Category: Home Furnishing Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Home Furnishing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Home Furnishing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Home Furnishing Software")
SORT osi_score DESC
```