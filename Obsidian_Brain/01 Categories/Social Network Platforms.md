...
# 📂 Category: Social Network Platforms

> G2 Software Category: Social Network Platforms within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Social Network Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Social Network Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Social Network Platforms")
SORT osi_score DESC
```