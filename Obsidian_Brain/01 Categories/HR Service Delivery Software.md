---
type: category
name: "HR Service Delivery Software"
slug: "hr-service-delivery"
---

# 📂 Category: HR Service Delivery Software

> G2 Software Category: HR Service Delivery Software within HR.
...
FROM "02 Products"
WHERE contains(category, "HR Service Delivery Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "HR Service Delivery Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "HR Service Delivery Software")
SORT osi_score DESC
```