---
type: category
name: "Aviation Authoring Software"
slug: "aviation-authoring"
---

# 📂 Category: Aviation Authoring Software

> G2 Software Category: Aviation Authoring Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Aviation Authoring Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Aviation Authoring Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Aviation Authoring Software")
SORT osi_score DESC
```