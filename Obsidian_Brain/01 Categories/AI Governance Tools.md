...
> G2 Software Category: AI Governance Tools within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "AI Governance Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI Governance Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI Governance Tools")
SORT osi_score DESC
```