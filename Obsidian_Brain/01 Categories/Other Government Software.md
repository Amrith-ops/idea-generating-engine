---
type: category
name: "Other Government Software"
slug: "other-government-d4c8acd9-570b-4c29-a393-3556c677048d"
---

# 📂 Category: Other Government Software

> G2 Software Category: Other Government Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Government Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Government Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Government Software")
SORT osi_score DESC
```