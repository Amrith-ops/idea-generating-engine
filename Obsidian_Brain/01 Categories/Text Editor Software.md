...
# 📂 Category: Text Editor Software

> G2 Software Category: Text Editor Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Text Editor Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Text Editor Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Text Editor Software")
SORT osi_score DESC
```