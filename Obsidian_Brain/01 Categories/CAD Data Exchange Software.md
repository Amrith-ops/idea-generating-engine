---
type: category
name: "CAD Data Exchange Software"
slug: "cad-data-exchange"
---

# 📂 Category: CAD Data Exchange Software

> G2 Software Category: CAD Data Exchange Software within CAD & PLM.
...
FROM "02 Products"
WHERE contains(category, "CAD Data Exchange Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "CAD Data Exchange Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "CAD Data Exchange Software")
SORT osi_score DESC
```