...
> G2 Software Category: Subscription Management Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Subscription Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Subscription Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Subscription Management Software")
SORT osi_score DESC
```