...
# 📂 Category: AI SOC Agents

> G2 Software Category: AI SOC Agents within Security.
...
FROM "02 Products"
WHERE contains(category, "AI SOC Agents") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI SOC Agents") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI SOC Agents")
SORT osi_score DESC
```