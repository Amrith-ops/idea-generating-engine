...
> G2 Software Category: IT Asset Management Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "IT Asset Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "IT Asset Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "IT Asset Management Software")
SORT osi_score DESC
```