---
type: category
name: "Medical IoT Software"
slug: "medical-iot"
---

# 📂 Category: Medical IoT Software

> G2 Software Category: Medical IoT Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Medical IoT Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Medical IoT Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Medical IoT Software")
SORT osi_score DESC
```