---
type: category
name: "Supply Chain Business Networks"
slug: "supply-chain-business-networks"
---

# 📂 Category: Supply Chain Business Networks

> G2 Software Category: Supply Chain Business Networks within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Supply Chain Business Networks") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Supply Chain Business Networks") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Supply Chain Business Networks")
SORT osi_score DESC
```