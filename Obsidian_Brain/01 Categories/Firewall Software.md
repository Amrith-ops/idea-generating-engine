...
> G2 Software Category: Firewall Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Firewall Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Firewall Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Firewall Software")
SORT osi_score DESC
```