---
type: category
name: "Optometry Software"
slug: "optometry"
---

# 📂 Category: Optometry Software

> G2 Software Category: Optometry Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Optometry Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Optometry Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Optometry Software")
SORT osi_score DESC
```