---
type: category
name: "Earthworks Software"
slug: "earthworks"
---

# 📂 Category: Earthworks Software

> G2 Software Category: Earthworks Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Earthworks Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Earthworks Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Earthworks Software")
SORT osi_score DESC
```