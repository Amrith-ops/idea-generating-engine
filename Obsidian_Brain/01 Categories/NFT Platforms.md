...
> G2 Software Category: NFT Platforms within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "NFT Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "NFT Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "NFT Platforms")
SORT osi_score DESC
```