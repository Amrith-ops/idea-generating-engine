---
type: category
name: "Desktop Database Software"
slug: "desktop-database"
---

# 📂 Category: Desktop Database Software

> G2 Software Category: Desktop Database Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Desktop Database Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Desktop Database Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Desktop Database Software")
SORT osi_score DESC
```