---
type: category
name: "Zero Trust Architecture Software"
slug: "zero-trust-architecture"
---

# 📂 Category: Zero Trust Architecture Software

> G2 Software Category: Zero Trust Architecture Software within Zero Trust.
...
FROM "02 Products"
WHERE contains(category, "Zero Trust Architecture Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Zero Trust Architecture Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Zero Trust Architecture Software")
SORT osi_score DESC
```