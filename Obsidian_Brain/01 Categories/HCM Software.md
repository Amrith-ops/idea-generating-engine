...
> G2 Software Category: HCM Software within HR.
...
FROM "02 Products"
WHERE contains(category, "HCM Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "HCM Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "HCM Software")
SORT osi_score DESC
```