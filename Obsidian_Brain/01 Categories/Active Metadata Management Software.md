---
type: category
name: "Active Metadata Management Software"
slug: "active-metadata-management"
---

# 📂 Category: Active Metadata Management Software

> G2 Software Category: Active Metadata Management Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Active Metadata Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Active Metadata Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Active Metadata Management Software")
SORT osi_score DESC
```