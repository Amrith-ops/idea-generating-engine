---
type: category
name: "Presales Software"
slug: "presales"
---

# 📂 Category: Presales Software

> G2 Software Category: Presales Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Presales Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Presales Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Presales Software")
SORT osi_score DESC
```