...
slug: "virtual-routers"
---

# 📂 Category: Virtual Routers

> G2 Software Category: Virtual Routers within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Virtual Routers") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Virtual Routers") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Virtual Routers")
SORT osi_score DESC
```