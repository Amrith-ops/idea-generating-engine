---
type: category
name: "Mobile Marketing Software"
slug: "mobile-marketing"
---

# 📂 Category: Mobile Marketing Software

> G2 Software Category: Mobile Marketing Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Mobile Marketing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Mobile Marketing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Mobile Marketing Software")
SORT osi_score DESC
```