...
# 📂 Category: MEP Software

> G2 Software Category: MEP Software within CAD & PLM.
...
FROM "02 Products"
WHERE contains(category, "MEP Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "MEP Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "MEP Software")
SORT osi_score DESC
```