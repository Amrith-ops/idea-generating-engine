---
type: category
name: "Corporate Wellness Software"
slug: "corporate-wellness"
---

# 📂 Category: Corporate Wellness Software

> G2 Software Category: Corporate Wellness Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Corporate Wellness Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Corporate Wellness Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Corporate Wellness Software")
SORT osi_score DESC
```