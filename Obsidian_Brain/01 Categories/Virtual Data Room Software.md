---
type: category
name: "Virtual Data Room Software"
slug: "virtual-data-room-vdr"
---

# 📂 Category: Virtual Data Room Software

> G2 Software Category: Virtual Data Room Software within Content Management.
...
FROM "02 Products"
WHERE contains(category, "Virtual Data Room Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Virtual Data Room Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Virtual Data Room Software")
SORT osi_score DESC
```