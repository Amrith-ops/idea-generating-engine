---
type: category
name: "Secure Code Review Software"
slug: "secure-code-review"
---

# 📂 Category: Secure Code Review Software

> G2 Software Category: Secure Code Review Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Secure Code Review Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Secure Code Review Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Secure Code Review Software")
SORT osi_score DESC
```