---
type: category
name: "Takeoff Software"
slug: "takeoff"
---

# 📂 Category: Takeoff Software

> G2 Software Category: Takeoff Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Takeoff Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Takeoff Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Takeoff Software")
SORT osi_score DESC
```