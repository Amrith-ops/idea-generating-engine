...
# 📂 Category: Print Management Solutions

> G2 Software Category: Print Management Solutions within Office Management Software.
...
FROM "02 Products"
WHERE contains(category, "Print Management Solutions") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Print Management Solutions") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Print Management Solutions")
SORT osi_score DESC
```