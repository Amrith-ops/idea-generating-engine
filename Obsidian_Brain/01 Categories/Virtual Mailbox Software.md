---
type: category
name: "Virtual Mailbox Software"
slug: "virtual-mailbox"
---

# 📂 Category: Virtual Mailbox Software

> G2 Software Category: Virtual Mailbox Software within Office Management Software.
...
FROM "02 Products"
WHERE contains(category, "Virtual Mailbox Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Virtual Mailbox Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Virtual Mailbox Software")
SORT osi_score DESC
```