---
type: category
name: "Data Masking Software"
slug: "data-masking"
---

# 📂 Category: Data Masking Software

> G2 Software Category: Data Masking Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Data Masking Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Masking Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Masking Software")
SORT osi_score DESC
```