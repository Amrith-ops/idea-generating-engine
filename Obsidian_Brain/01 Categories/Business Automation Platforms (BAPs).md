---
type: category
name: "Business Automation Platforms (BAPs)"
slug: "business-automation-platforms-baps"
---

# 📂 Category: Business Automation Platforms (BAPs)

> G2 Software Category: Business Automation Platforms (BAPs) within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Business Automation Platforms (BAPs)") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Business Automation Platforms (BAPs)") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Business Automation Platforms (BAPs)")
SORT osi_score DESC
```