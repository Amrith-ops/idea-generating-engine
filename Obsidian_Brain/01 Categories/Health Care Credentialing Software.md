---
type: category
name: "Health Care Credentialing Software"
slug: "health-care-credentialing"
---

# 📂 Category: Health Care Credentialing Software

> G2 Software Category: Health Care Credentialing Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Health Care Credentialing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Health Care Credentialing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Health Care Credentialing Software")
SORT osi_score DESC
```