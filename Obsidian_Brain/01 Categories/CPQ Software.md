...
# 📂 Category: CPQ Software

> G2 Software Category: CPQ Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "CPQ Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "CPQ Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "CPQ Software")
SORT osi_score DESC
```