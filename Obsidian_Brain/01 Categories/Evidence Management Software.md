---
type: category
name: "Evidence Management Software"
slug: "evidence-management"
---

# 📂 Category: Evidence Management Software

> G2 Software Category: Evidence Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Evidence Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Evidence Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Evidence Management Software")
SORT osi_score DESC
```