...
> G2 Software Category: Contract Management Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Contract Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Contract Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Contract Management Software")
SORT osi_score DESC
```