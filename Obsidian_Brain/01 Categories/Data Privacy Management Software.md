---
type: category
name: "Data Privacy Management Software"
slug: "data-privacy-management"
---

# 📂 Category: Data Privacy Management Software

> G2 Software Category: Data Privacy Management Software within Data Privacy.
...
FROM "02 Products"
WHERE contains(category, "Data Privacy Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Privacy Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Privacy Management Software")
SORT osi_score DESC
```