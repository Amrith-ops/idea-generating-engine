---
type: category
name: "Transactional Email Software"
slug: "transactional-email"
---

# 📂 Category: Transactional Email Software

> G2 Software Category: Transactional Email Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Transactional Email Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Transactional Email Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Transactional Email Software")
SORT osi_score DESC
```