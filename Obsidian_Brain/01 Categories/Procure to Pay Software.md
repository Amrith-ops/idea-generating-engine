---
type: category
name: "Procure to Pay Software"
slug: "procure-to-pay"
---

# 📂 Category: Procure to Pay Software

> G2 Software Category: Procure to Pay Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Procure to Pay Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Procure to Pay Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Procure to Pay Software")
SORT osi_score DESC
```