...
slug: "ucaas-platforms"
---

# 📂 Category: UCaaS Platforms

> G2 Software Category: UCaaS Platforms within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "UCaaS Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "UCaaS Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "UCaaS Platforms")
SORT osi_score DESC
```