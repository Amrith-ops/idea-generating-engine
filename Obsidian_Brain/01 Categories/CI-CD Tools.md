...
> G2 Software Category: CI/CD Tools within Development.
...
FROM "02 Products"
WHERE contains(category, "CI/CD Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "CI/CD Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "CI/CD Tools")
SORT osi_score DESC
```