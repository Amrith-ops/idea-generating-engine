---
type: category
name: "Identity and Access Management (IAM) Software"
slug: "identity-and-access-management-iam"
---

# 📂 Category: Identity and Access Management (IAM) Software

> G2 Software Category: Identity and Access Management (IAM) Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Identity and Access Management (IAM) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Identity and Access Management (IAM) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Identity and Access Management (IAM) Software")
SORT osi_score DESC
```