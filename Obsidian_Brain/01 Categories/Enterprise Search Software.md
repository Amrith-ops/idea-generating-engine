...
slug: "enterprise-search-software"
---

# 📂 Category: Enterprise Search Software

> G2 Software Category: Enterprise Search Software within Analytics Tools & Software.
...
FROM "02 Products"
WHERE contains(category, "Enterprise Search Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Enterprise Search Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Enterprise Search Software")
SORT osi_score DESC
```