...
> G2 Software Category: Customer Success Software within Customer Service.
...
FROM "02 Products"
WHERE contains(category, "Customer Success Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Customer Success Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Customer Success Software")
SORT osi_score DESC
```