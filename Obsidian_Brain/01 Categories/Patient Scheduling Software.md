---
type: category
name: "Patient Scheduling Software"
slug: "patient-scheduling"
---

# 📂 Category: Patient Scheduling Software

> G2 Software Category: Patient Scheduling Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Patient Scheduling Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Patient Scheduling Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Patient Scheduling Software")
SORT osi_score DESC
```