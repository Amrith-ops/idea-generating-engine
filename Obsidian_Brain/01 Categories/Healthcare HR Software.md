---
type: category
name: "Healthcare HR Software"
slug: "healthcare-hr"
---

# 📂 Category: Healthcare HR Software

> G2 Software Category: Healthcare HR Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Healthcare HR Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Healthcare HR Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Healthcare HR Software")
SORT osi_score DESC
```