---
type: category
name: "Other Supply & Logistics Software"
slug: "other-supply-logistics"
---

# 📂 Category: Other Supply & Logistics Software

> G2 Software Category: Other Supply & Logistics Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Other Supply & Logistics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Supply & Logistics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Supply & Logistics Software")
SORT osi_score DESC
```