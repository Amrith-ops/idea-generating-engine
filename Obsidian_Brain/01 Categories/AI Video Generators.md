...
> G2 Software Category: AI Video Generators within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "AI Video Generators") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI Video Generators") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI Video Generators")
SORT osi_score DESC
```