---
type: category
name: "Push Notification Software"
slug: "push-notification"
---

# 📂 Category: Push Notification Software

> G2 Software Category: Push Notification Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Push Notification Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Push Notification Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Push Notification Software")
SORT osi_score DESC
```