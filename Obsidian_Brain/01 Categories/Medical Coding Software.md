...
# 📂 Category: Medical Coding Software

> G2 Software Category: Medical Coding Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Medical Coding Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Medical Coding Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Medical Coding Software")
SORT osi_score DESC
```