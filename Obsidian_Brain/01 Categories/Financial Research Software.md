---
type: category
name: "Financial Research Software"
slug: "financial-research"
---

# 📂 Category: Financial Research Software

> G2 Software Category: Financial Research Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Financial Research Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Financial Research Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Financial Research Software")
SORT osi_score DESC
```