...
# 📂 Category: Digital Twin Software

> G2 Software Category: Digital Twin Software within IoT Management.
...
FROM "02 Products"
WHERE contains(category, "Digital Twin Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Digital Twin Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Digital Twin Software")
SORT osi_score DESC
```