...
> G2 Software Category: Survey Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Survey Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Survey Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Survey Software")
SORT osi_score DESC
```