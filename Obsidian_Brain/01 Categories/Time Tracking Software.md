...
> G2 Software Category: Time Tracking Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Time Tracking Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Time Tracking Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Time Tracking Software")
SORT osi_score DESC
```