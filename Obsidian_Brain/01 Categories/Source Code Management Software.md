---
type: category
name: "Source Code Management Software"
slug: "source-code-management"
---

# 📂 Category: Source Code Management Software

> G2 Software Category: Source Code Management Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Source Code Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Source Code Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Source Code Management Software")
SORT osi_score DESC
```