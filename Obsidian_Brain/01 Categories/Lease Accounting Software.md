---
type: category
name: "Lease Accounting Software"
slug: "lease-accounting"
---

# 📂 Category: Lease Accounting Software

> G2 Software Category: Lease Accounting Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Lease Accounting Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Lease Accounting Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Lease Accounting Software")
SORT osi_score DESC
```