...
slug: "virtual-event-platforms"
---

# 📂 Category: Virtual Event Platforms

> G2 Software Category: Virtual Event Platforms within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Virtual Event Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Virtual Event Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Virtual Event Platforms")
SORT osi_score DESC
```