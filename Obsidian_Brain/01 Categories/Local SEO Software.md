...
> G2 Software Category: Local SEO Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Local SEO Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Local SEO Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Local SEO Software")
SORT osi_score DESC
```