...
> G2 Software Category: Dental Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Dental Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Dental Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Dental Software")
SORT osi_score DESC
```