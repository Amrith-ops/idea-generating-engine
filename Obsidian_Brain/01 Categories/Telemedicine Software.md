...
> G2 Software Category: Telemedicine Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Telemedicine Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Telemedicine Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Telemedicine Software")
SORT osi_score DESC
```