...
type: category
name: "AIOps Tools"
slug: "aiops-platforms"
---

# 📂 Category: AIOps Tools

> G2 Software Category: AIOps Tools within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "AIOps Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AIOps Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AIOps Tools")
SORT osi_score DESC
```