---
type: category
name: "Other Nonprofit Software"
slug: "other-nonprofit"
---

# 📂 Category: Other Nonprofit Software

> G2 Software Category: Other Nonprofit Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Nonprofit Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Nonprofit Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Nonprofit Software")
SORT osi_score DESC
```