---
type: category
name: "WAN Edge Infrastructure Software"
slug: "wan-edge-infrastructure"
---

# 📂 Category: WAN Edge Infrastructure Software

> G2 Software Category: WAN Edge Infrastructure Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "WAN Edge Infrastructure Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "WAN Edge Infrastructure Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "WAN Edge Infrastructure Software")
SORT osi_score DESC
```