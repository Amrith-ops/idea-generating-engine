...
> G2 Software Category: Internal Developer Platforms within Development.
...
FROM "02 Products"
WHERE contains(category, "Internal Developer Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Internal Developer Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Internal Developer Platforms")
SORT osi_score DESC
```