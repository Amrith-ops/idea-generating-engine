---
type: category
name: "Emotion AI Software"
slug: "emotion-ai"
---

# 📂 Category: Emotion AI Software

> G2 Software Category: Emotion AI Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Emotion AI Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Emotion AI Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Emotion AI Software")
SORT osi_score DESC
```