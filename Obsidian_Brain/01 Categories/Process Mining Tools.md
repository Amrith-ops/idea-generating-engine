...
slug: "process-mining-tools"
---

# 📂 Category: Process Mining Tools

> G2 Software Category: Process Mining Tools within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Process Mining Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Process Mining Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Process Mining Tools")
SORT osi_score DESC
```