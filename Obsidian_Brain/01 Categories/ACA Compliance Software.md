---
type: category
name: "ACA Compliance Software"
slug: "aca-compliance"
---

# 📂 Category: ACA Compliance Software

> G2 Software Category: ACA Compliance Software within HR.
...
FROM "02 Products"
WHERE contains(category, "ACA Compliance Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "ACA Compliance Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "ACA Compliance Software")
SORT osi_score DESC
```