---
type: category
name: "Big Data Integration Platforms"
slug: "big-data-integration-platforms"
---

# 📂 Category: Big Data Integration Platforms

> G2 Software Category: Big Data Integration Platforms within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Big Data Integration Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Big Data Integration Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Big Data Integration Platforms")
SORT osi_score DESC
```