---
type: category
name: "SAP Security Software"
slug: "sap-security-software"
---

# 📂 Category: SAP Security Software

> G2 Software Category: SAP Security Software within Security.
...
FROM "02 Products"
WHERE contains(category, "SAP Security Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "SAP Security Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "SAP Security Software")
SORT osi_score DESC
```