...
> G2 Software Category: API Management Tools within Development.
...
FROM "02 Products"
WHERE contains(category, "API Management Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "API Management Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "API Management Tools")
SORT osi_score DESC
```