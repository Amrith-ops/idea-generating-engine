...
> G2 Software Category: Mobile Development Frameworks within Development.
...
FROM "02 Products"
WHERE contains(category, "Mobile Development Frameworks") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Mobile Development Frameworks") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Mobile Development Frameworks")
SORT osi_score DESC
```