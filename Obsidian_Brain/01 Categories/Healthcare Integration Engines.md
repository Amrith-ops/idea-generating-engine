---
type: category
name: "Healthcare Integration Engines"
slug: "healthcare-integration-engines"
---

# 📂 Category: Healthcare Integration Engines

> G2 Software Category: Healthcare Integration Engines within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Healthcare Integration Engines") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Healthcare Integration Engines") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Healthcare Integration Engines")
SORT osi_score DESC
```