---
type: category
name: "Jewelry Store Management Software"
slug: "jewelry-store-management"
---

# 📂 Category: Jewelry Store Management Software

> G2 Software Category: Jewelry Store Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Jewelry Store Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Jewelry Store Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Jewelry Store Management Software")
SORT osi_score DESC
```