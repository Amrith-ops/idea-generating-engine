...
> G2 Software Category: Network Security Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Network Security Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Network Security Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Network Security Software")
SORT osi_score DESC
```