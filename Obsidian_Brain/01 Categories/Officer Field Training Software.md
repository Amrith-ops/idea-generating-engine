---
type: category
name: "Officer Field Training Software"
slug: "officer-field-training"
---

# 📂 Category: Officer Field Training Software

> G2 Software Category: Officer Field Training Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Officer Field Training Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Officer Field Training Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Officer Field Training Software")
SORT osi_score DESC
```