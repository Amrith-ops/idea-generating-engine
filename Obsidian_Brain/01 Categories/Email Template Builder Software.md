---
type: category
name: "Email Template Builder Software"
slug: "email-template-builder"
---

# 📂 Category: Email Template Builder Software

> G2 Software Category: Email Template Builder Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Email Template Builder Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Email Template Builder Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Email Template Builder Software")
SORT osi_score DESC
```