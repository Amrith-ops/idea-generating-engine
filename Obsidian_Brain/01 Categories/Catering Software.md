---
type: category
name: "Catering Software"
slug: "catering"
---

# 📂 Category: Catering Software

> G2 Software Category: Catering Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Catering Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Catering Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Catering Software")
SORT osi_score DESC
```