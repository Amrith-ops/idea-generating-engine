---
type: category
name: "Smart Buildings Software"
slug: "smart-buildings"
---

# 📂 Category: Smart Buildings Software

> G2 Software Category: Smart Buildings Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Smart Buildings Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Smart Buildings Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Smart Buildings Software")
SORT osi_score DESC
```