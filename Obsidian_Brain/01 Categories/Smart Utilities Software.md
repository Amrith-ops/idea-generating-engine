---
type: category
name: "Smart Utilities Software"
slug: "smart-utilities"
---

# 📂 Category: Smart Utilities Software

> G2 Software Category: Smart Utilities Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Smart Utilities Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Smart Utilities Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Smart Utilities Software")
SORT osi_score DESC
```