---
type: category
name: "IoT Edge Platforms"
slug: "iot-edge-platforms"
---

# 📂 Category: IoT Edge Platforms

> G2 Software Category: IoT Edge Platforms within IoT Management.
...
FROM "02 Products"
WHERE contains(category, "IoT Edge Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "IoT Edge Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "IoT Edge Platforms")
SORT osi_score DESC
```