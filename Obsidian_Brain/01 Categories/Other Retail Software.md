---
type: category
name: "Other Retail Software"
slug: "other-retail"
---

# 📂 Category: Other Retail Software

> G2 Software Category: Other Retail Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Other Retail Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Retail Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Retail Software")
SORT osi_score DESC
```