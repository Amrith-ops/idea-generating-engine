...
slug: "automation-testing-tools"
---

# 📂 Category: Automation Testing Tools

> G2 Software Category: Automation Testing Tools within Development.
...
FROM "02 Products"
WHERE contains(category, "Automation Testing Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Automation Testing Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Automation Testing Tools")
SORT osi_score DESC
```