---
type: category
name: "Gamification Software"
slug: "gamification"
---

# 📂 Category: Gamification Software

> G2 Software Category: Gamification Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Gamification Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Gamification Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Gamification Software")
SORT osi_score DESC
```