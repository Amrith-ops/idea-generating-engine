---
type: category
name: "Grocery Delivery Software"
slug: "grocery-delivery"
---

# 📂 Category: Grocery Delivery Software

> G2 Software Category: Grocery Delivery Software within B2B Marketplaces.
...
FROM "02 Products"
WHERE contains(category, "Grocery Delivery Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Grocery Delivery Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Grocery Delivery Software")
SORT osi_score DESC
```