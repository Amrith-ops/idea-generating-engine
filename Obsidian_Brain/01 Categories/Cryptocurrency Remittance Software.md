---
type: category
name: "Cryptocurrency Remittance Software"
slug: "cryptocurrency-remittance"
---

# 📂 Category: Cryptocurrency Remittance Software

> G2 Software Category: Cryptocurrency Remittance Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Cryptocurrency Remittance Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cryptocurrency Remittance Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cryptocurrency Remittance Software")
SORT osi_score DESC
```