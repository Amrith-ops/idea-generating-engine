---
type: category
name: "Sales Tax and VAT Compliance Software"
slug: "sales-tax-and-vat-compliance"
---

# 📂 Category: Sales Tax and VAT Compliance Software

> G2 Software Category: Sales Tax and VAT Compliance Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Sales Tax and VAT Compliance Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Sales Tax and VAT Compliance Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Sales Tax and VAT Compliance Software")
SORT osi_score DESC
```