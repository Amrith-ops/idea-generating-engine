---
type: category
name: "Confidentiality Software"
slug: "confidentiality"
---

# 📂 Category: Confidentiality Software

> G2 Software Category: Confidentiality Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Confidentiality Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Confidentiality Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Confidentiality Software")
SORT osi_score DESC
```