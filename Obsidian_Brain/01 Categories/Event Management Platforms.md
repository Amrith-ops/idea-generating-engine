---
type: category
name: "Event Management Platforms"
slug: "event-management-platforms"
---

# 📂 Category: Event Management Platforms

> G2 Software Category: Event Management Platforms within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Event Management Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Event Management Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Event Management Platforms")
SORT osi_score DESC
```