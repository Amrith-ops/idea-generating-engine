...
slug: "foodservice-distribution"
---

# 📂 Category: Foodservice Distribution Software

> G2 Software Category: Foodservice Distribution Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Foodservice Distribution Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Foodservice Distribution Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Foodservice Distribution Software")
SORT osi_score DESC
```