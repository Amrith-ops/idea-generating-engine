...
# 📂 Category: Board Management Software

> G2 Software Category: Board Management Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Board Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Board Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Board Management Software")
SORT osi_score DESC
```