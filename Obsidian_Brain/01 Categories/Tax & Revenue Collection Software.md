---
type: category
name: "Tax & Revenue Collection Software"
slug: "tax-revenue-collection"
---

# 📂 Category: Tax & Revenue Collection Software

> G2 Software Category: Tax & Revenue Collection Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Tax & Revenue Collection Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Tax & Revenue Collection Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Tax & Revenue Collection Software")
SORT osi_score DESC
```