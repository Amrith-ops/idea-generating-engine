---
type: category
name: "Brand Advocacy Software"
slug: "brand-advocacy"
---

# 📂 Category: Brand Advocacy Software

> G2 Software Category: Brand Advocacy Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Brand Advocacy Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Brand Advocacy Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Brand Advocacy Software")
SORT osi_score DESC
```