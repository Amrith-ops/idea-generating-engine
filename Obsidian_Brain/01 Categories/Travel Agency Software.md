...
# 📂 Category: Travel Agency Software

> G2 Software Category: Travel Agency Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Travel Agency Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Travel Agency Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Travel Agency Software")
SORT osi_score DESC
```