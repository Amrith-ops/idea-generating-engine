...
> G2 Software Category: Retail POS Systems within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Retail POS Systems") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Retail POS Systems") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Retail POS Systems")
SORT osi_score DESC
```