---
type: category
name: "Geofencing Software"
slug: "geofencing"
---

# 📂 Category: Geofencing Software

> G2 Software Category: Geofencing Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Geofencing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Geofencing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Geofencing Software")
SORT osi_score DESC
```