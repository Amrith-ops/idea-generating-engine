---
type: category
name: "Travel Arrangement Software"
slug: "travel-arrangement"
---

# 📂 Category: Travel Arrangement Software

> G2 Software Category: Travel Arrangement Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Travel Arrangement Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Travel Arrangement Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Travel Arrangement Software")
SORT osi_score DESC
```