---
type: category
name: "Merchant Marketing Software"
slug: "merchant-marketing"
---

# 📂 Category: Merchant Marketing Software

> G2 Software Category: Merchant Marketing Software within B2B Marketplaces.
...
FROM "02 Products"
WHERE contains(category, "Merchant Marketing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Merchant Marketing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Merchant Marketing Software")
SORT osi_score DESC
```