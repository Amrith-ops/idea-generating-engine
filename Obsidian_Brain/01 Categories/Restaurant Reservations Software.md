---
type: category
name: "Restaurant Reservations Software"
slug: "restaurant-reservations"
---

# 📂 Category: Restaurant Reservations Software

> G2 Software Category: Restaurant Reservations Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Restaurant Reservations Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Restaurant Reservations Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Restaurant Reservations Software")
SORT osi_score DESC
```