---
type: category
name: "E-Commerce Personalization Software"
slug: "e-commerce-personalization"
---

# 📂 Category: E-Commerce Personalization Software

> G2 Software Category: E-Commerce Personalization Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "E-Commerce Personalization Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "E-Commerce Personalization Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "E-Commerce Personalization Software")
SORT osi_score DESC
```