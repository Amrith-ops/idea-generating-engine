---
type: category
name: "Browser Isolation Software"
slug: "browser-isolation"
---

# 📂 Category: Browser Isolation Software

> G2 Software Category: Browser Isolation Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Browser Isolation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Browser Isolation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Browser Isolation Software")
SORT osi_score DESC
```