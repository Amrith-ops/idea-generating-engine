---
type: category
name: "Partner Relationship Management (PRM) Software"
slug: "partner-relationship-management-prm"
---

# 📂 Category: Partner Relationship Management (PRM) Software

> G2 Software Category: Partner Relationship Management (PRM) Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Partner Relationship Management (PRM) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Partner Relationship Management (PRM) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Partner Relationship Management (PRM) Software")
SORT osi_score DESC
```