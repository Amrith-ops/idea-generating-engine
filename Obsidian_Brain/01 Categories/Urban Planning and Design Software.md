---
type: category
name: "Urban Planning and Design Software"
slug: "urban-planning-and-design"
---

# 📂 Category: Urban Planning and Design Software

> G2 Software Category: Urban Planning and Design Software within CAD & PLM.
...
FROM "02 Products"
WHERE contains(category, "Urban Planning and Design Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Urban Planning and Design Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Urban Planning and Design Software")
SORT osi_score DESC
```