...
# 📂 Category: Lead Scoring Software

> G2 Software Category: Lead Scoring Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Lead Scoring Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Lead Scoring Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Lead Scoring Software")
SORT osi_score DESC
```