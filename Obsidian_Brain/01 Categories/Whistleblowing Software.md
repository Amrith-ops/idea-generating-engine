...
# 📂 Category: Whistleblowing Software

> G2 Software Category: Whistleblowing Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Whistleblowing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Whistleblowing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Whistleblowing Software")
SORT osi_score DESC
```