---
type: category
name: "Dedicated Hosting Platforms"
slug: "dedicated-hosting"
---

# 📂 Category: Dedicated Hosting Platforms

> G2 Software Category: Dedicated Hosting Platforms within Hosting.
...
FROM "02 Products"
WHERE contains(category, "Dedicated Hosting Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Dedicated Hosting Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Dedicated Hosting Platforms")
SORT osi_score DESC
```