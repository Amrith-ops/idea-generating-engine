---
type: category
name: "eLearning Content Software"
slug: "elearning-content"
---

# 📂 Category: eLearning Content Software

> G2 Software Category: eLearning Content Software within HR.
...
FROM "02 Products"
WHERE contains(category, "eLearning Content Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "eLearning Content Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "eLearning Content Software")
SORT osi_score DESC
```