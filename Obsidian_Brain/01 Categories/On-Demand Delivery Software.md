---
type: category
name: "On-Demand Delivery Software"
slug: "on-demand-delivery"
---

# 📂 Category: On-Demand Delivery Software

> G2 Software Category: On-Demand Delivery Software within B2B Marketplaces.
...
FROM "02 Products"
WHERE contains(category, "On-Demand Delivery Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "On-Demand Delivery Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "On-Demand Delivery Software")
SORT osi_score DESC
```