---
type: category
name: "Ambulatory Software"
slug: "ambulatory"
---

# 📂 Category: Ambulatory Software

> G2 Software Category: Ambulatory Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Ambulatory Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Ambulatory Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Ambulatory Software")
SORT osi_score DESC
```