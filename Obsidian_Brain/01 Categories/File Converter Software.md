---
type: category
name: "File Converter Software"
slug: "file-converter"
---

# 📂 Category: File Converter Software

> G2 Software Category: File Converter Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "File Converter Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "File Converter Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "File Converter Software")
SORT osi_score DESC
```