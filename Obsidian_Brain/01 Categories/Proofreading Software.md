---
type: category
name: "Proofreading Software"
slug: "proofreading"
---

# 📂 Category: Proofreading Software

> G2 Software Category: Proofreading Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Proofreading Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Proofreading Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Proofreading Software")
SORT osi_score DESC
```