...
> G2 Software Category: Retail Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Retail Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Retail Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Retail Software")
SORT osi_score DESC
```