---
type: category
name: "Insight Engines Software"
slug: "insight-engines"
---

# 📂 Category: Insight Engines Software

> G2 Software Category: Insight Engines Software within Analytics Tools & Software.
...
FROM "02 Products"
WHERE contains(category, "Insight Engines Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Insight Engines Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Insight Engines Software")
SORT osi_score DESC
```