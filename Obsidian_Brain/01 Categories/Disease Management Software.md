---
type: category
name: "Disease Management Software"
slug: "disease-management"
---

# 📂 Category: Disease Management Software

> G2 Software Category: Disease Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Disease Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Disease Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Disease Management Software")
SORT osi_score DESC
```