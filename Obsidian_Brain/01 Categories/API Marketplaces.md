...
> G2 Software Category: API Marketplaces within Development.
...
FROM "02 Products"
WHERE contains(category, "API Marketplaces") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "API Marketplaces") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "API Marketplaces")
SORT osi_score DESC
```