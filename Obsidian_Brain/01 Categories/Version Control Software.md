...
slug: "version-control-software"
---

# 📂 Category: Version Control Software

> G2 Software Category: Version Control Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Version Control Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Version Control Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Version Control Software")
SORT osi_score DESC
```