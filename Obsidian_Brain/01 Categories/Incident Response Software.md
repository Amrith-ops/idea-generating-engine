---
type: category
name: "Incident Response Software"
slug: "incident-response"
---

# 📂 Category: Incident Response Software

> G2 Software Category: Incident Response Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Incident Response Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Incident Response Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Incident Response Software")
SORT osi_score DESC
```