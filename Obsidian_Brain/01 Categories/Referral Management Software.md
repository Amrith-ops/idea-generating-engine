...
> G2 Software Category: Referral Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Referral Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Referral Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Referral Management Software")
SORT osi_score DESC
```