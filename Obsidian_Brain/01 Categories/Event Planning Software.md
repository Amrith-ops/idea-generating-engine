---
type: category
name: "Event Planning Software"
slug: "event-planning"
---

# 📂 Category: Event Planning Software

> G2 Software Category: Event Planning Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Event Planning Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Event Planning Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Event Planning Software")
SORT osi_score DESC
```