---
type: category
name: "RCS Business Messaging Software"
slug: "rcs-business-messaging"
---

# 📂 Category: RCS Business Messaging Software

> G2 Software Category: RCS Business Messaging Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "RCS Business Messaging Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "RCS Business Messaging Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "RCS Business Messaging Software")
SORT osi_score DESC
```