...
> G2 Software Category: Field Service Management Software within Customer Service.
...
FROM "02 Products"
WHERE contains(category, "Field Service Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Field Service Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Field Service Management Software")
SORT osi_score DESC
```