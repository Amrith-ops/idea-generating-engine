---
type: category
name: "Infrastructure as a Service (IaaS) Software"
slug: "infrastructure-as-a-service-iaas"
---

# 📂 Category: Infrastructure as a Service (IaaS) Software

> G2 Software Category: Infrastructure as a Service (IaaS) Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Infrastructure as a Service (IaaS) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Infrastructure as a Service (IaaS) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Infrastructure as a Service (IaaS) Software")
SORT osi_score DESC
```