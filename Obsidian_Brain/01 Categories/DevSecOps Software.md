---
type: category
name: "DevSecOps Software"
slug: "devsecops"
---

# 📂 Category: DevSecOps Software

> G2 Software Category: DevSecOps Software within Security.
...
FROM "02 Products"
WHERE contains(category, "DevSecOps Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "DevSecOps Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "DevSecOps Software")
SORT osi_score DESC
```