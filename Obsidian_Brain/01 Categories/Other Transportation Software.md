---
type: category
name: "Other Transportation Software"
slug: "other-transportation"
---

# 📂 Category: Other Transportation Software

> G2 Software Category: Other Transportation Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Transportation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Transportation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Transportation Software")
SORT osi_score DESC
```