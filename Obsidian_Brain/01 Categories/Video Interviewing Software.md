---
type: category
name: "Video Interviewing Software"
slug: "video-interviewing"
---

# 📂 Category: Video Interviewing Software

> G2 Software Category: Video Interviewing Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Video Interviewing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Video Interviewing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Video Interviewing Software")
SORT osi_score DESC
```