...
slug: "marketo-launchpoint-apps"
---

# 📂 Category: Marketo LaunchPoint Apps

> G2 Software Category: Marketo LaunchPoint Apps within Marketplace Apps.
...
FROM "02 Products"
WHERE contains(category, "Marketo LaunchPoint Apps") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Marketo LaunchPoint Apps") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Marketo LaunchPoint Apps")
SORT osi_score DESC
```