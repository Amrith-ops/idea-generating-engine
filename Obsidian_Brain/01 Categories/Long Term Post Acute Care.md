---
type: category
name: "Long Term Post Acute Care"
slug: "long-term-post-acute-care"
---

# 📂 Category: Long Term Post Acute Care

> G2 Software Category: Long Term Post Acute Care within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Long Term Post Acute Care") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Long Term Post Acute Care") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Long Term Post Acute Care")
SORT osi_score DESC
```