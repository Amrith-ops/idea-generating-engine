---
type: category
name: "AI Customer Support Agents Software"
slug: "ai-customer-support-agents"
---

# 📂 Category: AI Customer Support Agents Software

> G2 Software Category: AI Customer Support Agents Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "AI Customer Support Agents Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI Customer Support Agents Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI Customer Support Agents Software")
SORT osi_score DESC
```