---
type: category
name: "File Analysis Software"
slug: "file-analysis"
---

# 📂 Category: File Analysis Software

> G2 Software Category: File Analysis Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "File Analysis Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "File Analysis Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "File Analysis Software")
SORT osi_score DESC
```