---
type: category
name: "Social Media Analytics Software"
slug: "social-media-analytics"
---

# 📂 Category: Social Media Analytics Software

> G2 Software Category: Social Media Analytics Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Social Media Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Social Media Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Social Media Analytics Software")
SORT osi_score DESC
```