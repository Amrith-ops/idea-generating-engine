...
# 📂 Category: Distribution Software

> G2 Software Category: Distribution Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Distribution Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Distribution Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Distribution Software")
SORT osi_score DESC
```