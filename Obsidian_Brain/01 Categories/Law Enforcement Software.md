---
type: category
name: "Law Enforcement Software"
slug: "law-enforcement"
---

# 📂 Category: Law Enforcement Software

> G2 Software Category: Law Enforcement Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Law Enforcement Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Law Enforcement Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Law Enforcement Software")
SORT osi_score DESC
```