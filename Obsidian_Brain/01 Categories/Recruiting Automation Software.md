---
type: category
name: "Recruiting Automation Software"
slug: "recruiting-automation"
---

# 📂 Category: Recruiting Automation Software

> G2 Software Category: Recruiting Automation Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Recruiting Automation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Recruiting Automation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Recruiting Automation Software")
SORT osi_score DESC
```