---
type: category
name: "E-Signature APIs Software"
slug: "e-signature-apis"
---

# 📂 Category: E-Signature APIs Software

> G2 Software Category: E-Signature APIs Software within Development.
...
FROM "02 Products"
WHERE contains(category, "E-Signature APIs Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "E-Signature APIs Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "E-Signature APIs Software")
SORT osi_score DESC
```