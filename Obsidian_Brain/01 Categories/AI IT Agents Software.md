---
type: category
name: "AI IT Agents Software"
slug: "ai-it-agents"
---

# 📂 Category: AI IT Agents Software

> G2 Software Category: AI IT Agents Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "AI IT Agents Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI IT Agents Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI IT Agents Software")
SORT osi_score DESC
```