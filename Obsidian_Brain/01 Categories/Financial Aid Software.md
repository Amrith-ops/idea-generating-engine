---
type: category
name: "Financial Aid Software"
slug: "financial-aid-software"
---

# 📂 Category: Financial Aid Software

> G2 Software Category: Financial Aid Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Financial Aid Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Financial Aid Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Financial Aid Software")
SORT osi_score DESC
```