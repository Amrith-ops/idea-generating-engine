---
type: category
name: "Legal Hold Software"
slug: "legal-hold"
---

# 📂 Category: Legal Hold Software

> G2 Software Category: Legal Hold Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Legal Hold Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Legal Hold Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Legal Hold Software")
SORT osi_score DESC
```