---
type: category
name: "Health Care Software"
slug: "health-care"
---

# 📂 Category: Health Care Software

> G2 Software Category: Health Care Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Health Care Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Health Care Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Health Care Software")
SORT osi_score DESC
```