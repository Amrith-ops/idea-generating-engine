---
type: category
name: "Product Analytics Software"
slug: "product-analytics"
---

# 📂 Category: Product Analytics Software

> G2 Software Category: Product Analytics Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Product Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Product Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Product Analytics Software")
SORT osi_score DESC
```