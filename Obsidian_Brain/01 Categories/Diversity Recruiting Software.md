---
type: category
name: "Diversity Recruiting Software"
slug: "diversity-recruiting"
---

# 📂 Category: Diversity Recruiting Software

> G2 Software Category: Diversity Recruiting Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Diversity Recruiting Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Diversity Recruiting Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Diversity Recruiting Software")
SORT osi_score DESC
```