---
type: category
name: "Investor Reporting Software"
slug: "investor-reporting"
---

# 📂 Category: Investor Reporting Software

> G2 Software Category: Investor Reporting Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Investor Reporting Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Investor Reporting Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Investor Reporting Software")
SORT osi_score DESC
```