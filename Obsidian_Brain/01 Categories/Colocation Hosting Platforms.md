---
type: category
name: "Colocation Hosting Platforms"
slug: "colocation-hosting"
---

# 📂 Category: Colocation Hosting Platforms

> G2 Software Category: Colocation Hosting Platforms within Hosting.
...
FROM "02 Products"
WHERE contains(category, "Colocation Hosting Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Colocation Hosting Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Colocation Hosting Platforms")
SORT osi_score DESC
```