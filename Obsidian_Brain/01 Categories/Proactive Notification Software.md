---
type: category
name: "Proactive Notification Software"
slug: "proactive-notification"
---

# 📂 Category: Proactive Notification Software

> G2 Software Category: Proactive Notification Software within Customer Service.
...
FROM "02 Products"
WHERE contains(category, "Proactive Notification Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Proactive Notification Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Proactive Notification Software")
SORT osi_score DESC
```