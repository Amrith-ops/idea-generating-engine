---
type: category
name: "OT Security Tools Software"
slug: "ot-security-tools"
---

# 📂 Category: OT Security Tools Software

> G2 Software Category: OT Security Tools Software within Security.
...
FROM "02 Products"
WHERE contains(category, "OT Security Tools Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "OT Security Tools Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "OT Security Tools Software")
SORT osi_score DESC
```