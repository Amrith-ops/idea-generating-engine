...
# 📂 Category: Employee Recognition Software

> G2 Software Category: Employee Recognition Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Employee Recognition Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Employee Recognition Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Employee Recognition Software")
SORT osi_score DESC
```