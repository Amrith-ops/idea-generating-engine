---
type: category
name: "Log Analysis Software"
slug: "log-analysis"
---

# 📂 Category: Log Analysis Software

> G2 Software Category: Log Analysis Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Log Analysis Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Log Analysis Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Log Analysis Software")
SORT osi_score DESC
```