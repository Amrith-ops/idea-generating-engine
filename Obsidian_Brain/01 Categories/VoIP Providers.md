...
> G2 Software Category: VoIP Providers within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "VoIP Providers") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "VoIP Providers") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "VoIP Providers")
SORT osi_score DESC
```