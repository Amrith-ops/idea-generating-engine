...
> G2 Software Category: Sales Analytics Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Sales Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Sales Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Sales Analytics Software")
SORT osi_score DESC
```