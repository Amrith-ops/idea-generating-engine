---
type: category
name: "Retail Execution Software"
slug: "retail-execution"
---

# 📂 Category: Retail Execution Software

> G2 Software Category: Retail Execution Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Retail Execution Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Retail Execution Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Retail Execution Software")
SORT osi_score DESC
```