---
type: category
name: "Reseller Hosting Platforms"
slug: "reseller-hosting"
---

# 📂 Category: Reseller Hosting Platforms

> G2 Software Category: Reseller Hosting Platforms within Hosting.
...
FROM "02 Products"
WHERE contains(category, "Reseller Hosting Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Reseller Hosting Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Reseller Hosting Platforms")
SORT osi_score DESC
```