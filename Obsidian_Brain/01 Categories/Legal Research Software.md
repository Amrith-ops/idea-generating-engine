---
type: category
name: "Legal Research Software"
slug: "legal-research"
---

# 📂 Category: Legal Research Software

> G2 Software Category: Legal Research Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Legal Research Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Legal Research Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Legal Research Software")
SORT osi_score DESC
```