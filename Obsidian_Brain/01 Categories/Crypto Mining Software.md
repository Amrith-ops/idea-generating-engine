...
# 📂 Category: Crypto Mining Software

> G2 Software Category: Crypto Mining Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Crypto Mining Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Crypto Mining Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Crypto Mining Software")
SORT osi_score DESC
```