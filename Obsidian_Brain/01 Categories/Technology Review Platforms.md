---
type: category
name: "Technology Review Platforms"
slug: "technology-review-platforms"
---

# 📂 Category: Technology Review Platforms

> G2 Software Category: Technology Review Platforms within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Technology Review Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Technology Review Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Technology Review Platforms")
SORT osi_score DESC
```