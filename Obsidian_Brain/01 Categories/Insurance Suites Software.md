---
type: category
name: "Insurance Suites Software"
slug: "insurance-suites"
---

# 📂 Category: Insurance Suites Software

> G2 Software Category: Insurance Suites Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Insurance Suites Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Insurance Suites Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Insurance Suites Software")
SORT osi_score DESC
```