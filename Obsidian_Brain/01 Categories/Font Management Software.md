---
type: category
name: "Font Management Software"
slug: "font-management"
---

# 📂 Category: Font Management Software

> G2 Software Category: Font Management Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Font Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Font Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Font Management Software")
SORT osi_score DESC
```