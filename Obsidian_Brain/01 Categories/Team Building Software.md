---
type: category
name: "Team Building Software"
slug: "team-building"
---

# 📂 Category: Team Building Software

> G2 Software Category: Team Building Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Team Building Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Team Building Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Team Building Software")
SORT osi_score DESC
```