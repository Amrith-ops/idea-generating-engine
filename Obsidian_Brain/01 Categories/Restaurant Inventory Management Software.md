...
# 📂 Category: Restaurant Inventory Management Software

> G2 Software Category: Restaurant Inventory Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Restaurant Inventory Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Restaurant Inventory Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Restaurant Inventory Management Software")
SORT osi_score DESC
```