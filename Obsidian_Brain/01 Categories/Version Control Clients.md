---
type: category
name: "Version Control Clients"
slug: "version-control-clients"
---

# 📂 Category: Version Control Clients

> G2 Software Category: Version Control Clients within Development.
...
FROM "02 Products"
WHERE contains(category, "Version Control Clients") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Version Control Clients") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Version Control Clients")
SORT osi_score DESC
```