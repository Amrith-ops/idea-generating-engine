...
> G2 Software Category: Decision-Making Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Decision-Making Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Decision-Making Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Decision-Making Software")
SORT osi_score DESC
```