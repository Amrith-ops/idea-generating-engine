...
> G2 Software Category: 3D Rendering Software within Design.
...
FROM "02 Products"
WHERE contains(category, "3D Rendering Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "3D Rendering Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "3D Rendering Software")
SORT osi_score DESC
```