---
type: category
name: "Package Tracking Software"
slug: "package-tracking"
---

# 📂 Category: Package Tracking Software

> G2 Software Category: Package Tracking Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Package Tracking Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Package Tracking Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Package Tracking Software")
SORT osi_score DESC
```