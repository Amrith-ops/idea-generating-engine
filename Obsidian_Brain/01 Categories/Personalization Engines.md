...
# 📂 Category: Personalization Engines

> G2 Software Category: Personalization Engines within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Personalization Engines") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Personalization Engines") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Personalization Engines")
SORT osi_score DESC
```