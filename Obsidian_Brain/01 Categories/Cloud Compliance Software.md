---
type: category
name: "Cloud Compliance Software"
slug: "cloud-compliance"
---

# 📂 Category: Cloud Compliance Software

> G2 Software Category: Cloud Compliance Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Cloud Compliance Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cloud Compliance Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cloud Compliance Software")
SORT osi_score DESC
```