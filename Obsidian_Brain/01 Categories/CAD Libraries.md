...
# 📂 Category: CAD Libraries

> G2 Software Category: CAD Libraries within CAD & PLM.
...
FROM "02 Products"
WHERE contains(category, "CAD Libraries") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "CAD Libraries") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "CAD Libraries")
SORT osi_score DESC
```