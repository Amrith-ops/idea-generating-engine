...
> G2 Software Category: Wireframing Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Wireframing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Wireframing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Wireframing Software")
SORT osi_score DESC
```