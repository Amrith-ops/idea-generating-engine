---
type: category
name: "Real Estate License School Software"
slug: "real-estate-license-school"
---

# 📂 Category: Real Estate License School Software

> G2 Software Category: Real Estate License School Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Real Estate License School Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Real Estate License School Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Real Estate License School Software")
SORT osi_score DESC
```