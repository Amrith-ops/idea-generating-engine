...
> G2 Software Category: Billing Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Billing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Billing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Billing Software")
SORT osi_score DESC
```