---
type: category
name: "Lead Capture Software"
slug: "lead-capture"
---

# 📂 Category: Lead Capture Software

> G2 Software Category: Lead Capture Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Lead Capture Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Lead Capture Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Lead Capture Software")
SORT osi_score DESC
```