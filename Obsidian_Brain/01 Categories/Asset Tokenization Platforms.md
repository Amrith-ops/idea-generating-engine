...
slug: "asset-tokenization-platforms"
---

# 📂 Category: Asset Tokenization Platforms

> G2 Software Category: Asset Tokenization Platforms within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Asset Tokenization Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Asset Tokenization Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Asset Tokenization Platforms")
SORT osi_score DESC
```