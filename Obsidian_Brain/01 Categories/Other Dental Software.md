---
type: category
name: "Other Dental Software"
slug: "other-dental"
---

# 📂 Category: Other Dental Software

> G2 Software Category: Other Dental Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Dental Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Dental Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Dental Software")
SORT osi_score DESC
```