...
> G2 Software Category: HVAC Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "HVAC Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "HVAC Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "HVAC Software")
SORT osi_score DESC
```