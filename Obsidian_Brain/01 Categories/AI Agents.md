...
> G2 Software Category: AI Agents within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "AI Agents") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI Agents") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI Agents")
SORT osi_score DESC
```