---
type: category
name: "AI Gateways Software"
slug: "ai-gateways"
---

# 📂 Category: AI Gateways Software

> G2 Software Category: AI Gateways Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "AI Gateways Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI Gateways Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI Gateways Software")
SORT osi_score DESC
```