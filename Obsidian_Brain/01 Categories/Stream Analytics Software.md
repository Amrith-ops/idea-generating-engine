---
type: category
name: "Stream Analytics Software"
slug: "stream-analytics"
---

# 📂 Category: Stream Analytics Software

> G2 Software Category: Stream Analytics Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Stream Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Stream Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Stream Analytics Software")
SORT osi_score DESC
```