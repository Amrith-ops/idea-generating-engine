---
type: category
name: "User Threat Prevention Software"
slug: "user-threat-prevention"
---

# 📂 Category: User Threat Prevention Software

> G2 Software Category: User Threat Prevention Software within Security.
...
FROM "02 Products"
WHERE contains(category, "User Threat Prevention Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "User Threat Prevention Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "User Threat Prevention Software")
SORT osi_score DESC
```