---
type: category
name: "Other Gym Software"
slug: "other-gym"
---

# 📂 Category: Other Gym Software

> G2 Software Category: Other Gym Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Gym Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Gym Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Gym Software")
SORT osi_score DESC
```