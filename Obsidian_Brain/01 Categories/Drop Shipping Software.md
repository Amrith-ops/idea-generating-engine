---
type: category
name: "Drop Shipping Software"
slug: "drop-shipping"
---

# 📂 Category: Drop Shipping Software

> G2 Software Category: Drop Shipping Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Drop Shipping Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Drop Shipping Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Drop Shipping Software")
SORT osi_score DESC
```