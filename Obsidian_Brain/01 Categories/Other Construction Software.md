---
type: category
name: "Other Construction Software"
slug: "other-construction"
---

# 📂 Category: Other Construction Software

> G2 Software Category: Other Construction Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Construction Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Construction Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Construction Software")
SORT osi_score DESC
```