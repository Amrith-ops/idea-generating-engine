...
> G2 Software Category: Fitness Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Fitness Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Fitness Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Fitness Software")
SORT osi_score DESC
```