...
# 📂 Category: Security Awareness Training Software

> G2 Software Category: Security Awareness Training Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Security Awareness Training Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Security Awareness Training Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Security Awareness Training Software")
SORT osi_score DESC
```