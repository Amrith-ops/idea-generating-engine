---
type: category
name: "Other Vertical Industry Software"
slug: "other-vertical-industry"
---

# 📂 Category: Other Vertical Industry Software

> G2 Software Category: Other Vertical Industry Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Vertical Industry Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Vertical Industry Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Vertical Industry Software")
SORT osi_score DESC
```