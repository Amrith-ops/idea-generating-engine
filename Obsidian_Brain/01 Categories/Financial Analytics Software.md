...
> G2 Software Category: Financial Analytics Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Financial Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Financial Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Financial Analytics Software")
SORT osi_score DESC
```