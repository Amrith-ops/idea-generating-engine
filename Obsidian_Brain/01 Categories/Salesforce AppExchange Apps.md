---
type: category
name: "Salesforce AppExchange Apps"
slug: "salesforce-appexchange-apps"
---

# 📂 Category: Salesforce AppExchange Apps

> G2 Software Category: Salesforce AppExchange Apps within Marketplace Apps.
...
FROM "02 Products"
WHERE contains(category, "Salesforce AppExchange Apps") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Salesforce AppExchange Apps") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Salesforce AppExchange Apps")
SORT osi_score DESC
```