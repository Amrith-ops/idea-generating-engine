...
> G2 Software Category: E-Signature Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "E-Signature Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "E-Signature Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "E-Signature Software")
SORT osi_score DESC
```