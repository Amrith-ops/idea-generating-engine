...
slug: "wysiwyg-editors"
---

# 📂 Category: WYSIWYG Editors

> G2 Software Category: WYSIWYG Editors within Development.
...
FROM "02 Products"
WHERE contains(category, "WYSIWYG Editors") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "WYSIWYG Editors") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "WYSIWYG Editors")
SORT osi_score DESC
```