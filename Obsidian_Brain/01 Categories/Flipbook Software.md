---
type: category
name: "Flipbook Software"
slug: "flipbook"
---

# 📂 Category: Flipbook Software

> G2 Software Category: Flipbook Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Flipbook Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Flipbook Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Flipbook Software")
SORT osi_score DESC
```