---
type: category
name: "Sweepstakes Software"
slug: "sweepstakes"
---

# 📂 Category: Sweepstakes Software

> G2 Software Category: Sweepstakes Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Sweepstakes Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Sweepstakes Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Sweepstakes Software")
SORT osi_score DESC
```