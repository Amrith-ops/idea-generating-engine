---
type: category
name: "Data Virtualization Software"
slug: "data-virtualization"
---

# 📂 Category: Data Virtualization Software

> G2 Software Category: Data Virtualization Software within Analytics Tools & Software.
...
FROM "02 Products"
WHERE contains(category, "Data Virtualization Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Virtualization Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Virtualization Software")
SORT osi_score DESC
```