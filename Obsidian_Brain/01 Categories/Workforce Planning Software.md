---
type: category
name: "Workforce Planning Software"
slug: "workforce-planning"
---

# 📂 Category: Workforce Planning Software

> G2 Software Category: Workforce Planning Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Workforce Planning Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Workforce Planning Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Workforce Planning Software")
SORT osi_score DESC
```