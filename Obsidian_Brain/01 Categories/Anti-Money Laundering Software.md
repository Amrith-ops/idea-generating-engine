---
type: category
name: "Anti-Money Laundering Software"
slug: "anti-money-laundering"
---

# 📂 Category: Anti-Money Laundering Software

> G2 Software Category: Anti-Money Laundering Software within Governance, Risk & Compliance.
...
FROM "02 Products"
WHERE contains(category, "Anti-Money Laundering Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Anti-Money Laundering Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Anti-Money Laundering Software")
SORT osi_score DESC
```