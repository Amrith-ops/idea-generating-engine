---
type: category
name: "Marina Management Software"
slug: "marina-management"
---

# 📂 Category: Marina Management Software

> G2 Software Category: Marina Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Marina Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Marina Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Marina Management Software")
SORT osi_score DESC
```