---
type: category
name: "Virtual Career Fair Platforms"
slug: "virtual-career-fair-platforms"
---

# 📂 Category: Virtual Career Fair Platforms

> G2 Software Category: Virtual Career Fair Platforms within HR.
...
FROM "02 Products"
WHERE contains(category, "Virtual Career Fair Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Virtual Career Fair Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Virtual Career Fair Platforms")
SORT osi_score DESC
```