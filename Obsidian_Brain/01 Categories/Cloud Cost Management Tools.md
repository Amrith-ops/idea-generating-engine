...
# 📂 Category: Cloud Cost Management Tools

> G2 Software Category: Cloud Cost Management Tools within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Cloud Cost Management Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cloud Cost Management Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cloud Cost Management Tools")
SORT osi_score DESC
```