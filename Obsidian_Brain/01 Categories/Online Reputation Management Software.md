---
type: category
name: "Online Reputation Management Software"
slug: "online-reputation-management"
---

# 📂 Category: Online Reputation Management Software

> G2 Software Category: Online Reputation Management Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Online Reputation Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Online Reputation Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Online Reputation Management Software")
SORT osi_score DESC
```