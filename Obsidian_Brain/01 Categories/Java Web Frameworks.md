...
slug: "java-web-frameworks"
---

# 📂 Category: Java Web Frameworks

> G2 Software Category: Java Web Frameworks within Development.
...
FROM "02 Products"
WHERE contains(category, "Java Web Frameworks") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Java Web Frameworks") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Java Web Frameworks")
SORT osi_score DESC
```