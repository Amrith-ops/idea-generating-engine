---
type: category
name: "Pharma and Biotech Software"
slug: "pharma-and-biotech"
---

# 📂 Category: Pharma and Biotech Software

> G2 Software Category: Pharma and Biotech Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Pharma and Biotech Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Pharma and Biotech Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Pharma and Biotech Software")
SORT osi_score DESC
```