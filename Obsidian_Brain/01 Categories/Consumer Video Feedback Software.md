---
type: category
name: "Consumer Video Feedback Software"
slug: "consumer-video-feedback"
---

# 📂 Category: Consumer Video Feedback Software

> G2 Software Category: Consumer Video Feedback Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Consumer Video Feedback Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Consumer Video Feedback Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Consumer Video Feedback Software")
SORT osi_score DESC
```