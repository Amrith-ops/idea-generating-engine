---
type: category
name: "Generative AI Software"
slug: "generative-ai"
---

# 📂 Category: Generative AI Software

> G2 Software Category: Generative AI Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Generative AI Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Generative AI Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Generative AI Software")
SORT osi_score DESC
```