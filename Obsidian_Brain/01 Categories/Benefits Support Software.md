---
type: category
name: "Benefits Support Software"
slug: "benefits-support"
---

# 📂 Category: Benefits Support Software

> G2 Software Category: Benefits Support Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Benefits Support Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Benefits Support Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Benefits Support Software")
SORT osi_score DESC
```