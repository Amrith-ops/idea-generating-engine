---
type: category
name: "Seed to Sale Software"
slug: "seed-to-sale-software"
---

# 📂 Category: Seed to Sale Software

> G2 Software Category: Seed to Sale Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Seed to Sale Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Seed to Sale Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Seed to Sale Software")
SORT osi_score DESC
```