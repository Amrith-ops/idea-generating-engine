...
# 📂 Category: Q&A Platforms

> G2 Software Category: Q&A Platforms within Content Management.
...
FROM "02 Products"
WHERE contains(category, "Q&A Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Q&A Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Q&A Platforms")
SORT osi_score DESC
```