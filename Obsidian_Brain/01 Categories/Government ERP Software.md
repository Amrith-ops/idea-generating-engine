---
type: category
name: "Government ERP Software"
slug: "government-erp"
---

# 📂 Category: Government ERP Software

> G2 Software Category: Government ERP Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Government ERP Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Government ERP Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Government ERP Software")
SORT osi_score DESC
```