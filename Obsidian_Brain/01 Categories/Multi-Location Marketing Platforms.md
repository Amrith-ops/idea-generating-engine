---
type: category
name: "Multi-Location Marketing Platforms"
slug: "multi-location-marketing-platforms"
---

# 📂 Category: Multi-Location Marketing Platforms

> G2 Software Category: Multi-Location Marketing Platforms within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Multi-Location Marketing Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Multi-Location Marketing Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Multi-Location Marketing Platforms")
SORT osi_score DESC
```