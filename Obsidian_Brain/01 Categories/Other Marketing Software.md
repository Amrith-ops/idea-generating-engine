---
type: category
name: "Other Marketing Software"
slug: "other-marketing"
---

# 📂 Category: Other Marketing Software

> G2 Software Category: Other Marketing Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Other Marketing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Marketing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Marketing Software")
SORT osi_score DESC
```