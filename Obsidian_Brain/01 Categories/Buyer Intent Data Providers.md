---
type: category
name: "Buyer Intent Data Providers"
slug: "buyer-intent-data-providers"
---

# 📂 Category: Buyer Intent Data Providers

> G2 Software Category: Buyer Intent Data Providers within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Buyer Intent Data Providers") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Buyer Intent Data Providers") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Buyer Intent Data Providers")
SORT osi_score DESC
```