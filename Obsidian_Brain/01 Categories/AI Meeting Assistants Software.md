---
type: category
name: "AI Meeting Assistants Software"
slug: "ai-meeting-assistants"
---

# 📂 Category: AI Meeting Assistants Software

> G2 Software Category: AI Meeting Assistants Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "AI Meeting Assistants Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI Meeting Assistants Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI Meeting Assistants Software")
SORT osi_score DESC
```