---
type: category
name: "Cloud Infrastructure Monitoring  Software"
slug: "cloud-infrastructure-monitoring"
---

# 📂 Category: Cloud Infrastructure Monitoring  Software

> G2 Software Category: Cloud Infrastructure Monitoring  Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Cloud Infrastructure Monitoring  Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cloud Infrastructure Monitoring  Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cloud Infrastructure Monitoring  Software")
SORT osi_score DESC
```