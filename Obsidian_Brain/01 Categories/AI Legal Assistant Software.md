---
type: category
name: "AI Legal Assistant Software"
slug: "ai-legal-assistant"
---

# 📂 Category: AI Legal Assistant Software

> G2 Software Category: AI Legal Assistant Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "AI Legal Assistant Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI Legal Assistant Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI Legal Assistant Software")
SORT osi_score DESC
```