---
type: category
name: "Help Authoring Tools (HAT)"
slug: "help-authoring-tool-hat"
---

# 📂 Category: Help Authoring Tools (HAT)

> G2 Software Category: Help Authoring Tools (HAT) within Development.
...
FROM "02 Products"
WHERE contains(category, "Help Authoring Tools (HAT)") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Help Authoring Tools (HAT)") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Help Authoring Tools (HAT)")
SORT osi_score DESC
```