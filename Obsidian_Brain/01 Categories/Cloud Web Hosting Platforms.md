---
type: category
name: "Cloud Web Hosting Platforms"
slug: "cloud-web-hosting"
---

# 📂 Category: Cloud Web Hosting Platforms

> G2 Software Category: Cloud Web Hosting Platforms within Hosting.
...
FROM "02 Products"
WHERE contains(category, "Cloud Web Hosting Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cloud Web Hosting Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cloud Web Hosting Platforms")
SORT osi_score DESC
```