...
# 📂 Category: Dry Cleaning Software

> G2 Software Category: Dry Cleaning Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Dry Cleaning Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Dry Cleaning Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Dry Cleaning Software")
SORT osi_score DESC
```