---
type: category
name: "Spa and Salon Management Software"
slug: "spa-and-salon-management"
---

# 📂 Category: Spa and Salon Management Software

> G2 Software Category: Spa and Salon Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Spa and Salon Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Spa and Salon Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Spa and Salon Management Software")
SORT osi_score DESC
```