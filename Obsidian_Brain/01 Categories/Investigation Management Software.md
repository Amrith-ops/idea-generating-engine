---
type: category
name: "Investigation Management Software"
slug: "investigation-management"
---

# 📂 Category: Investigation Management Software

> G2 Software Category: Investigation Management Software within Governance, Risk & Compliance.
...
FROM "02 Products"
WHERE contains(category, "Investigation Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Investigation Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Investigation Management Software")
SORT osi_score DESC
```