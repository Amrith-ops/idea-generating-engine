---
type: category
name: "Call Compliance Software"
slug: "call-compliance"
---

# 📂 Category: Call Compliance Software

> G2 Software Category: Call Compliance Software within Governance, Risk & Compliance.
...
FROM "02 Products"
WHERE contains(category, "Call Compliance Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Call Compliance Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Call Compliance Software")
SORT osi_score DESC
```