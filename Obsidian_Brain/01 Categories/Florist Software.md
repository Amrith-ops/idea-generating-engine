---
type: category
name: "Florist Software"
slug: "florist"
---

# 📂 Category: Florist Software

> G2 Software Category: Florist Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Florist Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Florist Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Florist Software")
SORT osi_score DESC
```