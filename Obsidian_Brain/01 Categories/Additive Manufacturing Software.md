---
type: category
name: "Additive Manufacturing Software"
slug: "additive-manufacturing"
---

# 📂 Category: Additive Manufacturing Software

> G2 Software Category: Additive Manufacturing Software within CAD & PLM.
...
FROM "02 Products"
WHERE contains(category, "Additive Manufacturing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Additive Manufacturing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Additive Manufacturing Software")
SORT osi_score DESC
```