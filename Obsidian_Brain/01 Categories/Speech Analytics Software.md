---
type: category
name: "Speech Analytics Software"
slug: "speech-analytics"
---

# 📂 Category: Speech Analytics Software

> G2 Software Category: Speech Analytics Software within Customer Service.
...
FROM "02 Products"
WHERE contains(category, "Speech Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Speech Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Speech Analytics Software")
SORT osi_score DESC
```