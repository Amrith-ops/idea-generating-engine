...
> G2 Software Category: CAD Software within CAD & PLM.
...
FROM "02 Products"
WHERE contains(category, "CAD Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "CAD Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "CAD Software")
SORT osi_score DESC
```