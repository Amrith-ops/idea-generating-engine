---
type: category
name: "Screen and Video Capture Software"
slug: "screen-and-video-capture"
---

# 📂 Category: Screen and Video Capture Software

> G2 Software Category: Screen and Video Capture Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Screen and Video Capture Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Screen and Video Capture Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Screen and Video Capture Software")
SORT osi_score DESC
```