---
type: category
name: "Customer Education Software"
slug: "customer-education"
---

# 📂 Category: Customer Education Software

> G2 Software Category: Customer Education Software within Customer Service.
...
FROM "02 Products"
WHERE contains(category, "Customer Education Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Customer Education Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Customer Education Software")
SORT osi_score DESC
```