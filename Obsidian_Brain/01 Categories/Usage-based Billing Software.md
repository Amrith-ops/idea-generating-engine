---
type: category
name: "Usage-based Billing Software"
slug: "usage-based-billing-software"
---

# 📂 Category: Usage-based Billing Software

> G2 Software Category: Usage-based Billing Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Usage-based Billing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Usage-based Billing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Usage-based Billing Software")
SORT osi_score DESC
```