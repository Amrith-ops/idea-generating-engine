---
type: category
name: "Earned Value Management Software"
slug: "earned-value-management"
---

# 📂 Category: Earned Value Management Software

> G2 Software Category: Earned Value Management Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Earned Value Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Earned Value Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Earned Value Management Software")
SORT osi_score DESC
```