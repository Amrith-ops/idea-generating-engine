---
type: category
name: "Owned Media Software"
slug: "owned-media"
---

# 📂 Category: Owned Media Software

> G2 Software Category: Owned Media Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Owned Media Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Owned Media Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Owned Media Software")
SORT osi_score DESC
```