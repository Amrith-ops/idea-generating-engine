...
> G2 Software Category: Virtual Reality Software within AR/VR.
...
FROM "02 Products"
WHERE contains(category, "Virtual Reality Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Virtual Reality Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Virtual Reality Software")
SORT osi_score DESC
```