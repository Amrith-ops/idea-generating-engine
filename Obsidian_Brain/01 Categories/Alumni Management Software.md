---
type: category
name: "Alumni Management Software"
slug: "alumni-management"
---

# 📂 Category: Alumni Management Software

> G2 Software Category: Alumni Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Alumni Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Alumni Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Alumni Management Software")
SORT osi_score DESC
```