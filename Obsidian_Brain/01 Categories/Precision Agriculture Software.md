...
> G2 Software Category: Precision Agriculture Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Precision Agriculture Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Precision Agriculture Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Precision Agriculture Software")
SORT osi_score DESC
```