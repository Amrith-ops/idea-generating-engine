---
type: category
name: "Public Records Management Software"
slug: "public-records-management"
---

# 📂 Category: Public Records Management Software

> G2 Software Category: Public Records Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Public Records Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Public Records Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Public Records Management Software")
SORT osi_score DESC
```