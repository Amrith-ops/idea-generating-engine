---
type: category
name: "eSports Management Software"
slug: "esports-management"
---

# 📂 Category: eSports Management Software

> G2 Software Category: eSports Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "eSports Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "eSports Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "eSports Management Software")
SORT osi_score DESC
```