---
type: category
name: "Data Observability Software"
slug: "data-observability"
---

# 📂 Category: Data Observability Software

> G2 Software Category: Data Observability Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Data Observability Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Observability Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Observability Software")
SORT osi_score DESC
```