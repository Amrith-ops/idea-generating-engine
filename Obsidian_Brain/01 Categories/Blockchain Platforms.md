...
> G2 Software Category: Blockchain Platforms within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Blockchain Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Blockchain Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Blockchain Platforms")
SORT osi_score DESC
```