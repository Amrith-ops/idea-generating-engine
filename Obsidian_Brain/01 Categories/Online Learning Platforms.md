...
> G2 Software Category: Online Learning Platforms within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Online Learning Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Online Learning Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Online Learning Platforms")
SORT osi_score DESC
```