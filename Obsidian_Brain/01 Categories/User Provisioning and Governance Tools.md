---
type: category
name: "User Provisioning and Governance Tools"
slug: "user-provisioning-and-governance-tools"
---

# 📂 Category: User Provisioning and Governance Tools

> G2 Software Category: User Provisioning and Governance Tools within Security.
...
FROM "02 Products"
WHERE contains(category, "User Provisioning and Governance Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "User Provisioning and Governance Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "User Provisioning and Governance Tools")
SORT osi_score DESC
```