---
type: category
name: "Stablecoin Infrastructure Software"
slug: "stablecoin-infrastructure"
---

# 📂 Category: Stablecoin Infrastructure Software

> G2 Software Category: Stablecoin Infrastructure Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Stablecoin Infrastructure Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Stablecoin Infrastructure Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Stablecoin Infrastructure Software")
SORT osi_score DESC
```