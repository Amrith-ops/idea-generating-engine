---
type: category
name: "Knowledge Management Software"
slug: "knowledge-management"
---

# 📂 Category: Knowledge Management Software

> G2 Software Category: Knowledge Management Software within Content Management.
...
FROM "02 Products"
WHERE contains(category, "Knowledge Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Knowledge Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Knowledge Management Software")
SORT osi_score DESC
```