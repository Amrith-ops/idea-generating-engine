---
type: category
name: "Electronic Data Interchange (EDI) Software"
slug: "electronic-data-interchange-edi"
---

# 📂 Category: Electronic Data Interchange (EDI) Software

> G2 Software Category: Electronic Data Interchange (EDI) Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Electronic Data Interchange (EDI) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Electronic Data Interchange (EDI) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Electronic Data Interchange (EDI) Software")
SORT osi_score DESC
```