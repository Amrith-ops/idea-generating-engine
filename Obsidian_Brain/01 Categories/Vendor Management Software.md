...
> G2 Software Category: Vendor Management Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Vendor Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Vendor Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Vendor Management Software")
SORT osi_score DESC
```