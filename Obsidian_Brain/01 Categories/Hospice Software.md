---
type: category
name: "Hospice Software"
slug: "hospice"
---

# 📂 Category: Hospice Software

> G2 Software Category: Hospice Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Hospice Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Hospice Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Hospice Software")
SORT osi_score DESC
```