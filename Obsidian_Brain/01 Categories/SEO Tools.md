...
> G2 Software Category: SEO Tools within Marketing.
...
FROM "02 Products"
WHERE contains(category, "SEO Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "SEO Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "SEO Tools")
SORT osi_score DESC
```