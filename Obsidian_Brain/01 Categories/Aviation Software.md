---
type: category
name: "Aviation Software"
slug: "aviation"
---

# 📂 Category: Aviation Software

> G2 Software Category: Aviation Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Aviation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Aviation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Aviation Software")
SORT osi_score DESC
```