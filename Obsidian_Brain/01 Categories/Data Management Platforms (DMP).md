---
type: category
name: "Data Management Platforms (DMP)"
slug: "data-management-platform-dmp"
---

# 📂 Category: Data Management Platforms (DMP)

> G2 Software Category: Data Management Platforms (DMP) within Digital Advertising Tech.
...
FROM "02 Products"
WHERE contains(category, "Data Management Platforms (DMP)") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Management Platforms (DMP)") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Management Platforms (DMP)")
SORT osi_score DESC
```