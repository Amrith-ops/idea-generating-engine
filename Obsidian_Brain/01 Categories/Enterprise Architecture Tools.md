...
slug: "enterprise-architecture-tools"
---

# 📂 Category: Enterprise Architecture Tools

> G2 Software Category: Enterprise Architecture Tools within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Enterprise Architecture Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Enterprise Architecture Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Enterprise Architecture Tools")
SORT osi_score DESC
```