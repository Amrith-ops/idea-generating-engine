---
type: category
name: "Regulatory Change Management Software"
slug: "regulatory-change-management"
---

# 📂 Category: Regulatory Change Management Software

> G2 Software Category: Regulatory Change Management Software within Governance, Risk & Compliance.
...
FROM "02 Products"
WHERE contains(category, "Regulatory Change Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Regulatory Change Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Regulatory Change Management Software")
SORT osi_score DESC
```