...
# 📂 Category: Process Automation Software

> G2 Software Category: Process Automation Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Process Automation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Process Automation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Process Automation Software")
SORT osi_score DESC
```