...
# 📂 Category: Employee Monitoring Software

> G2 Software Category: Employee Monitoring Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Employee Monitoring Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Employee Monitoring Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Employee Monitoring Software")
SORT osi_score DESC
```