...
> G2 Software Category: Learning Management Systems within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Learning Management Systems") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Learning Management Systems") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Learning Management Systems")
SORT osi_score DESC
```