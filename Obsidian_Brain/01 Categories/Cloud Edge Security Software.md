---
type: category
name: "Cloud Edge Security Software"
slug: "cloud-edge-security"
---

# 📂 Category: Cloud Edge Security Software

> G2 Software Category: Cloud Edge Security Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Cloud Edge Security Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cloud Edge Security Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cloud Edge Security Software")
SORT osi_score DESC
```