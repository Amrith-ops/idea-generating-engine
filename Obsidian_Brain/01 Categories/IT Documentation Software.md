---
type: category
name: "IT Documentation Software"
slug: "it-documentation"
---

# 📂 Category: IT Documentation Software

> G2 Software Category: IT Documentation Software within Content Management.
...
FROM "02 Products"
WHERE contains(category, "IT Documentation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "IT Documentation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "IT Documentation Software")
SORT osi_score DESC
```