---
type: category
name: "Large Language Models (LLMs) Software"
slug: "large-language-models-llms"
---

# 📂 Category: Large Language Models (LLMs) Software

> G2 Software Category: Large Language Models (LLMs) Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Large Language Models (LLMs) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Large Language Models (LLMs) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Large Language Models (LLMs) Software")
SORT osi_score DESC
```