---
type: category
name: "Virtual Reality (VR) Collaboration Platforms"
slug: "vr-collaboration"
---

# 📂 Category: Virtual Reality (VR) Collaboration Platforms

> G2 Software Category: Virtual Reality (VR) Collaboration Platforms within AR/VR.
...
FROM "02 Products"
WHERE contains(category, "Virtual Reality (VR) Collaboration Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Virtual Reality (VR) Collaboration Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Virtual Reality (VR) Collaboration Platforms")
SORT osi_score DESC
```