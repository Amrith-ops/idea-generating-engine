---
type: category
name: "Currency Exchange Bureau Software"
slug: "currency-exchange-bureau"
---

# 📂 Category: Currency Exchange Bureau Software

> G2 Software Category: Currency Exchange Bureau Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Currency Exchange Bureau Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Currency Exchange Bureau Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Currency Exchange Bureau Software")
SORT osi_score DESC
```