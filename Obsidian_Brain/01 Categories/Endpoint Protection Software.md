---
type: category
name: "Endpoint Protection Software"
slug: "endpoint-protection"
---

# 📂 Category: Endpoint Protection Software

> G2 Software Category: Endpoint Protection Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Endpoint Protection Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Endpoint Protection Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Endpoint Protection Software")
SORT osi_score DESC
```