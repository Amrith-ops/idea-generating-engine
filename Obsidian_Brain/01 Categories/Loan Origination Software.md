---
type: category
name: "Loan Origination Software"
slug: "loan-origination"
---

# 📂 Category: Loan Origination Software

> G2 Software Category: Loan Origination Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Loan Origination Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Loan Origination Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Loan Origination Software")
SORT osi_score DESC
```