---
type: category
name: "Sustainability Management Software"
slug: "sustainability-management"
---

# 📂 Category: Sustainability Management Software

> G2 Software Category: Sustainability Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Sustainability Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Sustainability Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Sustainability Management Software")
SORT osi_score DESC
```