---
type: category
name: "Weather Data Software"
slug: "weather-data-software"
---

# 📂 Category: Weather Data Software

> G2 Software Category: Weather Data Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Weather Data Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Weather Data Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Weather Data Software")
SORT osi_score DESC
```