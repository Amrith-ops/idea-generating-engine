---
type: category
name: "Public Works Software"
slug: "public-works"
---

# 📂 Category: Public Works Software

> G2 Software Category: Public Works Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Public Works Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Public Works Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Public Works Software")
SORT osi_score DESC
```