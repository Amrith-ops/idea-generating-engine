---
type: category
name: "Application Performance Monitoring (APM) Tools"
slug: "application-performance-monitoring-apm"
---

# 📂 Category: Application Performance Monitoring (APM) Tools

> G2 Software Category: Application Performance Monitoring (APM) Tools within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Application Performance Monitoring (APM) Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Application Performance Monitoring (APM) Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Application Performance Monitoring (APM) Tools")
SORT osi_score DESC
```