---
type: category
name: "Disk Cleanup Software"
slug: "disk-cleanup"
---

# 📂 Category: Disk Cleanup Software

> G2 Software Category: Disk Cleanup Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Disk Cleanup Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Disk Cleanup Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Disk Cleanup Software")
SORT osi_score DESC
```