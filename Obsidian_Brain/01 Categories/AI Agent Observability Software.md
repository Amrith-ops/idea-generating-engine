---
type: category
name: "AI Agent Observability Software"
slug: "ai-agent-observability"
---

# 📂 Category: AI Agent Observability Software

> G2 Software Category: AI Agent Observability Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "AI Agent Observability Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI Agent Observability Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI Agent Observability Software")
SORT osi_score DESC
```