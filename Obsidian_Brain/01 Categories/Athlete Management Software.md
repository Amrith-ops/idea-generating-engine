---
type: category
name: "Athlete Management Software"
slug: "athlete-management"
---

# 📂 Category: Athlete Management Software

> G2 Software Category: Athlete Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Athlete Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Athlete Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Athlete Management Software")
SORT osi_score DESC
```