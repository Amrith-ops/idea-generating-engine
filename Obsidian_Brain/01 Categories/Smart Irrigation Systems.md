...
> G2 Software Category: Smart Irrigation Systems within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Smart Irrigation Systems") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Smart Irrigation Systems") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Smart Irrigation Systems")
SORT osi_score DESC
```