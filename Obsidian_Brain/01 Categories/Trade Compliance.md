...
> G2 Software Category: Trade Compliance within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Trade Compliance") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Trade Compliance") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Trade Compliance")
SORT osi_score DESC
```