---
type: category
name: "Electronic Data Capture (EDC) Software"
slug: "electronic-data-capture-edc"
---

# 📂 Category: Electronic Data Capture (EDC) Software

> G2 Software Category: Electronic Data Capture (EDC) Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Electronic Data Capture (EDC) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Electronic Data Capture (EDC) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Electronic Data Capture (EDC) Software")
SORT osi_score DESC
```