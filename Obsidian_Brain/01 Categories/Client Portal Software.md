...
> G2 Software Category: Client Portal Software within Content Management.
...
FROM "02 Products"
WHERE contains(category, "Client Portal Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Client Portal Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Client Portal Software")
SORT osi_score DESC
```