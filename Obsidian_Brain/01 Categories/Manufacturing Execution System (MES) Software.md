...
# 📂 Category: Manufacturing Execution System (MES) Software

> G2 Software Category: Manufacturing Execution System (MES) Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Manufacturing Execution System (MES) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Manufacturing Execution System (MES) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Manufacturing Execution System (MES) Software")
SORT osi_score DESC
```