---
type: category
name: "Biometric Authentication Software"
slug: "biometric-authentication"
---

# 📂 Category: Biometric Authentication Software

> G2 Software Category: Biometric Authentication Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Biometric Authentication Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Biometric Authentication Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Biometric Authentication Software")
SORT osi_score DESC
```