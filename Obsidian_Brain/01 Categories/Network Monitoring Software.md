...
> G2 Software Category: Network Monitoring Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Network Monitoring Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Network Monitoring Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Network Monitoring Software")
SORT osi_score DESC
```