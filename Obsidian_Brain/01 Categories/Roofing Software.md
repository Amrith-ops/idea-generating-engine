---
type: category
name: "Roofing Software"
slug: "roofing-software"
---

# 📂 Category: Roofing Software

> G2 Software Category: Roofing Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Roofing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Roofing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Roofing Software")
SORT osi_score DESC
```