...
# 📂 Category: Application Development Software

> G2 Software Category: Application Development Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Application Development Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Application Development Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Application Development Software")
SORT osi_score DESC
```