---
type: category
name: "Chemical Management Software"
slug: "chemical-management"
---

# 📂 Category: Chemical Management Software

> G2 Software Category: Chemical Management Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Chemical Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Chemical Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Chemical Management Software")
SORT osi_score DESC
```