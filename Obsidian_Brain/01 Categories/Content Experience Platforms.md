---
type: category
name: "Content Experience Platforms"
slug: "content-experience-platforms"
---

# 📂 Category: Content Experience Platforms

> G2 Software Category: Content Experience Platforms within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Content Experience Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Content Experience Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Content Experience Platforms")
SORT osi_score DESC
```