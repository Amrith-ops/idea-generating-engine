---
type: category
name: "Agentic Analytics Software"
slug: "agentic-analytics"
---

# 📂 Category: Agentic Analytics Software

> G2 Software Category: Agentic Analytics Software within Analytics Tools & Software.
...
FROM "02 Products"
WHERE contains(category, "Agentic Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Agentic Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Agentic Analytics Software")
SORT osi_score DESC
```