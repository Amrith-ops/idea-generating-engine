...
> G2 Software Category: PDF Editors within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "PDF Editors") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "PDF Editors") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "PDF Editors")
SORT osi_score DESC
```