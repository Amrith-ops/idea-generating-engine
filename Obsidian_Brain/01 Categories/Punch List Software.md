---
type: category
name: "Punch List Software"
slug: "punch-list"
---

# 📂 Category: Punch List Software

> G2 Software Category: Punch List Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Punch List Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Punch List Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Punch List Software")
SORT osi_score DESC
```