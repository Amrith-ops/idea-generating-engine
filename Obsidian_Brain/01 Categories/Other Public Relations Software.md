---
type: category
name: "Other Public Relations Software"
slug: "other-public-relations"
---

# 📂 Category: Other Public Relations Software

> G2 Software Category: Other Public Relations Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Other Public Relations Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Public Relations Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Public Relations Software")
SORT osi_score DESC
```