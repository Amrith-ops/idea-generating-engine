...
> G2 Software Category: Workforce Management Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Workforce Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Workforce Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Workforce Management Software")
SORT osi_score DESC
```