---
type: category
name: "Freelance Tax Software"
slug: "freelance-tax"
---

# 📂 Category: Freelance Tax Software

> G2 Software Category: Freelance Tax Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Freelance Tax Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Freelance Tax Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Freelance Tax Software")
SORT osi_score DESC
```