---
type: category
name: "Skills Management Software"
slug: "skills-management"
---

# 📂 Category: Skills Management Software

> G2 Software Category: Skills Management Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Skills Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Skills Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Skills Management Software")
SORT osi_score DESC
```