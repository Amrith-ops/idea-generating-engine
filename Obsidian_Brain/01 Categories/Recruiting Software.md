...
> G2 Software Category: Recruiting Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Recruiting Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Recruiting Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Recruiting Software")
SORT osi_score DESC
```