---
type: category
name: "Other Life Sciences Software"
slug: "other-life-sciences"
---

# 📂 Category: Other Life Sciences Software

> G2 Software Category: Other Life Sciences Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Life Sciences Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Life Sciences Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Life Sciences Software")
SORT osi_score DESC
```