---
type: category
name: "Live Commerce Software"
slug: "live-commerce"
---

# 📂 Category: Live Commerce Software

> G2 Software Category: Live Commerce Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Live Commerce Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Live Commerce Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Live Commerce Software")
SORT osi_score DESC
```