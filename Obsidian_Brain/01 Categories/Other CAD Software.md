---
type: category
name: "Other CAD Software"
slug: "other-cad"
---

# 📂 Category: Other CAD Software

> G2 Software Category: Other CAD Software within CAD & PLM.
...
FROM "02 Products"
WHERE contains(category, "Other CAD Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other CAD Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other CAD Software")
SORT osi_score DESC
```