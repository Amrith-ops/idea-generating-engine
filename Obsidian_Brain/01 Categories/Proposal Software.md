...
> G2 Software Category: Proposal Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Proposal Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Proposal Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Proposal Software")
SORT osi_score DESC
```