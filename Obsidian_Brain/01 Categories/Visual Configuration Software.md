---
type: category
name: "Visual Configuration Software"
slug: "visual-configuration"
---

# 📂 Category: Visual Configuration Software

> G2 Software Category: Visual Configuration Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Visual Configuration Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Visual Configuration Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Visual Configuration Software")
SORT osi_score DESC
```