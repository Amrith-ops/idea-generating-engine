---
type: category
name: "Masonry Software"
slug: "masonry"
---

# 📂 Category: Masonry Software

> G2 Software Category: Masonry Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Masonry Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Masonry Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Masonry Software")
SORT osi_score DESC
```