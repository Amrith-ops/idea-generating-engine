...
> G2 Software Category: Pet Care Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Pet Care Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Pet Care Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Pet Care Software")
SORT osi_score DESC
```