...
slug: "active-learning-tools"
---

# 📂 Category: Active Learning Tools

> G2 Software Category: Active Learning Tools within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Active Learning Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Active Learning Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Active Learning Tools")
SORT osi_score DESC
```