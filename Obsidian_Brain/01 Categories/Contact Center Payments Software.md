---
type: category
name: "Contact Center Payments Software"
slug: "contact-center-payments"
---

# 📂 Category: Contact Center Payments Software

> G2 Software Category: Contact Center Payments Software within Customer Service.
...
FROM "02 Products"
WHERE contains(category, "Contact Center Payments Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Contact Center Payments Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Contact Center Payments Software")
SORT osi_score DESC
```