---
type: category
name: "Clinical Documentation Software"
slug: "clinical-documentation"
---

# 📂 Category: Clinical Documentation Software

> G2 Software Category: Clinical Documentation Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Clinical Documentation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Clinical Documentation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Clinical Documentation Software")
SORT osi_score DESC
```