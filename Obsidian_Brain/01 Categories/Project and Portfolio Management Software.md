---
type: category
name: "Project and Portfolio Management Software"
slug: "project-and-portfolio-management"
---

# 📂 Category: Project and Portfolio Management Software

> G2 Software Category: Project and Portfolio Management Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Project and Portfolio Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Project and Portfolio Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Project and Portfolio Management Software")
SORT osi_score DESC
```