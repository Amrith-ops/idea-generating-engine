---
type: category
name: "Other Agriculture Software"
slug: "other-agriculture"
---

# 📂 Category: Other Agriculture Software

> G2 Software Category: Other Agriculture Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Agriculture Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Agriculture Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Agriculture Software")
SORT osi_score DESC
```