...
> G2 Software Category: Onboarding Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Onboarding Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Onboarding Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Onboarding Software")
SORT osi_score DESC
```