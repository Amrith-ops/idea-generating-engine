---
type: category
name: "Operational Risk Management Software"
slug: "operational-risk-management"
---

# 📂 Category: Operational Risk Management Software

> G2 Software Category: Operational Risk Management Software within Governance, Risk & Compliance.
...
FROM "02 Products"
WHERE contains(category, "Operational Risk Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Operational Risk Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Operational Risk Management Software")
SORT osi_score DESC
```