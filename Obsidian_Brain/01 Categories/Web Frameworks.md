...
> G2 Software Category: Web Frameworks within Development.
...
FROM "02 Products"
WHERE contains(category, "Web Frameworks") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Web Frameworks") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Web Frameworks")
SORT osi_score DESC
```