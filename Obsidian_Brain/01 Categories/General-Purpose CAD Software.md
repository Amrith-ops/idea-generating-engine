---
type: category
name: "General-Purpose CAD Software"
slug: "general-purpose-cad"
---

# 📂 Category: General-Purpose CAD Software

> G2 Software Category: General-Purpose CAD Software within CAD & PLM.
...
FROM "02 Products"
WHERE contains(category, "General-Purpose CAD Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "General-Purpose CAD Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "General-Purpose CAD Software")
SORT osi_score DESC
```