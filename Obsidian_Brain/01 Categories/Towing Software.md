---
type: category
name: "Towing Software"
slug: "towing"
---

# 📂 Category: Towing Software

> G2 Software Category: Towing Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Towing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Towing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Towing Software")
SORT osi_score DESC
```