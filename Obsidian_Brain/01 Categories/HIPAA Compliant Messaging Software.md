---
type: category
name: "HIPAA Compliant Messaging Software"
slug: "hipaa-compliant-messaging"
---

# 📂 Category: HIPAA Compliant Messaging Software

> G2 Software Category: HIPAA Compliant Messaging Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "HIPAA Compliant Messaging Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "HIPAA Compliant Messaging Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "HIPAA Compliant Messaging Software")
SORT osi_score DESC
```