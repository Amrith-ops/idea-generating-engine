---
type: category
name: "Transfer Pricing Software"
slug: "transfer-pricing"
---

# 📂 Category: Transfer Pricing Software

> G2 Software Category: Transfer Pricing Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Transfer Pricing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Transfer Pricing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Transfer Pricing Software")
SORT osi_score DESC
```