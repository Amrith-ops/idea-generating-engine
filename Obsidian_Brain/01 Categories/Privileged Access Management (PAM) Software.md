...
# 📂 Category: Privileged Access Management (PAM) Software

> G2 Software Category: Privileged Access Management (PAM) Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Privileged Access Management (PAM) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Privileged Access Management (PAM) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Privileged Access Management (PAM) Software")
SORT osi_score DESC
```