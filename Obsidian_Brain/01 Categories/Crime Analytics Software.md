---
type: category
name: "Crime Analytics Software"
slug: "crime-analytics"
---

# 📂 Category: Crime Analytics Software

> G2 Software Category: Crime Analytics Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Crime Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Crime Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Crime Analytics Software")
SORT osi_score DESC
```