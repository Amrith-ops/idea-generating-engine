---
type: category
name: "Image Recognition Software"
slug: "image-recognition"
---

# 📂 Category: Image Recognition Software

> G2 Software Category: Image Recognition Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Image Recognition Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Image Recognition Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Image Recognition Software")
SORT osi_score DESC
```