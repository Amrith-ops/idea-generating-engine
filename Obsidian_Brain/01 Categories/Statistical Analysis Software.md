...
> G2 Software Category: Statistical Analysis Software within Analytics Tools & Software.
...
FROM "02 Products"
WHERE contains(category, "Statistical Analysis Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Statistical Analysis Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Statistical Analysis Software")
SORT osi_score DESC
```