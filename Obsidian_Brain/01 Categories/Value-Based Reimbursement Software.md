---
type: category
name: "Value-Based Reimbursement Software"
slug: "value-based-reimbursement"
---

# 📂 Category: Value-Based Reimbursement Software

> G2 Software Category: Value-Based Reimbursement Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Value-Based Reimbursement Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Value-Based Reimbursement Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Value-Based Reimbursement Software")
SORT osi_score DESC
```