---
type: category
name: "Intelligent Email Protection Software"
slug: "intelligent-email-protection"
---

# 📂 Category: Intelligent Email Protection Software

> G2 Software Category: Intelligent Email Protection Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Intelligent Email Protection Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Intelligent Email Protection Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Intelligent Email Protection Software")
SORT osi_score DESC
```