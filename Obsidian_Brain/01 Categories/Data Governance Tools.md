...
> G2 Software Category: Data Governance Tools within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Data Governance Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Governance Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Governance Tools")
SORT osi_score DESC
```