---
type: category
name: "Course Authoring Software"
slug: "course-authoring"
---

# 📂 Category: Course Authoring Software

> G2 Software Category: Course Authoring Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Course Authoring Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Course Authoring Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Course Authoring Software")
SORT osi_score DESC
```