---
type: category
name: "Call & Contact Center Software"
slug: "call-contact-center"
---

# 📂 Category: Call & Contact Center Software

> G2 Software Category: Call & Contact Center Software within Customer Service.
...
FROM "02 Products"
WHERE contains(category, "Call & Contact Center Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Call & Contact Center Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Call & Contact Center Software")
SORT osi_score DESC
```