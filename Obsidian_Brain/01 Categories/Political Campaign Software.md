---
type: category
name: "Political Campaign Software"
slug: "political-campaign"
---

# 📂 Category: Political Campaign Software

> G2 Software Category: Political Campaign Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Political Campaign Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Political Campaign Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Political Campaign Software")
SORT osi_score DESC
```