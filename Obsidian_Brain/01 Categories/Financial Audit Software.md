---
type: category
name: "Financial Audit Software"
slug: "financial-audit"
---

# 📂 Category: Financial Audit Software

> G2 Software Category: Financial Audit Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Financial Audit Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Financial Audit Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Financial Audit Software")
SORT osi_score DESC
```