---
type: category
name: "Workflow Management Software"
slug: "workflow-management"
---

# 📂 Category: Workflow Management Software

> G2 Software Category: Workflow Management Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Workflow Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Workflow Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Workflow Management Software")
SORT osi_score DESC
```