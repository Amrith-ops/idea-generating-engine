---
type: category
name: "Employee Intranet Software"
slug: "employee-intranet"
---

# 📂 Category: Employee Intranet Software

> G2 Software Category: Employee Intranet Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Employee Intranet Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Employee Intranet Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Employee Intranet Software")
SORT osi_score DESC
```