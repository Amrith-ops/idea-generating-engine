---
type: category
name: "Mobile Forms Automation Software"
slug: "mobile-forms-automation"
---

# 📂 Category: Mobile Forms Automation Software

> G2 Software Category: Mobile Forms Automation Software within Content Management.
...
FROM "02 Products"
WHERE contains(category, "Mobile Forms Automation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Mobile Forms Automation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Mobile Forms Automation Software")
SORT osi_score DESC
```