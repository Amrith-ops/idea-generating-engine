---
type: category
name: "Visitor Identification Software"
slug: "visitor-identification"
---

# 📂 Category: Visitor Identification Software

> G2 Software Category: Visitor Identification Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Visitor Identification Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Visitor Identification Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Visitor Identification Software")
SORT osi_score DESC
```