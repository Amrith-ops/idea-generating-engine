...
# 📂 Category: LIMS Software

> G2 Software Category: LIMS Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "LIMS Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "LIMS Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "LIMS Software")
SORT osi_score DESC
```