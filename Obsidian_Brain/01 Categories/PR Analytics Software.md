---
type: category
name: "PR Analytics Software"
slug: "pr-analytics"
---

# 📂 Category: PR Analytics Software

> G2 Software Category: PR Analytics Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "PR Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "PR Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "PR Analytics Software")
SORT osi_score DESC
```