...
> G2 Software Category: Domain Registrars within Hosting.
...
FROM "02 Products"
WHERE contains(category, "Domain Registrars") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Domain Registrars") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Domain Registrars")
SORT osi_score DESC
```