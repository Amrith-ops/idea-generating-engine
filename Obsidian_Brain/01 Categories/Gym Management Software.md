...
> G2 Software Category: Gym Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Gym Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Gym Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Gym Management Software")
SORT osi_score DESC
```