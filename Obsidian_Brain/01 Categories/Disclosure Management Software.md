---
type: category
name: "Disclosure Management Software"
slug: "disclosure-management"
---

# 📂 Category: Disclosure Management Software

> G2 Software Category: Disclosure Management Software within Governance, Risk & Compliance.
...
FROM "02 Products"
WHERE contains(category, "Disclosure Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Disclosure Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Disclosure Management Software")
SORT osi_score DESC
```