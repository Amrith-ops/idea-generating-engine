---
type: category
name: "Document Scanning Software"
slug: "document-scanning"
---

# 📂 Category: Document Scanning Software

> G2 Software Category: Document Scanning Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Document Scanning Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Document Scanning Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Document Scanning Software")
SORT osi_score DESC
```