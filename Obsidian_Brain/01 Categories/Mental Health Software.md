...
# 📂 Category: Mental Health Software

> G2 Software Category: Mental Health Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Mental Health Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Mental Health Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Mental Health Software")
SORT osi_score DESC
```