...
> G2 Software Category: Data Recovery Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Data Recovery Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Recovery Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Recovery Software")
SORT osi_score DESC
```