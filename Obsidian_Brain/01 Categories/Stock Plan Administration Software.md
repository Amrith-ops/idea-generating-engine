---
type: category
name: "Stock Plan Administration Software"
slug: "stock-plan-administration"
---

# 📂 Category: Stock Plan Administration Software

> G2 Software Category: Stock Plan Administration Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Stock Plan Administration Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Stock Plan Administration Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Stock Plan Administration Software")
SORT osi_score DESC
```