...
# 📂 Category: Label Printing Software

> G2 Software Category: Label Printing Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Label Printing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Label Printing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Label Printing Software")
SORT osi_score DESC
```