---
type: category
name: "Scholarship Management Software"
slug: "scholarship-management"
---

# 📂 Category: Scholarship Management Software

> G2 Software Category: Scholarship Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Scholarship Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Scholarship Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Scholarship Management Software")
SORT osi_score DESC
```