---
type: category
name: "Vaccine Tracking Software"
slug: "vaccine-tracking"
---

# 📂 Category: Vaccine Tracking Software

> G2 Software Category: Vaccine Tracking Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Vaccine Tracking Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Vaccine Tracking Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Vaccine Tracking Software")
SORT osi_score DESC
```