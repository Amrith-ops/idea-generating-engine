...
# 📂 Category: Legal Document Management Software

> G2 Software Category: Legal Document Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Legal Document Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Legal Document Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Legal Document Management Software")
SORT osi_score DESC
```