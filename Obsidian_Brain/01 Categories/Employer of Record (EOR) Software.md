---
type: category
name: "Employer of Record (EOR) Software"
slug: "employer-of-record-eor"
---

# 📂 Category: Employer of Record (EOR) Software

> G2 Software Category: Employer of Record (EOR) Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Employer of Record (EOR) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Employer of Record (EOR) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Employer of Record (EOR) Software")
SORT osi_score DESC
```