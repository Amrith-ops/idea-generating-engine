...
# 📂 Category: Construction Scheduling Software

> G2 Software Category: Construction Scheduling Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Construction Scheduling Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Construction Scheduling Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Construction Scheduling Software")
SORT osi_score DESC
```