...
> G2 Software Category: Password Managers within Security.
...
FROM "02 Products"
WHERE contains(category, "Password Managers") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Password Managers") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Password Managers")
SORT osi_score DESC
```