...
> G2 Software Category: Drawing Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Drawing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Drawing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Drawing Software")
SORT osi_score DESC
```