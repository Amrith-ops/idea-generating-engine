...
> G2 Software Category: Industrial IoT Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Industrial IoT Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Industrial IoT Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Industrial IoT Software")
SORT osi_score DESC
```