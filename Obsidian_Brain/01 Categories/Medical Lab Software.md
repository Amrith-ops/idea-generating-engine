---
type: category
name: "Medical Lab Software"
slug: "medical-lab"
---

# 📂 Category: Medical Lab Software

> G2 Software Category: Medical Lab Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Medical Lab Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Medical Lab Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Medical Lab Software")
SORT osi_score DESC
```