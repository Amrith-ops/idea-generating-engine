...
# 📂 Category: Customer Data Platforms (CDP)

> G2 Software Category: Customer Data Platforms (CDP) within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Customer Data Platforms (CDP)") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Customer Data Platforms (CDP)") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Customer Data Platforms (CDP)")
SORT osi_score DESC
```