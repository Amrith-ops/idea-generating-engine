---
type: category
name: "Google Workspace Teacher Resources"
slug: "google-workspace-teacher-resources"
---

# 📂 Category: Google Workspace Teacher Resources

> G2 Software Category: Google Workspace Teacher Resources within Marketplace Apps.
...
FROM "02 Products"
WHERE contains(category, "Google Workspace Teacher Resources") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Google Workspace Teacher Resources") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Google Workspace Teacher Resources")
SORT osi_score DESC
```