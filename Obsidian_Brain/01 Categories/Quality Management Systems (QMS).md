...
slug: "quality-management-qms"
---

# 📂 Category: Quality Management Systems (QMS)

> G2 Software Category: Quality Management Systems (QMS) within ERP.
...
FROM "02 Products"
WHERE contains(category, "Quality Management Systems (QMS)") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Quality Management Systems (QMS)") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Quality Management Systems (QMS)")
SORT osi_score DESC
```