---
type: category
name: "File Recovery Software"
slug: "file-recovery-software"
---

# 📂 Category: File Recovery Software

> G2 Software Category: File Recovery Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "File Recovery Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "File Recovery Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "File Recovery Software")
SORT osi_score DESC
```