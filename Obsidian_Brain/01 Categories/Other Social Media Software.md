---
type: category
name: "Other Social Media Software"
slug: "other-social-media"
---

# 📂 Category: Other Social Media Software

> G2 Software Category: Other Social Media Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Other Social Media Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Social Media Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Social Media Software")
SORT osi_score DESC
```