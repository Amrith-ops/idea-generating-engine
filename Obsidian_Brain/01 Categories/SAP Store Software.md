---
type: category
name: "SAP Store Software"
slug: "sap-store"
---

# 📂 Category: SAP Store Software

> G2 Software Category: SAP Store Software within Marketplace Apps.
...
FROM "02 Products"
WHERE contains(category, "SAP Store Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "SAP Store Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "SAP Store Software")
SORT osi_score DESC
```