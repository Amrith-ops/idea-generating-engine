---
type: category
name: "Other Reservations Software"
slug: "other-reservations"
---

# 📂 Category: Other Reservations Software

> G2 Software Category: Other Reservations Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Reservations Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Reservations Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Reservations Software")
SORT osi_score DESC
```