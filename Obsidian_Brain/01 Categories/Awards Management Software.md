---
type: category
name: "Awards Management Software"
slug: "awards-management"
---

# 📂 Category: Awards Management Software

> G2 Software Category: Awards Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Awards Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Awards Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Awards Management Software")
SORT osi_score DESC
```