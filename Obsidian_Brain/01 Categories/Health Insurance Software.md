---
type: category
name: "Health Insurance Software"
slug: "health-insurance-software"
---

# 📂 Category: Health Insurance Software

> G2 Software Category: Health Insurance Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Health Insurance Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Health Insurance Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Health Insurance Software")
SORT osi_score DESC
```