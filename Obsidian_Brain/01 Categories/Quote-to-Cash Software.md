---
type: category
name: "Quote-to-Cash Software"
slug: "quote-to-cash"
---

# 📂 Category: Quote-to-Cash Software

> G2 Software Category: Quote-to-Cash Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Quote-to-Cash Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Quote-to-Cash Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Quote-to-Cash Software")
SORT osi_score DESC
```