---
type: category
name: "Nonprofit Accounting Software"
slug: "nonprofit-accounting-software"
---

# 📂 Category: Nonprofit Accounting Software

> G2 Software Category: Nonprofit Accounting Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Nonprofit Accounting Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Nonprofit Accounting Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Nonprofit Accounting Software")
SORT osi_score DESC
```