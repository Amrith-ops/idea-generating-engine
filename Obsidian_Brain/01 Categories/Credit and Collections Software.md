---
type: category
name: "Credit and Collections Software"
slug: "credit-and-collections"
---

# 📂 Category: Credit and Collections Software

> G2 Software Category: Credit and Collections Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Credit and Collections Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Credit and Collections Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Credit and Collections Software")
SORT osi_score DESC
```