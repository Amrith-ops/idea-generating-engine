...
> G2 Software Category: Shopping Cart Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Shopping Cart Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Shopping Cart Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Shopping Cart Software")
SORT osi_score DESC
```