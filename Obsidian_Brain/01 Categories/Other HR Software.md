---
type: category
name: "Other HR Software"
slug: "other-hr"
---

# 📂 Category: Other HR Software

> G2 Software Category: Other HR Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Other HR Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other HR Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other HR Software")
SORT osi_score DESC
```