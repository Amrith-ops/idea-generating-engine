---
type: category
name: "Deception Technology Software"
slug: "deception-technology"
---

# 📂 Category: Deception Technology Software

> G2 Software Category: Deception Technology Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Deception Technology Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Deception Technology Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Deception Technology Software")
SORT osi_score DESC
```