---
type: category
name: "Yard Management Software"
slug: "yard-management"
---

# 📂 Category: Yard Management Software

> G2 Software Category: Yard Management Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Yard Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Yard Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Yard Management Software")
SORT osi_score DESC
```