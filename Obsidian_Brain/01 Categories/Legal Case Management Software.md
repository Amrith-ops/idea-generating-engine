...
# 📂 Category: Legal Case Management Software

> G2 Software Category: Legal Case Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Legal Case Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Legal Case Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Legal Case Management Software")
SORT osi_score DESC
```