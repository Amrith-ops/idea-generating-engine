...
# 📂 Category: Quote Management Software

> G2 Software Category: Quote Management Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Quote Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Quote Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Quote Management Software")
SORT osi_score DESC
```