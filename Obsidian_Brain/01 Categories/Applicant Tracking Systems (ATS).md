...
slug: "applicant-tracking-systems-ats"
---

# 📂 Category: Applicant Tracking Systems (ATS)

> G2 Software Category: Applicant Tracking Systems (ATS) within HR.
...
FROM "02 Products"
WHERE contains(category, "Applicant Tracking Systems (ATS)") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Applicant Tracking Systems (ATS)") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Applicant Tracking Systems (ATS)")
SORT osi_score DESC
```