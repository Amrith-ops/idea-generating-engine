---
type: category
name: "Pharmacy POS Systems"
slug: "pharmacy-pos-systems"
---

# 📂 Category: Pharmacy POS Systems

> G2 Software Category: Pharmacy POS Systems within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Pharmacy POS Systems") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Pharmacy POS Systems") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Pharmacy POS Systems")
SORT osi_score DESC
```