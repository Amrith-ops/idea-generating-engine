---
type: category
name: "Background Check Software"
slug: "background-check"
---

# 📂 Category: Background Check Software

> G2 Software Category: Background Check Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Background Check Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Background Check Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Background Check Software")
SORT osi_score DESC
```