---
type: category
name: "Load Board Software"
slug: "load-board"
---

# 📂 Category: Load Board Software

> G2 Software Category: Load Board Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Load Board Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Load Board Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Load Board Software")
SORT osi_score DESC
```