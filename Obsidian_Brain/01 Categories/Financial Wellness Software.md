---
type: category
name: "Financial Wellness Software"
slug: "financial-wellness"
---

# 📂 Category: Financial Wellness Software

> G2 Software Category: Financial Wellness Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Financial Wellness Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Financial Wellness Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Financial Wellness Software")
SORT osi_score DESC
```