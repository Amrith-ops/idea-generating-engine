---
type: category
name: "Retail Intelligence Software"
slug: "retail-intelligence"
---

# 📂 Category: Retail Intelligence Software

> G2 Software Category: Retail Intelligence Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Retail Intelligence Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Retail Intelligence Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Retail Intelligence Software")
SORT osi_score DESC
```