---
type: category
name: "Internal Communications Software"
slug: "internal-communications"
---

# 📂 Category: Internal Communications Software

> G2 Software Category: Internal Communications Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Internal Communications Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Internal Communications Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Internal Communications Software")
SORT osi_score DESC
```