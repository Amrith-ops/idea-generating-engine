---
type: category
name: "Retail Assortment Planning Software"
slug: "retail-assortment-planning"
---

# 📂 Category: Retail Assortment Planning Software

> G2 Software Category: Retail Assortment Planning Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Retail Assortment Planning Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Retail Assortment Planning Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Retail Assortment Planning Software")
SORT osi_score DESC
```