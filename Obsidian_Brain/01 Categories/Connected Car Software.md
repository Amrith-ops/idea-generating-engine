---
type: category
name: "Connected Car Software"
slug: "connected-car"
---

# 📂 Category: Connected Car Software

> G2 Software Category: Connected Car Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Connected Car Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Connected Car Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Connected Car Software")
SORT osi_score DESC
```