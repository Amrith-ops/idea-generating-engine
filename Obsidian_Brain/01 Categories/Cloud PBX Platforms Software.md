---
type: category
name: "Cloud PBX Platforms Software"
slug: "cloud-pbx-platforms"
---

# 📂 Category: Cloud PBX Platforms Software

> G2 Software Category: Cloud PBX Platforms Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Cloud PBX Platforms Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cloud PBX Platforms Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cloud PBX Platforms Software")
SORT osi_score DESC
```