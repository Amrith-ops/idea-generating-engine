---
type: category
name: "Business Activity Monitoring Software"
slug: "business-activity-monitoring"
---

# 📂 Category: Business Activity Monitoring Software

> G2 Software Category: Business Activity Monitoring Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Business Activity Monitoring Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Business Activity Monitoring Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Business Activity Monitoring Software")
SORT osi_score DESC
```