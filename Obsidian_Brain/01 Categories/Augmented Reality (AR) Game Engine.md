---
type: category
name: "Augmented Reality (AR) Game Engine"
slug: "ar-game-engine"
---

# 📂 Category: Augmented Reality (AR) Game Engine

> G2 Software Category: Augmented Reality (AR) Game Engine within AR/VR.
...
FROM "02 Products"
WHERE contains(category, "Augmented Reality (AR) Game Engine") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Augmented Reality (AR) Game Engine") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Augmented Reality (AR) Game Engine")
SORT osi_score DESC
```