---
type: category
name: "Tool Tracking Software"
slug: "tool-tracking"
---

# 📂 Category: Tool Tracking Software

> G2 Software Category: Tool Tracking Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Tool Tracking Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Tool Tracking Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Tool Tracking Software")
SORT osi_score DESC
```