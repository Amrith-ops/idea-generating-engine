---
type: category
name: "Investor Relations Software"
slug: "investor-relations"
---

# 📂 Category: Investor Relations Software

> G2 Software Category: Investor Relations Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Investor Relations Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Investor Relations Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Investor Relations Software")
SORT osi_score DESC
```