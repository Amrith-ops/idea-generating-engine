---
type: category
name: "Revenue AI Platforms"
slug: "revenue-ai-platforms"
---

# 📂 Category: Revenue AI Platforms

> G2 Software Category: Revenue AI Platforms within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Revenue AI Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Revenue AI Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Revenue AI Platforms")
SORT osi_score DESC
```