---
type: category
name: "Business Entertainment Software"
slug: "business-entertainment"
---

# 📂 Category: Business Entertainment Software

> G2 Software Category: Business Entertainment Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Business Entertainment Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Business Entertainment Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Business Entertainment Software")
SORT osi_score DESC
```