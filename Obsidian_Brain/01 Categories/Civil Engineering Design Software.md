---
type: category
name: "Civil Engineering Design Software"
slug: "civil-engineering-design"
---

# 📂 Category: Civil Engineering Design Software

> G2 Software Category: Civil Engineering Design Software within CAD & PLM.
...
FROM "02 Products"
WHERE contains(category, "Civil Engineering Design Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Civil Engineering Design Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Civil Engineering Design Software")
SORT osi_score DESC
```