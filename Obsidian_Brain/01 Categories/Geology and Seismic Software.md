---
type: category
name: "Geology and Seismic Software"
slug: "geology-and-seismic"
---

# 📂 Category: Geology and Seismic Software

> G2 Software Category: Geology and Seismic Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Geology and Seismic Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Geology and Seismic Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Geology and Seismic Software")
SORT osi_score DESC
```