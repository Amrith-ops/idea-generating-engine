---
type: category
name: "Sales Planning Software"
slug: "sales-planning"
---

# 📂 Category: Sales Planning Software

> G2 Software Category: Sales Planning Software within Sales Tools.
...
FROM "02 Products"
WHERE contains(category, "Sales Planning Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Sales Planning Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Sales Planning Software")
SORT osi_score DESC
```