---
type: category
name: "Contractor Payment Software"
slug: "contractor-payments"
---

# 📂 Category: Contractor Payment Software

> G2 Software Category: Contractor Payment Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Contractor Payment Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Contractor Payment Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Contractor Payment Software")
SORT osi_score DESC
```