...
> G2 Software Category: Relational Databases within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Relational Databases") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Relational Databases") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Relational Databases")
SORT osi_score DESC
```