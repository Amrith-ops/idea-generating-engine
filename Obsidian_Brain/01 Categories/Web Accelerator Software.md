---
type: category
name: "Web Accelerator Software"
slug: "web-accelerator"
---

# 📂 Category: Web Accelerator Software

> G2 Software Category: Web Accelerator Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Web Accelerator Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Web Accelerator Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Web Accelerator Software")
SORT osi_score DESC
```