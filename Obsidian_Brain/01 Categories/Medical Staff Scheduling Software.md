---
type: category
name: "Medical Staff Scheduling Software"
slug: "medical-staff-scheduling"
---

# 📂 Category: Medical Staff Scheduling Software

> G2 Software Category: Medical Staff Scheduling Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Medical Staff Scheduling Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Medical Staff Scheduling Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Medical Staff Scheduling Software")
SORT osi_score DESC
```