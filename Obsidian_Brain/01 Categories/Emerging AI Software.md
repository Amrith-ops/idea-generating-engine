---
type: category
name: "Emerging AI Software"
slug: "emerging-ai-software"
---

# 📂 Category: Emerging AI Software

> G2 Software Category: Emerging AI Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Emerging AI Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Emerging AI Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Emerging AI Software")
SORT osi_score DESC
```