...
> G2 Software Category: Job Board Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Job Board Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Job Board Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Job Board Software")
SORT osi_score DESC
```