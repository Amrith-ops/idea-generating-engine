---
type: category
name: "Secure Email Gateway Software"
slug: "secure-email-gateway"
---

# 📂 Category: Secure Email Gateway Software

> G2 Software Category: Secure Email Gateway Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Secure Email Gateway Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Secure Email Gateway Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Secure Email Gateway Software")
SORT osi_score DESC
```