...
> G2 Software Category: Veterinary Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Veterinary Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Veterinary Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Veterinary Software")
SORT osi_score DESC
```