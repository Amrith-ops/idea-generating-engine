...
> G2 Software Category: Landing Page Builders within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Landing Page Builders") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Landing Page Builders") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Landing Page Builders")
SORT osi_score DESC
```