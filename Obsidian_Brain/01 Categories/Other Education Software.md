---
type: category
name: "Other Education Software"
slug: "other-education"
---

# 📂 Category: Other Education Software

> G2 Software Category: Other Education Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Other Education Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Education Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Education Software")
SORT osi_score DESC
```