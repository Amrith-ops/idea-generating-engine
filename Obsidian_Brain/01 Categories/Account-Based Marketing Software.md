---
type: category
name: "Account-Based Marketing Software"
slug: "account-based-marketing"
---

# 📂 Category: Account-Based Marketing Software

> G2 Software Category: Account-Based Marketing Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Account-Based Marketing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Account-Based Marketing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Account-Based Marketing Software")
SORT osi_score DESC
```