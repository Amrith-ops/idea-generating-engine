---
type: category
name: "Data Destruction Software"
slug: "data-destruction"
---

# 📂 Category: Data Destruction Software

> G2 Software Category: Data Destruction Software within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Data Destruction Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Destruction Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Destruction Software")
SORT osi_score DESC
```