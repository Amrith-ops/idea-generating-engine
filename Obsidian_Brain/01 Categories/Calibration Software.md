...
> G2 Software Category: Calibration Software within ERP.
...
FROM "02 Products"
WHERE contains(category, "Calibration Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Calibration Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Calibration Software")
SORT osi_score DESC
```