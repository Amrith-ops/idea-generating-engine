---
type: category
name: "Account-Based Orchestration Platforms"
slug: "account-based-orchestration-platforms"
---

# 📂 Category: Account-Based Orchestration Platforms

> G2 Software Category: Account-Based Orchestration Platforms within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Account-Based Orchestration Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Account-Based Orchestration Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Account-Based Orchestration Platforms")
SORT osi_score DESC
```