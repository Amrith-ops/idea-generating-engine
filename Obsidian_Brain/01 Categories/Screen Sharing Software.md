...
> G2 Software Category: Screen Sharing Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Screen Sharing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Screen Sharing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Screen Sharing Software")
SORT osi_score DESC
```