---
type: category
name: "Legal CRM Software"
slug: "legal-crm"
---

# 📂 Category: Legal CRM Software

> G2 Software Category: Legal CRM Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Legal CRM Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Legal CRM Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Legal CRM Software")
SORT osi_score DESC
```