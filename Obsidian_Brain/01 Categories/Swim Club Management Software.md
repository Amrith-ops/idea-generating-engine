---
type: category
name: "Swim Club Management Software"
slug: "swim-club-management"
---

# 📂 Category: Swim Club Management Software

> G2 Software Category: Swim Club Management Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Swim Club Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Swim Club Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Swim Club Management Software")
SORT osi_score DESC
```