---
type: category
name: "AI Legal Operating System Software"
slug: "ai-legal-operating-system"
---

# 📂 Category: AI Legal Operating System Software

> G2 Software Category: AI Legal Operating System Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "AI Legal Operating System Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "AI Legal Operating System Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "AI Legal Operating System Software")
SORT osi_score DESC
```