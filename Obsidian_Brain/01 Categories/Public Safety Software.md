---
type: category
name: "Public Safety Software"
slug: "public-safety"
---

# 📂 Category: Public Safety Software

> G2 Software Category: Public Safety Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Public Safety Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Public Safety Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Public Safety Software")
SORT osi_score DESC
```