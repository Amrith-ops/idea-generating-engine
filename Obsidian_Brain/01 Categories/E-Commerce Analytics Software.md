---
type: category
name: "E-Commerce Analytics Software"
slug: "e-commerce-analytics"
---

# 📂 Category: E-Commerce Analytics Software

> G2 Software Category: E-Commerce Analytics Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "E-Commerce Analytics Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "E-Commerce Analytics Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "E-Commerce Analytics Software")
SORT osi_score DESC
```