---
type: category
name: "VPS Hosting Platforms"
slug: "vps-hosting-platforms"
---

# 📂 Category: VPS Hosting Platforms

> G2 Software Category: VPS Hosting Platforms within Hosting.
...
FROM "02 Products"
WHERE contains(category, "VPS Hosting Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "VPS Hosting Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "VPS Hosting Platforms")
SORT osi_score DESC
```