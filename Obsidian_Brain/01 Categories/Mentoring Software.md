---
type: category
name: "Mentoring Software"
slug: "mentoring"
---

# 📂 Category: Mentoring Software

> G2 Software Category: Mentoring Software within HR.
...
FROM "02 Products"
WHERE contains(category, "Mentoring Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Mentoring Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Mentoring Software")
SORT osi_score DESC
```