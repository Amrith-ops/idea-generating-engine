---
type: category
name: "Software Composition Analysis Tools"
slug: "software-composition-analysis"
---

# 📂 Category: Software Composition Analysis Tools

> G2 Software Category: Software Composition Analysis Tools within Security.
...
FROM "02 Products"
WHERE contains(category, "Software Composition Analysis Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Software Composition Analysis Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Software Composition Analysis Tools")
SORT osi_score DESC
```