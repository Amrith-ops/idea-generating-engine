...
slug: "e-commerce-tools"
---

# 📂 Category: E-Commerce Tools

> G2 Software Category: E-Commerce Tools within Commerce.
...
FROM "02 Products"
WHERE contains(category, "E-Commerce Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "E-Commerce Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "E-Commerce Tools")
SORT osi_score DESC
```