...
> G2 Software Category: Batteries within Greentech.
...
FROM "02 Products"
WHERE contains(category, "Batteries") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Batteries") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Batteries")
SORT osi_score DESC
```