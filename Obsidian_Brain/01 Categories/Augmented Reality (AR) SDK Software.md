---
type: category
name: "Augmented Reality (AR) SDK Software"
slug: "ar-sdk"
---

# 📂 Category: Augmented Reality (AR) SDK Software

> G2 Software Category: Augmented Reality (AR) SDK Software within AR/VR.
...
FROM "02 Products"
WHERE contains(category, "Augmented Reality (AR) SDK Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Augmented Reality (AR) SDK Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Augmented Reality (AR) SDK Software")
SORT osi_score DESC
```