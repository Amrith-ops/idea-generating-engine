...
# 📂 Category: eMAR Software

> G2 Software Category: eMAR Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "eMAR Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "eMAR Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "eMAR Software")
SORT osi_score DESC
```