---
type: category
name: "Merchant of Record Software"
slug: "merchant-of-record"
---

# 📂 Category: Merchant of Record Software

> G2 Software Category: Merchant of Record Software within Commerce.
...
FROM "02 Products"
WHERE contains(category, "Merchant of Record Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Merchant of Record Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Merchant of Record Software")
SORT osi_score DESC
```