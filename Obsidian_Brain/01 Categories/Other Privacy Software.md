---
type: category
name: "Other Privacy Software"
slug: "other-privacy"
---

# 📂 Category: Other Privacy Software

> G2 Software Category: Other Privacy Software within Data Privacy.
...
FROM "02 Products"
WHERE contains(category, "Other Privacy Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Privacy Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Privacy Software")
SORT osi_score DESC
```