...
slug: "webops-platforms"
---

# 📂 Category: WebOps Platforms

> G2 Software Category: WebOps Platforms within Development.
...
FROM "02 Products"
WHERE contains(category, "WebOps Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "WebOps Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "WebOps Platforms")
SORT osi_score DESC
```