---
type: category
name: "Service Discovery Software"
slug: "service-discovery"
---

# 📂 Category: Service Discovery Software

> G2 Software Category: Service Discovery Software within Development.
...
FROM "02 Products"
WHERE contains(category, "Service Discovery Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Service Discovery Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Service Discovery Software")
SORT osi_score DESC
```