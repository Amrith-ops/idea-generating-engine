...
> G2 Software Category: Graph Databases within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Graph Databases") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Graph Databases") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Graph Databases")
SORT osi_score DESC
```