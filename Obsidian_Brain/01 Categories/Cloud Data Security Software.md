---
type: category
name: "Cloud Data Security Software"
slug: "cloud-data-security"
---

# 📂 Category: Cloud Data Security Software

> G2 Software Category: Cloud Data Security Software within Security.
...
FROM "02 Products"
WHERE contains(category, "Cloud Data Security Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cloud Data Security Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cloud Data Security Software")
SORT osi_score DESC
```