---
type: category
name: "Text Expanders Software"
slug: "text-expanders"
---

# 📂 Category: Text Expanders Software

> G2 Software Category: Text Expanders Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Text Expanders Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Text Expanders Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Text Expanders Software")
SORT osi_score DESC
```