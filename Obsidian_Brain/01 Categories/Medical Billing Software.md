...
# 📂 Category: Medical Billing Software

> G2 Software Category: Medical Billing Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Medical Billing Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Medical Billing Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Medical Billing Software")
SORT osi_score DESC
```