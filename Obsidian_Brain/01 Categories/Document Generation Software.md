---
type: category
name: "Document Generation Software"
slug: "document-generation"
---

# 📂 Category: Document Generation Software

> G2 Software Category: Document Generation Software within Collaboration & Productivity.
...
FROM "02 Products"
WHERE contains(category, "Document Generation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Document Generation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Document Generation Software")
SORT osi_score DESC
```