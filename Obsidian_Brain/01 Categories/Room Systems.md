...
# 📂 Category: Room Systems

> G2 Software Category: Room Systems within Office Management Software.
...
FROM "02 Products"
WHERE contains(category, "Room Systems") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Room Systems") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Room Systems")
SORT osi_score DESC
```