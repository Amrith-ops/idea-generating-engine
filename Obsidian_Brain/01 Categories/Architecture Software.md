...
> G2 Software Category: Architecture Software within Vertical Industry.
...
FROM "02 Products"
WHERE contains(category, "Architecture Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Architecture Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Architecture Software")
SORT osi_score DESC
```