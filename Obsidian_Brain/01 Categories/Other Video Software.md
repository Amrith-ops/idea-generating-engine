---
type: category
name: "Other Video Software"
slug: "other-video"
---

# 📂 Category: Other Video Software

> G2 Software Category: Other Video Software within Design.
...
FROM "02 Products"
WHERE contains(category, "Other Video Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Other Video Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Other Video Software")
SORT osi_score DESC
```