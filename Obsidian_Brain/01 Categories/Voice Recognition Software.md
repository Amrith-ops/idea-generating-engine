...
> G2 Software Category: Voice Recognition Software within Artificial Intelligence.
...
FROM "02 Products"
WHERE contains(category, "Voice Recognition Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Voice Recognition Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Voice Recognition Software")
SORT osi_score DESC
```