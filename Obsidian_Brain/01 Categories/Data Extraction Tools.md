...
> G2 Software Category: Data Extraction Tools within IT Management.
...
FROM "02 Products"
WHERE contains(category, "Data Extraction Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Data Extraction Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Data Extraction Tools")
SORT osi_score DESC
```