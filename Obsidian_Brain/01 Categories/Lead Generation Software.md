...
> G2 Software Category: Lead Generation Software within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Lead Generation Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Lead Generation Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Lead Generation Software")
SORT osi_score DESC
```