...
> G2 Software Category: Warehouse Management Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Warehouse Management Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Warehouse Management Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Warehouse Management Software")
SORT osi_score DESC
```