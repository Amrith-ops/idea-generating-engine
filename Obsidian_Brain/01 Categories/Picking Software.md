---
type: category
name: "Picking Software"
slug: "picking"
---

# 📂 Category: Picking Software

> G2 Software Category: Picking Software within Supply Chain & Logistics.
...
FROM "02 Products"
WHERE contains(category, "Picking Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Picking Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Picking Software")
SORT osi_score DESC
```