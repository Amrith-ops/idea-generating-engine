...
> G2 Software Category: Cryptocurrency Wallets within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Cryptocurrency Wallets") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Cryptocurrency Wallets") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Cryptocurrency Wallets")
SORT osi_score DESC
```