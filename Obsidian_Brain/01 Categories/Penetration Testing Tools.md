...
> G2 Software Category: Penetration Testing Tools within Security.
...
FROM "02 Products"
WHERE contains(category, "Penetration Testing Tools") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Penetration Testing Tools") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Penetration Testing Tools")
SORT osi_score DESC
```