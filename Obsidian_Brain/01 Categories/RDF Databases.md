...
# 📂 Category: RDF Databases

> G2 Software Category: RDF Databases within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "RDF Databases") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "RDF Databases") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "RDF Databases")
SORT osi_score DESC
```