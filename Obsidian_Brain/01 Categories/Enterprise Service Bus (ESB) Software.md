---
type: category
name: "Enterprise Service Bus (ESB) Software"
slug: "enterprise-service-bus-esb"
---

# 📂 Category: Enterprise Service Bus (ESB) Software

> G2 Software Category: Enterprise Service Bus (ESB) Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Enterprise Service Bus (ESB) Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Enterprise Service Bus (ESB) Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Enterprise Service Bus (ESB) Software")
SORT osi_score DESC
```