---
type: category
name: "Big Data Software"
slug: "big-data"
---

# 📂 Category: Big Data Software

> G2 Software Category: Big Data Software within IT Infrastructure.
...
FROM "02 Products"
WHERE contains(category, "Big Data Software") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Big Data Software") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Big Data Software")
SORT osi_score DESC
```