...
> G2 Software Category: Influencer Marketing Platforms within Marketing.
...
FROM "02 Products"
WHERE contains(category, "Influencer Marketing Platforms") AND orbit_tier = "0_behemoth"
```
...
FROM "02 Products"
WHERE contains(category, "Influencer Marketing Platforms") AND orbit_tier = "1_challenger"
```
...
WHERE contains(category, "Influencer Marketing Platforms")
SORT osi_score DESC
```